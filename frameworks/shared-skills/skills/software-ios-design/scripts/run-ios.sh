...
usage() {
  cat <<'EOF'
Build, install, and launch the current iOS app on Simulator using XcodeBuildMCP.

Usage:
  ./scripts/run-ios.sh [options] [-- extra xcodebuild args]
