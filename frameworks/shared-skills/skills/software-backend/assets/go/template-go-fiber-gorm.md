...
Prefer `template-go-chi-sqlc-pgx.md` when SQL auditability and explicit queries matter more than ORM convenience.
...
**Tech Stack:**
- [ ] Go 1.24+ (or org-approved stable; verify current at go.dev/doc/devel/release)
- [ ] Fiber v2 (lightweight Go web framework)
...
|---------|------------|-----------|
| Config loading (`getEnv`, `getEnvInt`) | `internal/pkg/config/` | [config-validation.md](../../../software-clean-code-standard/references/config-validation.md) |
| JWT (`JWTManager`, `Generate`, `Verify`) | `internal/pkg/auth/` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Password (`HashPassword`, `VerifyPassword`) | `internal/pkg/auth/` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Errors (`AppError`, `errorHandler`) | `internal/pkg/errors/` | [error-handling.md](../../../software-clean-code-standard/references/error-handling.md) |
| Logging (zap setup) | `internal/pkg/logger/` | [logging-utilities.md](../../../software-clean-code-standard/references/logging-utilities.md) |
