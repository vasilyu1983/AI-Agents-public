...
|---------|------------|-----------|
| Config (Options pattern) | `Api/` service registration | [config-validation.md](../../../software-clean-code-standard/references/config-validation.md) |
| JWT (token generation/validation) | `Infrastructure/Services/` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Password hashing (BCrypt) | `Infrastructure/Services/` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Errors (ProblemDetails, middleware) | `Api/Middleware/` | [error-handling.md](../../../software-clean-code-standard/references/error-handling.md) |
| Logging (Serilog setup) | `Api/Program.cs` | [logging-utilities.md](../../../software-clean-code-standard/references/logging-utilities.md) |
