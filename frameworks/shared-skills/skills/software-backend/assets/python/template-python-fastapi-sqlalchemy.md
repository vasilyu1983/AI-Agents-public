...
|---------|------------|-----------|
| Config (`Settings`, Pydantic) | `app/core/config.py` | [config-validation.md](../../../software-clean-code-standard/references/config-validation.md) |
| JWT (`create_access_token`, `decode_token`) | `app/core/security.py` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Password (`hash_password`, `verify_password`) | `app/core/security.py` | [auth-utilities.md](../../../software-clean-code-standard/references/auth-utilities.md) |
| Errors (`AppError`, exception handlers) | `app/core/errors.py` | [error-handling.md](../../../software-clean-code-standard/references/error-handling.md) |
| Logging (structlog setup) | `app/core/logging.py` | [logging-utilities.md](../../../software-clean-code-standard/references/logging-utilities.md) |
...
[tool.mypy]
# Match this to the interpreter in your Dockerfile (this template ships python:3.14-slim).
python_version = "3.13"
strict = true
