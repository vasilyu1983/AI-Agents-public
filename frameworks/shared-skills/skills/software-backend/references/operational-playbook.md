...
- [Pattern: GraphQL API Design](#pattern-graphql-api-design)
...
- [Pattern: Microservices & Circuit Breaker](#pattern-microservices--circuit-breaker)
...
- Treat **schema stitching** as a legacy composition technique, not the default for new distributed graphs
...
**Reference:** `../../software-clean-code-standard/references/auth-utilities.md` for shared auth/JWT/password-hashing utilities; `software-security-appsec` skill for threat-model-level guidance.
...
**Reference:** `../../software-clean-code-standard/references/error-handling.md` for shared error-class and Problem Details (RFC 9457) patterns.
...
**Reference:** `references/database-patterns.md` for PostgreSQL, connection pooling, migration, and index-design patterns.
...
## Pattern: Microservices & Circuit Breaker
...
**Reference:** `references/database-patterns.md` (Query Optimization, N+1 Detection) and `references/message-queues-background-jobs.md` for caching, pagination, and background-job performance patterns.
...
**Reference:** `../../software-clean-code-standard/references/testing-utilities.md` for shared unit/integration/E2E test scaffolding conventions.
...
**Reference:** `../../software-clean-code-standard/references/logging-utilities.md` and `../../software-clean-code-standard/references/observability-utilities.md` for shared logging/tracing conventions.
...
**Backend-Specific Security:** See `../../software-clean-code-standard/references/auth-utilities.md` for Node.js/Express-specific auth implementations.
...
- `nodejs/template-nodejs-fastify-drizzle-postgres.md` - Node.js + Fastify + Drizzle + PostgreSQL (SQL-first TypeScript)
- `go/template-go-fiber-gorm.md` - Go + Fiber + GORM + PostgreSQL (high-performance, native concurrency)
- `go/template-go-chi-sqlc-pgx.md` - Go + chi + sqlc + pgx + PostgreSQL (auditable SQL-first backend)
- `rust/template-rust-axum-seaorm.md` - Rust + Axum + SeaORM + PostgreSQL (memory-safe, zero-cost abstractions)
- `rust/template-rust-axum-sqlx.md` - Rust + Axum + SQLx + PostgreSQL (explicit SQL, compile-time checks)
...
- `database-patterns.md` - PostgreSQL, connection pooling, migrations, query optimization, N+1 detection.
- `message-queues-background-jobs.md` - Queues, background jobs, delivery guarantees, DLQs.
- `../../software-clean-code-standard/references/` - Shared auth, error-handling, logging, observability, and testing utilities (see Navigation section of SKILL.md for the full list).
- `backend-best-practices.md` - Meta-guide for adding new stack templates to this skill (not a patterns reference).
