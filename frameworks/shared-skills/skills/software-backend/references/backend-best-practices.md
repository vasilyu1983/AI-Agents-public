...
**Implementation Reference**: See [auth-utilities.md](../../software-clean-code-standard/references/auth-utilities.md) for Argon2id password hashing, jose JWT, and OAuth 2.1/PKCE patterns.
...
**Implementation Reference**: See [testing-utilities.md](../../software-clean-code-standard/references/testing-utilities.md) for Vitest, MSW v2, factories, and fixtures.
...
### High Priority
- [x] Python + FastAPI + SQLAlchemy + PostgreSQL
- [x] Go + Fiber + GORM + PostgreSQL
- [x] Go + chi + sqlc + pgx + PostgreSQL
- [x] Rust + Axum + SQLx + PostgreSQL
- [x] Node.js + Fastify + Drizzle + PostgreSQL
- [x] C# + ASP.NET Core + EF Core + PostgreSQL
...
- [auth-utilities.md](../../software-clean-code-standard/references/auth-utilities.md) - Argon2id password hashing, jose JWT, OAuth 2.1/PKCE
- [error-handling.md](../../software-clean-code-standard/references/error-handling.md) - Effect Result types, correlation IDs, error boundaries
- [config-validation.md](../../software-clean-code-standard/references/config-validation.md) - Zod 3.24+, Valibot, secrets management (1Password/Doppler)
- [resilience-utilities.md](../../software-clean-code-standard/references/resilience-utilities.md) - p-retry v6, opossum v8 circuit breaker, OTel spans
- [logging-utilities.md](../../software-clean-code-standard/references/logging-utilities.md) - pino v9 + OpenTelemetry integration
- [testing-utilities.md](../../software-clean-code-standard/references/testing-utilities.md) - Vitest, MSW v2, factories, fixtures
- [observability-utilities.md](../../software-clean-code-standard/references/observability-utilities.md) - OpenTelemetry SDK, tracing, metrics
