...
|---------|---------|---------|--------|------|
| Performance profile | Baseline | Lean and fast | Framework-heavy | Lightweight, especially for edge-style handlers |
...
Node.js moved to a one-major-release-per-year cadence starting with Node.js 26 (April 2026,
LTS promotion October 2026); the table below reflects that transition as of mid-2026 — verify
against the official schedule before pinning a version, since these dates hedge against
further schedule changes.

| Version | Status (as of July 2026) | Active LTS Start | Maintenance / EOL |
|---------|--------------------------|-------------------|--------------------|
| Node.js 26 | Current (promotes to Active LTS ~Oct 2026) | — | EOL ~April 2029 |
| Node.js 24 | Active LTS | October 2025 | Maintenance ~Oct 2026, EOL April 2028 |
| Node.js 22 | Maintenance LTS | October 2024 | EOL April 2027 |
| Node.js 20 | End of Life | October 2023 | EOL April 2026 (verify — may have already occurred) |
| Node.js 18 | End of Life | April 2023 | April 2025 |

**Recommendation (as of July 2026):** Use Node.js 24 (Active LTS) for new projects. Node.js 22
(Maintenance LTS) is acceptable for existing projects but should be on a migration path to 24 or
newer. Treat Node.js 20 as end-of-life for anything handling production traffic. Node version
support windows change frequently — re-verify at nodejs.org before committing to a version in a
long-lived project.

### Notable Node.js 24 Features

- V8 upgraded with further `require(esm)` interop improvements
- Native `WebSocket` client (stable)
- Built-in `fetch` (stable)
- `node --watch` for development
- Improved `node:test` runner
- Permission model and single-executable-application improvements continue to mature

**Always check [nodejs.org/en/about/releases/](https://nodejs.org/en/about/releases/) for the current LTS schedule — do not treat the table above as durable past your answer date.**
