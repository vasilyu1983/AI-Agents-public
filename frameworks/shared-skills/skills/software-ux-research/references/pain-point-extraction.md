...
- [B2C: App Store & Play Store](#b2c-app-store-&-play-store)
- [App Store Connect - Manual export](#app-store-connect-manual-export)
- [Play Console - Manual export](#play-console-manual-export)
- [AppFollow API (if using)](#appfollow-api-if-using)
- [B2B: G2, Capterra, TrustRadius](#b2b-g2-capterra-trustradius)
- [Support Tickets](#support-tickets)
- [Zendesk API](#zendesk-api)
- [Filter by tags: ux, bug, feature-request](#filter-by-tags-ux-bug-feature-request)
- [Intercom - Use Data Export feature](#intercom-use-data-export-feature)
- [NPS/CSAT Open-Ends](#npscsat-open-ends)
- [Extraction Process](#extraction-process)
- [Step 1: Categorize by Pain Point Type](#step-1-categorize-by-pain-point-type)
- [Step 2: Extract Themes](#step-2-extract-themes)
- [Step 3: Score & Prioritize](#step-3-score-&-prioritize)
- [Step 4: Map to User Journey](#step-4-map-to-user-journey)
- [Output Format](#output-format)
- [Pain Point Report Template](#pain-point-report-template)
- [Pain Point Report: [Product Name]](#pain-point-report-product-name)
...
- [Feature Requests (Evaluate)](#feature-requests-evaluate)
- [Summary](#summary)
- [Pain Point → UI Pattern Mapping](#pain-point-→-ui-pattern-mapping)
- [Frequency Tracking](#frequency-tracking)
- [Weekly Digest Format](#weekly-digest-format)
- [Weekly Feedback Digest: [Week of YYYY-MM-DD]](#weekly-feedback-digest-week-of-yyyy-mm-dd)
- [Volume](#volume)
- [Sentiment Trend](#sentiment-trend)
- [Top 3 Themes This Week](#top-3-themes-this-week)
- [New Pain Points (Not seen before)](#new-pain-points-not-seen-before)
- [Resolved (No longer appearing)](#resolved-no-longer-appearing)
- [Integration with JTBD Framework](#integration-with-jtbd-framework)
- [Optional: AI/Automation — Automation Options](#optional-aiautomation-—-automation-options)
- [Set Up Continuous Monitoring](#set-up-continuous-monitoring)
...
|-----------------|--------------------| ---------|
| **Slow loading** | Skeleton screens, optimistic UI | [modern-ux-patterns.md](../../software-ui-ux-design/references/modern-ux-patterns.md) |
...
| **Too many steps** | Progressive disclosure, wizards | [modern-ux-patterns.md](../../software-ui-ux-design/references/modern-ux-patterns.md) |
| **Can't find features** | Command palette, improved IA | [design-systems.md](../../software-ui-ux-design/references/design-systems.md) |
| **Empty states** | Action-oriented prompts, templates | [modern-ux-patterns.md](../../software-ui-ux-design/references/modern-ux-patterns.md) |
...
| **Onboarding confusion** | Guided tours, checklist progress | [modern-ux-patterns.md](../../software-ui-ux-design/references/modern-ux-patterns.md) |
| **Accessibility issues** | WCAG compliance | [wcag-accessibility.md](../../software-ui-ux-design/references/wcag-accessibility.md) |
| **Visual clutter** | Whitespace, hierarchy, grouping | [frontend-aesthetics.md](../../software-ui-ux-design/references/frontend-aesthetics.md) |
...
See [research-frameworks.md](research-frameworks.md) for full JTBD methodology.
...
- Commercial model: free tier plus paid plans; verify current pricing before recommending
...
- Quarterly reports
- Commercial model: sales-led; verify current packaging before recommending
