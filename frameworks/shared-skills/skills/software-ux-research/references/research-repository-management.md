# Research Repository Management — Operations Guide
...
Commercial packaging and pricing change frequently. Verify vendor pricing pages before making tool or budget recommendations.

---
## Table of Contents

- [What Is a Research Repository?](#what-is-a-research-repository)
- [Repository vs File Storage](#repository-vs-file-storage)
- [Repository Architecture](#repository-architecture)
- [Tool Selection](#tool-selection)
- [Decision Framework](#decision-framework)
- [Minimum Viable Repository (Notion/Airtable)](#minimum-viable-repository-notionairtable)
- [Taxonomy Design](#taxonomy-design)
- [Taxonomy Dimensions](#taxonomy-dimensions)
- [Taxonomy Governance](#taxonomy-governance)
- [Common Taxonomy Mistakes](#common-taxonomy-mistakes)
- [Atomic Research Model](#atomic-research-model)
- [The Atomic Structure](#the-atomic-structure)
- [Rules for Atomic Insights](#rules-for-atomic-insights)
- [Composing Insights](#composing-insights)
- [Search and Retrieval Patterns](#search-and-retrieval-patterns)
- [Effective Repository Search](#effective-repository-search)
- [Making Research Findable](#making-research-findable)
- [Research Decay](#research-decay)
- [Freshness Framework](#freshness-framework)
- [Exceptions](#exceptions)
- [Implementing Decay](#implementing-decay)
- [Access Control and PII Handling](#access-control-and-pii-handling)
- [Data Classification](#data-classification)
- [PII Handling Protocol](#pii-handling-protocol)
- [GDPR Compliance](#gdpr-compliance)
- [Integration with Product Management Tools](#integration-with-product-management-tools)
- [Integration Patterns](#integration-patterns)
- [Linking Research to Product Decisions](#linking-research-to-product-decisions)
- [Measuring Repository Adoption and Research Reuse](#measuring-repository-adoption-and-research-reuse)
- [Adoption Metrics](#adoption-metrics)
- [Research Reuse Indicators](#research-reuse-indicators)
- [ROI of Research Repository](#roi-of-research-repository)
- [Building Research Culture Through Repository Access](#building-research-culture-through-repository-access)
- [Strategies for Adoption](#strategies-for-adoption)
...
| Tool | Best For | Strengths | Limitations | Budget fit |
|------|----------|-----------|-------------|------------|
| **Dovetail** | Dedicated research teams | Purpose-built for research, video coding, tagging, analysis | Cost scales with team | Medium to high |
| **EnjoyHQ** | Scaling research ops | Strong taxonomy, integrations, customer feedback ingestion | Steeper learning curve | Enterprise |
| **Notion** | Small teams, DIY approach | Flexible, cheap, team already uses it | No purpose-built research features | Low |
| **Airtable** | Structured data teams | Relational database model, views, automations | Requires setup effort | Low to medium |
| **Condens** | Qualitative analysis focus | Affinity mapping, video highlights, tagging | Smaller ecosystem | Medium |
| **Productboard** | PM-led organizations | Insights tied to features/roadmap, customer portal | More PM tool than research tool | Medium to high |
...
- **Cross-border transfer (Chapter V)**: when participant data leaves the EU/UK (most US-hosted research SaaS), the controller must use SCCs, an adequacy decision, or BCRs. Verify the AI vendor's current transfer mechanism — relying on "we're in the US so it's fine" is not compliant.

### EU AI Act — Compliance Action Items

GPAI provider obligations have applied since 2 August 2025; high-risk (Annex III) deployer obligations were postponed from 2 August 2026 to **2 December 2027** under the Digital Omnibus on AI, which has now cleared both the European Parliament (16 June 2026) and the Council (29 June 2026) and enters into force shortly after Official Journal publication (verify the exact in-force date before treating it as settled). Any research operation using AI tools to process participant recordings or transcripts must complete the following:

| Action | Why |
|--------|-----|
| Inventory every AI tool that touches participant data (transcription, sentiment, tagging, summarisation, AI moderators) | Required to determine deployer obligations and risk classification |
| Update participant consent forms to explicitly disclose AI processing, the tools used, retention, and any non-EU processing | Transparency obligation; also closes a GDPR Article 13 gap |
| Update Data Processing Agreements with each AI vendor; confirm sub-processors and EU representative | DPA freshness becomes audit material |
| Document the legal basis for AI processing (usually legitimate interest with opt-out; explicit consent for sensitive contexts) | Required record of processing |
| Determine whether any tool falls under Annex III high-risk (research about employment, education, public services) | Triggers Fundamental Rights Impact Assessment (FRIA) before first use |
| Train research-ops on the disclosure script: "we use [tool] to transcribe and analyse this session — your data is processed [where] for [retention]" | Required for valid consent |

Treating "AI processed it" as anonymisation is not GDPR-compliant. Output of an AI run on identifiable input data inherits the input's classification until it is genuinely de-identified by a separate process.

Sources: [European Commission — AI Act regulatory framework](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai), [IAPP — GDPR + EU AI Act interplay](https://iapp.org/resources/article/mapping-interplays-gdpr-eu-ai-act). See also [ai-in-research.md](ai-in-research.md) for the full AI workflow guidance.
...
```text
Annual investment:
  Tool and setup cost: low / medium / high, depending on stack and seats
  Maintenance: recurring researcher or ops time

Annual value (conservative):
  Studies not repeated: fewer duplicate studies and faster reuse
  Faster decisions: less time spent rediscovering existing evidence
  Better decisions: often the highest value, but usually measured qualitatively first

Measure ROI using:
  repeated studies prevented
  decisions influenced by repository evidence
  time saved locating prior findings
  increase in research citations in tickets and briefs
```
...
- [Dovetail — UX Research Repository](https://dovetail.com/solution/ux-research-repository/)
