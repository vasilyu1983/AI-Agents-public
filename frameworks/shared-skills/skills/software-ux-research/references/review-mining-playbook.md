...
- [Quick Reference: Which Platform for What](#quick-reference-which-platform-for-what)
- [B2C: App Store Mining](#b2c-app-store-mining)
- [Access Methods](#access-methods)
- [Get reviews via App Store Connect API](#get-reviews-via-app-store-connect-api)
- [Requires: API Key from App Store Connect](#requires-api-key-from-app-store-connect)
- [Star Rating Decoder](#star-rating-decoder)
- [Extraction Workflow](#extraction-workflow)
- [Theme Summary: [App Name] - [Date Range]](#theme-summary-app-name-date-range)
- [Top 5 Pain Points (1-2 star reviews)](#top-5-pain-points-1-2-star-reviews)
- [Most Requested Features (3-4 star reviews)](#most-requested-features-3-4-star-reviews)
- [Delight Signals (5 star reviews)](#delight-signals-5-star-reviews)
- [Competitor Review Mining (App Store)](#competitor-review-mining-app-store)
- [B2C: Play Store Mining](#b2c-play-store-mining)
- [Access Methods](#access-methods)
- [Reviews API](#reviews-api)
- [Requires OAuth 2.0 token with Play Developer API access](#requires-oauth-20-token-with-play-developer-api-access)
- [Android-Specific Signals](#android-specific-signals)
- [Cross-Platform Analysis](#cross-platform-analysis)
- [Cross-Platform Pain Point Comparison](#cross-platform-pain-point-comparison)
- [B2B: G2 Mining](#b2b-g2-mining)
- [Why G2 Matters](#why-g2-matters)
- [Access Methods](#access-methods)
- [G2 Review Structure](#g2-review-structure)
- [Extraction Process](#extraction-process)
- [Win/Loss from G2 Reviews](#winloss-from-g2-reviews)
- [B2B: TrustRadius Mining](#b2b-trustradius-mining)
- [Why TrustRadius](#why-trustradius)
- [TrustRadius Review Structure](#trustradius-review-structure)
- [Extraction Focus: Cons + Alternatives](#extraction-focus-cons-alternatives)
- [B2B: Capterra Mining](#b2b-capterra-mining)
- [Capterra Characteristics](#capterra-characteristics)
- [When to Use Capterra](#when-to-use-capterra)
- [Extraction Process](#extraction-process)
- [Optional: AI/Automation — LLM Prompts](#optional-aiautomation-—-llm-prompts)
- [Bulk Review Analysis](#bulk-review-analysis)
- [Competitive Gap Analysis](#competitive-gap-analysis)
- [Theme Clustering](#theme-clustering)
- [Response Strategy](#response-strategy)
- [When to Respond](#when-to-respond)
- [Response Template (Negative)](#response-template-negative)
- [Optional: AI/Automation — Automation Setup](#optional-aiautomation-—-automation-setup)
- [AppFollow (B2C)](#appfollow-b2c)
- [G2 Seller (B2B)](#g2-seller-b2b)
- [Custom Monitoring (Zapier + LLM API)](#custom-monitoring-zapier-llm-api)
- [Output Templates](#output-templates)
- [Weekly Review Digest](#weekly-review-digest)
- [Competitive Review Matrix](#competitive-review-matrix)
- [Pain Point Report](#pain-point-report)
