...
- [UX Metrics Overview](#ux-metrics-overview)
- [Behavioral vs Attitudinal Metrics](#behavioral-vs-attitudinal-metrics)
- [Leading vs Lagging Indicators](#leading-vs-lagging-indicators)
- [HEART Framework (Google)](#heart-framework-google)
- [Goals-Signals-Metrics (GSM)](#goals-signals-metrics-gsm)
- [Task-Level Metrics](#task-level-metrics)
- [Task Success Rate (TSR)](#task-success-rate-tsr)
- [Time on Task (ToT)](#time-on-task-tot)
- [Error Rate](#error-rate)
- [Lostness Score](#lostness-score)
- [Study-Level Metrics](#study-level-metrics)
- [System Usability Scale (SUS)](#system-usability-scale-sus)
- [UMUX-Lite](#umux-lite)
- [Single Ease Question (SEQ)](#single-ease-question-seq)
- [After-Scenario Questionnaire (ASQ)](#after-scenario-questionnaire-asq)
- [Product-Level Metrics](#product-level-metrics)
...
- [Concept](#concept)
- [North Star Characteristics](#north-star-characteristics)
- [Examples by Product Type](#examples-by-product-type)
- [Input Metrics Hierarchy](#input-metrics-hierarchy)
- [Metric Tree Construction](#metric-tree-construction)
- [Metrics Dashboard Design](#metrics-dashboard-design)
- [Key Metrics Selection](#key-metrics-selection)
- [Visualization Best Practices](#visualization-best-practices)
- [Alerting Thresholds](#alerting-thresholds)
- [Trend Analysis](#trend-analysis)
- [Metrics Selection Decision Tree](#metrics-selection-decision-tree)
- [Benchmarking Resources](#benchmarking-resources)
- [Industry Benchmark Sources](#industry-benchmark-sources)
- [Creating Internal Benchmarks](#creating-internal-benchmarks)
...
**Industry Benchmarks** (verify current):
