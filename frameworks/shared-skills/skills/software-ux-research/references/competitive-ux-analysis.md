...
- [Competitor Types](#competitor-types)
- [Selection Matrix](#selection-matrix)
- [Competitor Research Sources](#competitor-research-sources)
- [UX Pattern Analysis](#ux-pattern-analysis)
- [Navigation Patterns Comparison](#navigation-patterns-comparison)
- [Onboarding Flow Analysis](#onboarding-flow-analysis)
- [Error Handling Comparison](#error-handling-comparison)
- [Mobile Experience Benchmarking](#mobile-experience-benchmarking)
- [Feature Comparison Matrix](#feature-comparison-matrix)
- [Feature Parity Analysis](#feature-parity-analysis)
- [UX Quality Scoring](#ux-quality-scoring)
- [Industry Benchmarks](#industry-benchmarks)
- [E-commerce UX Standards (Baymard Institute)](#e-commerce-ux-standards-baymard-institute)
- [SaaS UX Standards](#saas-ux-standards)
- [Mobile App Standards](#mobile-app-standards)
- [Case Studies: Top Companies](#case-studies-top-companies)
- [Optional: Assistant/Automation UX Benchmark](#optional-assistantautomation-ux-benchmark)
- [Apple](#apple)
- [Stripe](#stripe)
- [Notion](#notion)
- [Linear](#linear)
...
- [Task Completion Comparison](#task-completion-comparison)
- [Error Rate Comparison](#error-rate-comparison)
- [User Satisfaction Benchmarks](#user-satisfaction-benchmarks)
- [Competitive Report Structure](#competitive-report-structure)
- [Executive Summary](#executive-summary)
- [Feature-by-Feature Analysis](#feature-by-feature-analysis)
- [UX Pattern Learnings](#ux-pattern-learnings)
- [Recommendations Prioritization](#recommendations-prioritization)
...
- [Domain-Specific UX Flow Patterns](#domain-specific-ux-flow-patterns)
- [Fintech: Money Transfer Flow](#fintech-money-transfer-flow)
- [Fintech: KYC/Onboarding Flow](#fintech-kyconboarding-flow)
- [E-commerce: Checkout Flow](#e-commerce-checkout-flow)
- [SaaS: Onboarding Flow](#saas-onboarding-flow)
- [Developer Tools: API Documentation](#developer-tools-api-documentation)
- [Healthcare: Appointment Booking](#healthcare-appointment-booking)
- [Flow Pattern Usage Guide](#flow-pattern-usage-guide)
- [How to Use These Patterns](#how-to-use-these-patterns)
- [Pattern Adaptation Checklist](#pattern-adaptation-checklist)
- [WebSearch Queries for Flow Research](#websearch-queries-for-flow-research)
