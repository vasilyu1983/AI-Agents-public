...
- [1. Digital Literacy Assessment Framework](#1-digital-literacy-assessment-framework)
- [Tiers and Behavioral Indicators](#tiers-and-behavioral-indicators)
- [Quick Assessment Protocol (5 minutes)](#quick-assessment-protocol-5-minutes)
- [2. Recruitment](#2-recruitment)
- [Channels (Offline-First)](#channels-offline-first)
- [Screening Questions (Plain Language)](#screening-questions-plain-language)
- [Recruitment Anti-Patterns](#recruitment-anti-patterns)
- [3. Research Method Adaptations](#3-research-method-adaptations)
- [Usability Testing Adaptations](#usability-testing-adaptations)
- [Interview Adaptations](#interview-adaptations)
- [Survey Adaptations](#survey-adaptations)
- [Contextual Inquiry Adaptations](#contextual-inquiry-adaptations)
- [4. Simplification-Specific Research Questions](#4-simplification-specific-research-questions)
- [Discovery Phase](#discovery-phase)
- [Validation Phase](#validation-phase)
- [Evaluative Phase](#evaluative-phase)
- [5. Metrics](#5-metrics)
- [Primary Metrics](#primary-metrics)
- [Secondary Metrics](#secondary-metrics)
- [Anti-Metrics (Track but Don't Optimize)](#anti-metrics-track-but-dont-optimize)
- [6. Simplification Audit Research Protocol](#6-simplification-audit-research-protocol)
- [Step 1: Heuristic Pre-Audit (1 day)](#step-1-heuristic-pre-audit-1-day)
- [Step 2: Recruit (3-5 days)](#step-2-recruit-3-5-days)
- [Step 3: Task-Based Usability Test (1-2 days)](#step-3-task-based-usability-test-1-2-days)
- [Step 4: Comprehension Check (During Session)](#step-4-comprehension-check-during-session)
- [Step 5: Analyze and Map](#step-5-analyze-and-map)
- [Step 6: Report and Recommend](#step-6-report-and-recommend)
- [7. Common Findings Patterns](#7-common-findings-patterns)
