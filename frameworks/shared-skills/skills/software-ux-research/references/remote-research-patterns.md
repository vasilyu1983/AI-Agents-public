# Remote Research Patterns — Methods and Operations Guide
...
Commercial packaging and pricing change frequently. Verify vendor pricing pages before recommending a tool or budget.

---
## Table of Contents

- [Remote Research Landscape](#remote-research-landscape)
- [When Remote Works Best vs In-Person](#when-remote-works-best-vs-in-person)
- [Moderated Remote Research](#moderated-remote-research)
- [Tool Selection](#tool-selection)
- [Session Structure](#session-structure)
- [Facilitation Tips for Remote](#facilitation-tips-for-remote)
- [Unmoderated Testing](#unmoderated-testing)
- [Platform Comparison](#platform-comparison)
- [Task Design for Unmoderated Testing](#task-design-for-unmoderated-testing)
- [Unmoderated Test Structure](#unmoderated-test-structure)
- [Key Metrics from Unmoderated Tests](#key-metrics-from-unmoderated-tests)
- [Asynchronous Research Methods](#asynchronous-research-methods)
- [Diary Studies](#diary-studies)
- [Card Sorts](#card-sorts)
- [Tree Tests](#tree-tests)
- [Participant Recruitment for Remote Research](#participant-recruitment-for-remote-research)
- [Recruitment Channels](#recruitment-channels)
- [Screener Design](#screener-design)
- [Recording and Consent](#recording-and-consent)
- [Legal Requirements](#legal-requirements)
- [Consent Form Elements](#consent-form-elements)
- [Tool Setup for Recording](#tool-setup-for-recording)
- [International Remote Research](#international-remote-research)
- [Timezone Management](#timezone-management)
- [Working with Interpreters](#working-with-interpreters)
- [International Research Considerations](#international-research-considerations)
- [Analysis of Remote Research Data](#analysis-of-remote-research-data)
- [Video Coding](#video-coding)
- [Theme Extraction Process](#theme-extraction-process)
- [Synthesis Template](#synthesis-template)
- [Remote Research vs In-Person: Decision Matrix](#remote-research-vs-in-person-decision-matrix)
- [Tool Comparison: Maze vs UserTesting vs Lyssna vs Optimal Workshop](#tool-comparison-maze-vs-usertesting-vs-lyssna-vs-optimal-workshop)
...
| Tool | Type | Best For | Recording | Budget fit |
|------|------|----------|-----------|------------|
| **Zoom** | General video call | Interviews, most common, universal access | Cloud recording, transcription | Low to medium |
| **Lookback** | Research-specific | Moderated + unmoderated, participant view | Multi-stream (face + screen), timestamped notes | Medium to high |
| **UserTesting** (Live Conversation) | Research platform | Moderated testing with recruitment panel | Integrated recording + analysis | Enterprise |
| **dscout** | Mobile diary + live | Mobile-first moderated research, diary studies | In-app recording | Enterprise |
| **Microsoft Teams** | Enterprise | Organizations already on Microsoft ecosystem | Cloud recording, transcription | Existing suite |
| **Google Meet** | Simple, accessible | Quick sessions, no participant software install | Recording to Drive | Existing suite |
...
| Platform | Strengths | Participant Source | Analysis Features | Budget fit |
|----------|-----------|-------------------|-------------------|------------|
| **Maze** | Fast setup, prototype testing (Figma integration), metrics dashboard | Your users or Maze panel | Heatmaps, misclick maps, task success rates | Low to medium |
| **UserTesting** | Large panel, screener quality, video analysis | 2M+ panel, or your users | Highlight reels, theme tagging, sentiment | Enterprise |
| **Lyssna** (formerly UsabilityHub) | Card sorts, tree tests, first-click, preference tests | Built-in panel or your users | Statistical analysis, demographic filtering | Medium |
| **Optimal Workshop** | IA-focused: card sorts, tree tests, first-click | Built-in panel or your users | Dendrograms, matrices, statistical tools | Medium |
| **Hotjar** | Integrated with heatmaps and recordings | Your website visitors | Session replay, funnel analysis | Low to medium |
| **Playbook UX** | Figma prototype testing | Your users or panel | Click paths, task completion, SUS | Low |
...
| Channel | Speed | Budget fit | Quality | Best For |
|---------|-------|------------|---------|----------|
| **Your own users** (email, in-app) | Medium (1-2 weeks) | Low | High (real users) | Product-specific research |
| **Prolific** | Fast (hours-days) | Medium | High (academic-grade) | Specific demographics, non-users |
| **UserTesting panel** | Fast (hours) | High | Medium-High | Quick unmoderated tests |
| **Respondent.io** | Fast (days) | High | High | B2B, niche professionals |
| **Social media** | Variable | Low | Variable (self-selection) | Broad audience, early-stage |
| **User Interviews** | Fast (days) | Medium to high | High | B2B and consumer recruitment |
...
| **Budget fit** | Low to medium | Enterprise | Medium | Medium |
...
- [Maze — Usability Testing Guide](https://maze.co/guides/usability-testing/)
