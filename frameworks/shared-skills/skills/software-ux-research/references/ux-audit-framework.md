...
- [What is a UX Audit?](#what-is-a-ux-audit)
- [Audit Types](#audit-types)
- [When to Audit](#when-to-audit)
- [Extended Heuristic Evaluation](#extended-heuristic-evaluation)
- [Nielsen's 10 Usability Heuristics](#nielsens-10-usability-heuristics)
- [Gerhardt-Powals Cognitive Principles](#gerhardt-powals-cognitive-principles)
- [Weinschenk & Barker Categories](#weinschenk-&-barker-categories)
- [Evaluation Matrix Template](#evaluation-matrix-template)
- [Cognitive Walkthrough Protocol](#cognitive-walkthrough-protocol)
- [Core Concept](#core-concept)
- [Four Questions per Step](#four-questions-per-step)
- [Walkthrough Process](#walkthrough-process)
- [Walkthrough Documentation Template](#walkthrough-documentation-template)
- [Accessibility Audit Component](#accessibility-audit-component)
- [Quick WCAG 2.2 Checklist](#quick-wcag-22-checklist)
...
- [5-Level Severity Scale](#5-level-severity-scale)
- [Severity Decision Matrix](#severity-decision-matrix)
- [Frequency x Impact Scoring](#frequency-x-impact-scoring)
- [Gap Analysis Patterns](#gap-analysis-patterns)
- [Current vs. Expected State](#current-vs-expected-state)
- [Pain Point Clustering](#pain-point-clustering)
...
- [Phased Improvement Roadmap](#phased-improvement-roadmap)
- [Audit Report Structure](#audit-report-structure)
- [Executive Summary (1 page)](#executive-summary-1-page)
- [Detailed Findings (Main Report)](#detailed-findings-main-report)
- [Appendix](#appendix)
- [Audit Checklist by Product Type](#audit-checklist-by-product-type)
