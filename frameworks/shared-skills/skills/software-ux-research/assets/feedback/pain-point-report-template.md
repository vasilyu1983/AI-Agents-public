...
**Analyst**: [Name]
**Sources Analyzed**: [App Store, G2, Zendesk, NPS, etc.]
...
**Top 3 Priorities**:
1. [Pain point 1] — [Impact summary]
2. [Pain point 2] — [Impact summary]
3. [Pain point 3] — [Impact summary]
...
|------------|------------------|------------------|----------|
| Slow loading | Loading states | Skeleton screens | [../../software-ui-ux-design/references/modern-ux-patterns.md] |
| Confusing navigation | Information architecture | Breadcrumbs, tabs | [nielsen-heuristics.md] |
| Too many steps | Progressive disclosure | Wizards, chunking | [../../software-ui-ux-design/references/modern-ux-patterns.md] |
| Can't find feature | Search/discovery | Command palette | [design-systems.md] |
| Empty state confusion | Onboarding | Action prompts | [../../software-ui-ux-design/references/modern-ux-patterns.md] |
...
1. [ ] **Critical fixes**: [Owner] to address by [Date]
2. [ ] **High priority review**: Product team to triage [Date]
3. [ ] **Feature requests**: PM to evaluate for roadmap
4. [ ] **Next report**: Schedule for [Date]
...
4. Add rows as needed to tables
5. Link to design pattern resources

**Output feeds**:
- `software-ui-ux-design` skill for pattern selection
- Product roadmap for feature prioritization
