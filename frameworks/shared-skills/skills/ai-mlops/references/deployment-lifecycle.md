...
Use this when the user needs the end-to-end promotion path from frozen artifact to operated service and retirement.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [Pattern 1: Standard Deployment Lifecycle](#pattern-1-standard-deployment-lifecycle)
- [Five Phases](#five-phases)
- [Phase 1: Pre-Deploy](#phase-1-pre-deploy)
- [Phase 2: Deploy](#phase-2-deploy)
- [Phase 3: Observe](#phase-3-observe)
- [Phase 4: Operate](#phase-4-operate)
- [Phase 5: Evolve](#phase-5-evolve)
- [Pattern 2: Environment Management](#pattern-2-environment-management)
- [Dev Environment](#dev-environment)
- [Staging Environment](#staging-environment)
- [Production Environment](#production-environment)
- [Pattern 3: Deployment Automation](#pattern-3-deployment-automation)
- [CI/CD Pipeline](#cicd-pipeline)
- [Pattern 4: Gradual Rollout Strategies](#pattern-4-gradual-rollout-strategies)
- [Canary Deployment](#canary-deployment)
- [Blue-Green Deployment](#blue-green-deployment)
- [Shadow Deployment](#shadow-deployment)
- [Pattern 5: Rollback Procedures](#pattern-5-rollback-procedures)
- [When to Rollback](#when-to-rollback)
- [Rollback Checklist](#rollback-checklist)
- [Post-Rollback Actions](#post-rollback-actions)
- [Real-World Example: Fraud Detection Model Deployment](#real-world-example-fraud-detection-model-deployment)
- [Context](#context)
