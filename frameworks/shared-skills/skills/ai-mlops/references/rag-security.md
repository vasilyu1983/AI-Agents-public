...
Use this when retrieval content, indexes, or metadata can be attacker-controlled or cross-tenant sensitive.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [Threats in RAG Pipelines](#threats-in-rag-pipelines)
- [1. Retrieval Injection](#1-retrieval-injection)
- [Product Documentation](#product-documentation)
- [Actual Product Info](#actual-product-info)
- [2. Poisoned Chunks](#2-poisoned-chunks)
- [3. Malicious Formatting](#3-malicious-formatting)
- [4. Context Hijacks](#4-context-hijacks)
- [5. Metadata Manipulation](#5-metadata-manipulation)
- [Defenses](#defenses)
- [1. Document Sanitization](#1-document-sanitization)
- [2. Metadata Filtering](#2-metadata-filtering)
- [3. Guarded Chunk Ingestion](#3-guarded-chunk-ingestion)
- [4. Grounding Constraints in Prompt](#4-grounding-constraints-in-prompt)
- [System Prompt Example](#system-prompt-example)
- [5. Output Grounding Validation](#5-output-grounding-validation)
- [RAG Security Hardening Checklist](#rag-security-hardening-checklist)
- [Real-World Example: Hardened RAG Pipeline](#real-world-example-hardened-rag-pipeline)
