...
Use this when the user needs agent runtime telemetry, replay, tool-call tracing, or production debugging.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [AgentOps vs MLOps vs LLMOps](#agentops-vs-mlops-vs-llmops)
- [Core AgentOps Capabilities](#core-agentops-capabilities)
- [1. Session Tracing & Replay](#1-session-tracing-&-replay)
- [Initialize at agent startup](#initialize-at-agent-startup)
- [Automatic instrumentation captures:](#automatic-instrumentation-captures)
- [- All LLM calls](#all-llm-calls)
- [- Tool usage](#tool-usage)
- [- Agent state transitions](#agent-state-transitions)
- [- Cost and latency metrics](#cost-and-latency-metrics)
- [2. Cost & Latency Tracking](#2-cost-&-latency-tracking)
- [3. Multi-Agent Visualization](#3-multi-agent-visualization)
- [4. Debugging & Root Cause Analysis](#4-debugging-&-root-cause-analysis)
- [AgentOps Tools & Platforms](#agentops-tools-&-platforms)
- [Dedicated AgentOps Platforms](#dedicated-agentops-platforms)
- [Agent Frameworks with Built-in Observability](#agent-frameworks-with-built-in-observability)
- [Implementation Patterns](#implementation-patterns)
- [Pattern 1: Minimal AgentOps Setup](#pattern-1-minimal-agentops-setup)
- [Set API key](#set-api-key)
- [Automatic instrumentation - no code changes to agents](#automatic-instrumentation-no-code-changes-to-agents)
- [Your CrewAI code runs as normal](#your-crewai-code-runs-as-normal)
- [All LLM calls, tool usage automatically tracked](#all-llm-calls-tool-usage-automatically-tracked)
- [Pattern 2: OpenTelemetry-Based Tracing](#pattern-2-opentelemetry-based-tracing)
- [Initialize tracer](#initialize-tracer)
- [Instrument agent execution](#instrument-agent-execution)
- [Pattern 3: Langfuse Open-Source Setup](#pattern-3-langfuse-open-source-setup)
- [AgentOps Metrics & Alerts](#agentops-metrics-&-alerts)
- [Core Metrics to Track](#core-metrics-to-track)
- [Alert Thresholds](#alert-thresholds)
- [AgentOps Workflow Checklist](#agentops-workflow-checklist)
- [Pre-Production](#pre-production)
- [Production Monitoring](#production-monitoring)
- [Incident Response](#incident-response)
- [OpenTelemetry Semantic Conventions for GenAI](#opentelemetry-semantic-conventions-for-genai)
...
def run_agent(user_input: str):
    with tracer.start_as_current_span("agent_session") as session_span:
        ...
        with tracer.start_as_current_span("llm_call") as llm_span:
            ...
            llm_span.set_attribute("model", response.model)  # use actual model ID from response, not hardcoded
