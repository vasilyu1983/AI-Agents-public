...
Use this when the user needs contracts, incremental syncs, lineage, replay, or schema evolution for ML data feeds.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [Pattern 1: Data Contracts](#pattern-1-data-contracts)
- [Definition](#definition)
- [Components](#components)
- [Implementation Checklist](#implementation-checklist)
- [Example Contract (YAML)](#example-contract-yaml)
- [Pattern 2: Ingestion Modes](#pattern-2-ingestion-modes)
- [CDC (Change Data Capture)](#cdc-change-data-capture)
- [Batch Ingestion](#batch-ingestion)
- [Streaming Ingestion](#streaming-ingestion)
- [Pattern 3: Lineage Tracking](#pattern-3-lineage-tracking)
- [Purpose](#purpose)
- [What to Track](#what-to-track)
- [Implementation](#implementation)
- [Checklist](#checklist)
- [Pattern 4: Schema Evolution](#pattern-4-schema-evolution)
- [Strategies](#strategies)
- [Migration Approaches](#migration-approaches)
- [Checklist](#checklist)
- [Pattern 5: Replay & Backfill](#pattern-5-replay-&-backfill)
- [Purpose](#purpose)
- [Replay Requirements](#replay-requirements)
- [Backfill Strategies](#backfill-strategies)
- [Checklist](#checklist)
- [Pattern 6: Data Quality Validation](#pattern-6-data-quality-validation)
- [Validation Layers](#validation-layers)
- [Quality Gates](#quality-gates)
- [Checklist](#checklist)
- [Real-World Example: E-Commerce Events Pipeline](#real-world-example-e-commerce-events-pipeline)
- [Setup](#setup)
