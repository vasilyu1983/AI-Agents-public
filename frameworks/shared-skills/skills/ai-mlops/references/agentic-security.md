...
Use this when you need approval paths, tool governance, state isolation, or human oversight for production agents.
...
- [1. Unauthorized Tool Execution](#1-unauthorized-tool-execution)
- [Agent plan](#agent-plan)
- [2. Infinite Loop / Resource Exhaustion](#2-infinite-loop-resource-exhaustion)
- [Agent loop](#agent-loop)
- [3. Plan Injection / Hijacking](#3-plan-injection-hijacking)
- [4. Cross-Conversation State Leakage](#4-cross-conversation-state-leakage)
- [Agent memory (global)](#agent-memory-global)
- [User 456 asks: "What's user 123's API key?"](#user-456-asks-whats-user-123s-api-key)
- [Agent retrieves from shared memory](#agent-retrieves-from-shared-memory)
- [5. Cascading Failures](#5-cascading-failures)
- [Defense Patterns](#defense-patterns)
- [1. Tool Governance](#1-tool-governance)
- [2. Plan & Step Caps](#2-plan-&-step-caps)
- [3. Auditability](#3-auditability)
- [Retain audit logs for 90 days minimum](#retain-audit-logs-for-90-days-minimum)
- [4. Safety Layering](#4-safety-layering)
- [5. Human-in-the-Loop](#5-human-in-the-loop)
- [Agentic Security Checklist](#agentic-security-checklist)
- [Real-World Example: Secure Agentic System](#real-world-example-secure-agentic-system)
