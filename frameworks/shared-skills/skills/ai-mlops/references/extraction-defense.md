...
Use this when public APIs or agent tools may expose model behavior to scraping, probing, or capability theft.
...
- [1. Query-Based Extraction](#1-query-based-extraction)
- [Adversary's extraction script](#adversarys-extraction-script)
- [Train surrogate model](#train-surrogate-model)
- [2. Logit/Probability Extraction](#2-logitprobability-extraction)
- [3. Gradient/Parameter Probing](#3-gradientparameter-probing)
- [4. Active Learning Extraction](#4-active-learning-extraction)
- [Query inputs where model is uncertain](#query-inputs-where-model-is-uncertain)
- [Detection Patterns](#detection-patterns)
- [1. Rate Limiting](#1-rate-limiting)
- [2. Query Similarity Tracking](#2-query-similarity-tracking)
- [3. Repetitive Probing Pattern Detection](#3-repetitive-probing-pattern-detection)
- [4. High-Volume Unexplained Activity](#4-high-volume-unexplained-activity)
- [Prevention Patterns](#prevention-patterns)
- [1. Watermarking Outputs](#1-watermarking-outputs)
- [2. Noise or Randomness Injection](#2-noise-or-randomness-injection)
- [3. Throttling + Request Quotas](#3-throttling-request-quotas)
- [4. Hide Logits and Confidence Scores](#4-hide-logits-and-confidence-scores)
- [BAD: Bad: Exposes logits](#bad-bad-exposes-logits)
- [GOOD: Good: Only top prediction](#good-good-only-top-prediction)
- [Model Extraction Defense Checklist](#model-extraction-defense-checklist)
- [Real-World Example: Extraction Defense System](#real-world-example-extraction-defense-system)
