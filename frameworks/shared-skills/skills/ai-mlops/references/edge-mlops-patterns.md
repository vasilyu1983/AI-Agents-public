...
Use this when the user is deploying to constrained devices, OTA update paths, or intermittently connected fleets.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [Edge vs Cloud MLOps](#edge-vs-cloud-mlops)
- [Core Edge MLOps Patterns](#core-edge-mlops-patterns)
- [Pattern 1: Device-Aware CI/CD](#pattern-1-device-aware-cicd)
- [.github/workflows/edge-mlops.yml](#githubworkflowsedge-mlopsyml)
- [Pattern 2: OTA Model Updates](#pattern-2-ota-model-updates)
- [Pattern 3: Federated Learning Operations](#pattern-3-federated-learning-operations)
- [Pattern 4: Edge Drift Detection](#pattern-4-edge-drift-detection)
- [Pattern 5: Intermittent Connectivity Handling](#pattern-5-intermittent-connectivity-handling)
- [TinyML Specifics](#tinyml-specifics)
- [Memory Constraints](#memory-constraints)
- [Model Optimization Techniques](#model-optimization-techniques)
- [TinyML Frameworks](#tinyml-frameworks)
- [Edge MLOps Platforms](#edge-mlops-platforms)
- [Monitoring & Observability](#monitoring-&-observability)
- [Batched Telemetry Pattern](#batched-telemetry-pattern)
- [Key Metrics for Edge](#key-metrics-for-edge)
- [Checklist: Edge MLOps Readiness](#checklist-edge-mlops-readiness)
