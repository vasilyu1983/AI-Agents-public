...
Use this when you need request/response contracts, reliability controls, or observability requirements for ML and LLM endpoints.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [1. Input Schema Design](#1-input-schema-design)
- [Best Practices](#best-practices)
- [2. Output Schema Design](#2-output-schema-design)
- [Example](#example)
- [3. API Reliability Patterns](#3-api-reliability-patterns)
- [Pattern 1: Timeouts & Retries](#pattern-1-timeouts-&-retries)
- [Pattern 2: Circuit Breakers](#pattern-2-circuit-breakers)
- [Pattern 3: Rate Limiting](#pattern-3-rate-limiting)
- [4. Feature Enrichment Patterns](#4-feature-enrichment-patterns)
- [1. Pre-request enrichment](#1-pre-request-enrichment)
- [2. Real-time feature lookup](#2-real-time-feature-lookup)
- [3. Post-processing](#3-post-processing)
- [5. Logging & Observability Requirements](#5-logging-&-observability-requirements)
- [Never log](#never-log)
- [6. SLO / SLA Definitions](#6-slo-sla-definitions)
- [Recommended SLOs](#recommended-slos)
- [7. API Checklist](#7-api-checklist)

## Quick Navigation

- [Input Schema Design](#1-input-schema-design)
- [Output Schema Design](#2-output-schema-design)
- [API Reliability Patterns](#3-api-reliability-patterns)
- [Feature Enrichment Patterns](#4-feature-enrichment-patterns)
- [Logging & Observability Requirements](#5-logging--observability-requirements)
- [SLO / SLA Definitions](#6-slo--sla-definitions)
- [API Checklist](#7-api-checklist)
