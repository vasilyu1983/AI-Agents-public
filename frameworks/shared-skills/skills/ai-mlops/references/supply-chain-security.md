...
Use this when the user needs SBOMs, artifact signing, provenance checks, or dependency policy for AI runtimes.

## Table of Contents

- [Quick Navigation](#quick-navigation)
- [Overview](#overview)
- [1. SBOM + Signing](#1-sbom-signing)
- [Software Bill of Materials (SBOM)](#software-bill-of-materials-sbom)
- [Artifact Signing](#artifact-signing)
- [Sign model checkpoint](#sign-model-checkpoint)
- [Verify signature](#verify-signature)
- [Sign container image with cosign](#sign-container-image-with-cosign)
- [Verify container signature](#verify-container-signature)
- [CI/CD Integration](#cicd-integration)
- [.github/workflows/deploy.yml](#githubworkflowsdeployyml)
- [2. Dependency Scanning](#2-dependency-scanning)
- [Python Package Scanning](#python-package-scanning)
- [Scan Python dependencies](#scan-python-dependencies)
- [Check for known vulnerabilities](#check-for-known-vulnerabilities)
- [Block deployment on high/critical CVEs](#block-deployment-on-highcritical-cves)
- [Pin Hashes for Reproducibility](#pin-hashes-for-reproducibility)
- [requirements.txt](#requirementstxt)
- [CUDA and Driver Scanning](#cuda-and-driver-scanning)
- [Check NVIDIA driver version](#check-nvidia-driver-version)
- [Verify CUDA version](#verify-cuda-version)
- [Validate against allowlist](#validate-against-allowlist)
- [cuda-allowlist.yaml](#cuda-allowlistyaml)
- [3. Model & Embedding Integrity](#3-model-&-embedding-integrity)
- [Model Checkpoint Hashing](#model-checkpoint-hashing)
- [Generate hash at model save time](#generate-hash-at-model-save-time)
- [Verify on Load](#verify-on-load)
- [Embedding Integrity](#embedding-integrity)
- [Hash Pinecone/Weaviate backup](#hash-pineconeweaviate-backup)
- [Verify before restore](#verify-before-restore)
- [Isolate Untrusted Models](#isolate-untrusted-models)
- [4. Driver/Runtime Attestation](#4-driverruntime-attestation)
- [GPU Driver Verification](#gpu-driver-verification)
- [Log Attestation](#log-attestation)
- [Runtime Integrity Monitoring](#runtime-integrity-monitoring)
- [Check for unexpected driver updates](#check-for-unexpected-driver-updates)
- [Alert on changes](#alert-on-changes)
- [5. Registry Hygiene](#5-registry-hygiene)
- [Immutable Tags](#immutable-tags)
- [docker-compose.yml](#docker-composeyml)
- [Promotion via Signed Manifests](#promotion-via-signed-manifests)
- [Sign manifest for production](#sign-manifest-for-production)
- [Policy: only signed images can be deployed to prod](#policy-only-signed-images-can-be-deployed-to-prod)
- [Audit Logs](#audit-logs)
- [Vulnerability Scanning](#vulnerability-scanning)
- [.github/workflows/build.yml](#githubworkflowsbuildyml)
- [Supply Chain Hardening Checklist](#supply-chain-hardening-checklist)
- [Related Patterns](#related-patterns)

## Quick Navigation

- [Overview](#overview)
- [SBOM + Signing](#1-sbom--signing)
- [Dependency Scanning](#2-dependency-scanning)
- [Model & Embedding Integrity](#3-model--embedding-integrity)
- [Driver/Runtime Attestation](#4-driverruntime-attestation)
- [Registry Hygiene](#5-registry-hygiene)
- [Supply Chain Hardening Checklist](#supply-chain-hardening-checklist)
