...
| 2 | [Loss Aversion](assets/templates/behavioral-economics/02-loss-aversion.md) | Loss framing can shift choices; magnitude varies by task, stakes, and elicitation method | Churn prevention, trial expiry, feature removal messaging |
...
| 16 | [Implementation Intentions](assets/templates/behavioral-economics/16-implementation-intentions.md) | User-authored if-then plans bind a specific cue to a specific response, supporting goal completion with context-dependent effects | Goal-pursuit features, onboarding into habit-forming behavior, transition-state re-anchoring |
...
| 2 | [Loss Aversion](assets/templates/behavioral-economics/02-loss-aversion.md) | Assuming framing superiority without testing truthful gain/loss variants under real user-relevant stakes |
...
| 12 | [Habit Loop](assets/templates/behavioral-economics/12-habit-loop.md) | Retention decline with several candidate explanations; examine cue-conditional behavior and automaticity evidence before attributing habit |
...
**EU DSA Article 25:** assess applicable online-platform scope, including the micro/small-enterprise exemption and Article 25(2) carve-out for practices covered by UCPD or GDPR. It does not extend to every EU-facing product or only VLOPs. See the [Commission DSA questions and answers](https://digital-strategy.ec.europa.eu/en/faqs/digital-services-act-questions-and-answers) and [Regulation (EU) 2022/2065](https://eur-lex.europa.eu/eli/reg/2022/2065/oj/eng/pdf); qualified counsel determines the governing instrument for a specific practice.

**EU AI Act manipulation review:** Article 5(1)(a) requires the relevant technique, impaired informed decision-making, material behavioural distortion and actual or reasonably likely significant harm; not every nudge or dark pattern meets those conditions. Assess territorial scope and current text with qualified counsel. Prohibitions apply separately from high-risk schedules. Verified 2026-09-17: the [official updated timeline](https://ai-act-service-desk.ec.europa.eu/en/ai-act/timeline/timeline-implementation-eu-ai-act) places GPAI rules from 2 August 2025 and Annex III high-risk rules from 2 December 2027 after the adopted Omnibus. The [official Article 5 explorer](https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-5) warns its displayed text is not yet updated; retrieve current amended law before a legal conclusion.

**EU digital fairness policy:** do not treat future initiatives as adopted law or forecast enactment dates. Verify legislative status when needed with qualified counsel. DSA Article 25 is not confined to Very Large Online Platforms; existing platform-scope and other consumer-law rules require separate analysis. Being outside one provision does not establish that a practice is lawful. The [Commission consumer-law review](https://commission.europa.eu/law/law-topic/consumer-protection-law/review-eu-consumer-law_en), checked 2026-09-17, describes the Digital Fairness Act as an initiative under preparation.
...
| Burying material decisions under cumulative cognitive load | Late-flow decisions may undermine informed choice; consent validity depends on the full legal and interaction context | Move material decisions to early/low-load positions; strip extraneous load from decision screens (#14) |
...
- [ ] **Capacity fit**: What must users retain without external support, and do observed errors indicate overload? Are material decisions understandable in context? → cognitive load (#14)
...
| Business model whose margin IS the bias | The primitive is not a retention technique here — it is the revenue line. Diagnostic: revenue concentration in the top decile rising over time is the leading indicator of *both* whale churn and duty-of-care enforcement exposure, read from the same chart | Track share of revenue from users whose spend exceeds plausible disposable income as a risk metric; apply the falsifier (publish the edge — if disclosure kills demand, the edge was information asymmetry) → [`references/patterns-scenarios-traps.md` § Edge-over-appetite business models](references/patterns-scenarios-traps.md#edge-over-appetite-business-models) |
...
5. **Measurement**: Cue-conditional completion rate per cohort-week. Track automaticity and cue dependence alongside completion; stable rates or a week threshold cannot establish a habit, and motivation/reminders remain alternative explanations.
...
- Edge-over-appetite business models (variance-pooling rule, response ladder, whale-concentration risk metric): [`references/patterns-scenarios-traps.md#edge-over-appetite-business-models`](references/patterns-scenarios-traps.md#edge-over-appetite-business-models)
...
- **Loss aversion coefficient:** Brown, Imai, Vieider & Camerer, *Journal of Economic Literature* 62(2), 2024 (607 estimates, 150 papers) places mean λ at 1.955 (95% CI [1.820, 2.102]); Walasek, Mullett & Stewart, *Journal of Economic Psychology* 103, 2024 (risky choice) at 1.31 (95% CI [1.10, 1.53]). The canonical λ ≈ 2.25 (Tversky & Kahneman 1992) is a historical task-specific estimate, not a population bound or copy-response multiplier. A 2025 re-meta-analysis of the Brown et al. dataset (84 papers, 163 estimates, N=149,218) finds λ ≈ 1.07 (non-significant) for symmetric unordered gain-loss designs — loss aversion is robust when design induces ordinal asymmetry, but not a universal constant.
