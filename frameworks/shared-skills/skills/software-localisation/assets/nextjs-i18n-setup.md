...
Production-ready i18n setup for Next.js App Router with Server Components, TypeScript, and static generation.
...
Use Next.js metadata alternates to emit hreflang tags. `next-intl` handles locale routing, while your metadata code owns the final alternate URLs:
