...
- [React Hook for Numbers](#react-hook-for-numbers)
- [Relative Time Formatting](#relative-time-formatting)
- [Basic Relative Time](#basic-relative-time)
- [Numeric vs Auto](#numeric-vs-auto)
- [Style Options](#style-options)
- [Smart Relative Time Function](#smart-relative-time-function)
- [List Formatting](#list-formatting)
- [Basic List Formatting](#basic-list-formatting)
- [Locale Variations](#locale-variations)
- [Display Names](#display-names)
- [Language Names](#language-names)
- [Region Names](#region-names)
- [Currency Names](#currency-names)
- [Locale Detection](#locale-detection)
- [Browser Detection](#browser-detection)
- [Detection Strategy](#detection-strategy)
- [Next.js Proxy Detection](#nextjs-proxy-detection)
...
- [Always Use Intl APIs](#always-use-intl-apis)
- [Cache Formatter Instances](#cache-formatter-instances)
- [Handle Timezone Consistently](#handle-timezone-consistently)
- [Test with Multiple Locales](#test-with-multiple-locales)
