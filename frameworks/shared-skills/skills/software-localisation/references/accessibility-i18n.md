...
> This file covers the i18n-specific dimensions of accessibility (ICU/BiDi, script line height, IME composition, lang-attribute propagation). For general WCAG compliance and ARIA patterns, see software-accessibility.
...
- [Why This Intersection Matters](#why-this-intersection-matters)
- [Screen Readers and RTL Languages](#screen-readers-and-rtl-languages)
- [Screen Reader Behaviour by Platform](#screen-reader-behaviour-by-platform)
- [Critical: The `lang` Attribute](#critical-the-lang-attribute)
- [hreflang for Alternate Language Links](#hreflang-for-alternate-language-links)
- [VoiceOver Behaviour with RTL](#voiceover-behaviour-with-rtl)
- [ARIA Labels in Multiple Languages](#aria-labels-in-multiple-languages)
- [Translating ARIA Attributes](#translating-aria-attributes)
- [Common ARIA Attributes Requiring Translation](#common-aria-attributes-requiring-translation)
- [Language-Specific ARIA Patterns](#language-specific-aria-patterns)
- [Bidirectional Text Accessibility](#bidirectional-text-accessibility)
- [BiDi Marks and Isolation](#bidi-marks-and-isolation)
- [HTML bdi Element](#html-bdi-element)
- [Screen Reader Impact](#screen-reader-impact)
- [ICU Messages and BiDi](#icu-messages-and-bidi)
- [Dynamic Type and Font Scaling Across Scripts](#dynamic-type-and-font-scaling-across-scripts)
- [Script Height Variance](#script-height-variance)
- [iOS Dynamic Type with Multilingual Fonts](#ios-dynamic-type-with-multilingual-fonts)
- [CSS Font Scaling for Multilingual](#css-font-scaling-for-multilingual)
- [Colour and Contrast Across Cultural Contexts](#colour-and-contrast-across-cultural-contexts)
- [Cultural Colour Associations](#cultural-colour-associations)
- [Contrast Requirements Are Universal](#contrast-requirements-are-universal)
- [Keyboard Navigation for RTL Interfaces](#keyboard-navigation-for-rtl-interfaces)
- [Tab Order in RTL](#tab-order-in-rtl)
- [Arrow Key Behaviour](#arrow-key-behaviour)
- [Form Labels and Error Messages in Localised Contexts](#form-labels-and-error-messages-in-localised-contexts)
- [Label Association](#label-association)
- [Error Message Translation Patterns](#error-message-translation-patterns)
- [Input Method Editor (IME) Accessibility](#input-method-editor-ime-accessibility)
- [IME for CJK Languages](#ime-for-cjk-languages)
- [Composition Events](#composition-events)
- [Indic Script IME Considerations](#indic-script-ime-considerations)
- [European Accessibility Act (EAA) and Multilingual Products](#european-accessibility-act-eaa-and-multilingual-products)
- [WCAG Requirements for Multilingual Content](#wcag-requirements-for-multilingual-content)
- [WCAG 3.1: Language of Page and Parts](#wcag-31-language-of-page-and-parts)
- [Implementation Checklist](#implementation-checklist)
- [Automated WCAG Checking Per Locale](#automated-wcag-checking-per-locale)
...
## European Accessibility Act (EAA) and Multilingual Products

The EAA has been enforceable since 28 June 2025 for EU-market products/services placed after that date (pre-existing services have until 28 June 2030). It sets accessibility requirements, not translation requirements, but it does not operate in isolation: e-commerce, banking, transport, and media products selling into the EU also carry consumer-information-in-local-language obligations from other EU rules (Consumer Rights Directive, national transpositions). For this skill, that means: don't treat "we shipped `lang`/`dir` correctly" as EAA-sufficient if the underlying accessible content only exists in one language — an accessible page that silently falls back to English in a French-only market fails the combined bar even when it passes WCAG in English. Verify current scope and deadlines against primary sources before advising a specific compliance date; enforcement details vary by member state.
...
- [software-accessibility](../../software-accessibility/SKILL.md) — general WCAG/ARIA compliance and EAA readiness beyond the i18n-specific dimensions covered here
