...
- [Bidirectional (BiDi) Text](#bidirectional-bidi-text)
- [CSS Logical Properties](#css-logical-properties)
- [Property Mapping](#property-mapping)
- [Implementation](#implementation)
- [Flexbox and Grid](#flexbox-and-grid)
- [HTML dir Attribute](#html-dir-attribute)
- [Document-Level](#document-level)
- [Dynamic Direction (React)](#dynamic-direction-react)
- [Dynamic Direction (Vue)](#dynamic-direction-vue)
- [Element-Level Override](#element-level-override)
- [Tailwind CSS RTL Support](#tailwind-css-rtl-support)
- [Built-in RTL Variants (v3.3+ / v4)](#built-in-rtl-variants-v33--v4)
- [Logical Utility Classes](#logical-utility-classes)
- [Custom Tailwind Config](#custom-tailwind-config)
- [Icons and Images](#icons-and-images)
- [When to Mirror](#when-to-mirror)
- [CSS Mirroring](#css-mirroring)
- [React Component](#react-component)
- [Form Inputs](#form-inputs)
- [Input Direction](#input-direction)
- [React Form Component](#react-form-component)
- [Placeholder Direction](#placeholder-direction)
- [Tables](#tables)
- [RTL Table Layout](#rtl-table-layout)
- [React Table Component](#react-table-component)
- [Testing RTL](#testing-rtl)
- [Browser DevTools](#browser-devtools)
- [Storybook RTL Decorator](#storybook-rtl-decorator)
- [Playwright RTL Tests](#playwright-rtl-tests)
- [Visual Regression Testing](#visual-regression-testing)
- [Common Issues and Fixes](#common-issues-and-fixes)
- [Issue: Scrollbar Position](#issue-scrollbar-position)
- [Issue: Absolute Positioning](#issue-absolute-positioning)
- [Issue: Border Radius](#issue-border-radius)
- [Issue: Transitions and Animations](#issue-transitions-and-animations)
- [RTL Checklist](#rtl-checklist)
