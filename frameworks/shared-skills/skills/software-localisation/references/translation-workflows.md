...
- [i18next-cli (preferred)](#i18next-cli-preferred)
- [Extract keys](#extract-keys)
- [CI mode](#ci-mode)
- [Watch mode](#watch-mode)
- [i18next-parser (legacy / existing repos)](#i18next-parser-legacy-existing-repos)
- [FormatJS CLI (@formatjs/cli)](#formatjs-cli-@formatjscli)
- [Extract messages](#extract-messages)
- [Compile for production (AST)](#compile-for-production-ast)
- [Lingui CLI](#lingui-cli)
- [Extract messages](#extract-messages)
- [Compile catalogs](#compile-catalogs)
- [Extract and compile](#extract-and-compile)
- [Translation Management Systems (TMS)](#translation-management-systems-tms)
- [Phrase Integration](#phrase-integration)
- [.phrase.yml](#phraseyml)
- [Push source strings](#push-source-strings)
- [Pull translations](#pull-translations)
- [Install CLI](#install-cli)
- [.github/workflows/phrase-sync.yml](#githubworkflowsphrase-syncyml)
- [Lokalise Integration](#lokalise-integration)
- [Install CLI](#install-cli)
- [lokalise.yml](#lokaliseyml)
- [Push source](#push-source)
- [Pull translations](#pull-translations)
- [.github/workflows/lokalise-sync.yml](#githubworkflowslokalise-syncyml)
- [Crowdin Integration](#crowdin-integration)
- [crowdin.yml](#crowdinyml)
- [Install CLI](#install-cli)
- [Upload sources](#upload-sources)
- [Download translations](#download-translations)
- [.github/workflows/crowdin.yml](#githubworkflowscrowdinyml)
- [CI/CD Pipelines](#cicd-pipelines)
- [GitHub Actions: Full Workflow](#github-actions-full-workflow)
- [.github/workflows/i18n.yml](#githubworkflowsi18nyml)
- [Translation Validation Script](#translation-validation-script)
- [GitLab CI Pipeline](#gitlab-ci-pipeline)
- [.gitlab-ci.yml](#gitlab-ciyml)
- [Git Workflow Patterns](#git-workflow-patterns)
- [Branch-Based Translation Workflow](#branch-based-translation-workflow)
- [Monorepo Pattern](#monorepo-pattern)
- [turbo.json (Turborepo)](#turbojson-turborepo)
- [Extract from all packages](#extract-from-all-packages)
- [Push to TMS](#push-to-tms)
- [Pre-commit Hook](#pre-commit-hook)
- [.husky/pre-commit](#huskypre-commit)
- [Extract and stage new translation keys](#extract-and-stage-new-translation-keys)
- [Missing Key Detection](#missing-key-detection)
- [Development Warning](#development-warning)
- [Production Fallback Strategy](#production-fallback-strategy)
- [Translation File Organisation](#translation-file-organisation)
- [Namespace Strategy](#namespace-strategy)
- [Key Naming Conventions](#key-naming-conventions)
- [Avoid](#avoid)
- [TMS Selection Guide](#tms-selection-guide)
- [Decision Criteria](#decision-criteria)
- [AI-Powered Translation (2026)](#ai-powered-translation-2026)
- [Consensus-Based Translation](#consensus-based-translation)
- [AI Translation Tools](#ai-translation-tools)
- [i18n-ai-translate Example](#i18n-ai-translate-example)
- [Install](#install)
- [Translate single file](#translate-single-file)
- [Translate entire directory](#translate-entire-directory)
- [CI/CD AI Translation Pipeline](#cicd-ai-translation-pipeline)
- [.github/workflows/ai-translate.yml](#githubworkflowsai-translateyml)
- [Agentic Translation Workflows](#agentic-translation-workflows)
- [Best Practices for AI Translation](#best-practices-for-ai-translation)
- [When to Use AI vs Human Translation](#when-to-use-ai-vs-human-translation)
- [Edge Translation (On-Device)](#edge-translation-on-device)
...
Relative pricing tiers ($ = lower, $$$ = higher) and "best for" labels below are directional and shift with vendor repricing and roadmap changes — confirm current plans and feature parity on the vendor's own pricing page before committing budget.
...
| **Weblate** | Self-hosted / data-residency requirements | Free (OSS) / paid hosted tier | Self-hostable, Git-native, no vendor lock-in |
...
6. **Data residency / self-hosting is a hard requirement** (regulated industries, air-gapped environments) -> Weblate; do not default to a SaaS-only TMS without checking this constraint first

### When Not to Adopt a TMS Yet

A TMS is overhead, not a default. Skip it (use plain JSON/YAML catalogs + PR review) when: fewer than ~3 target locales, translation volume is low and infrequent, or the team has no dedicated translator/reviewer role — in that situation a TMS adds sync complexity without a corresponding quality or speed win. Revisit once locale count, release cadence, or translator headcount grows past what manual PR review can track.
...
Some vendors run translation requests through multiple independent LLM providers and reconcile disagreements, reporting meaningfully fewer post-edit corrections than single-engine MT. Treat any specific error-reduction percentage as a vendor claim, not an audited benchmark — request the vendor's own methodology before using their number in a business case, and never pin this pattern to a specific model version (model choice and quality shift too fast for durable guidance here).

```text
Translation Request
    │
    ├─ Provider A ─────────────┐
    ├─ Provider B ─────────────┼─ Consensus Check -> Final Translation
    ├─ Provider C ─────────────┘
    │
...
**TMS platforms with AI agents** (current):
...
Emerging: on-device translation for offline-first apps.
