...
- [1. Digital Literacy Spectrum](#1-digital-literacy-spectrum)
- [2. Core Simplification Principles](#2-core-simplification-principles)
- [Functional Minimalism with Purpose (2026 Trend)](#functional-minimalism-with-purpose-2026-trend)
- [Zero-Friction Cognition (2026 Trend)](#zero-friction-cognition-2026-trend)
- [Calm Technology (2026 Trend)](#calm-technology-2026-trend)
- [3. Interface Simplification Patterns](#3-interface-simplification-patterns)
- [Single-Input Focus (ChatGPT/Claude Pattern)](#single-input-focus-chatgptclaude-pattern)
- [Clean Two-Column Layout (ChatGPT/Claude Pattern)](#clean-two-column-layout-chatgptclaude-pattern)
- [Content-First Design](#content-first-design)
- [Progressive Feature Revelation](#progressive-feature-revelation)
- [Suggested Actions / Prompt Chips](#suggested-actions-prompt-chips)
- [4. Navigation Simplification](#4-navigation-simplification)
- [Flat Information Architecture](#flat-information-architecture)
- [Linear Flow Design (One-Path-Forward)](#linear-flow-design-one-path-forward)
- [Obvious Exits](#obvious-exits)
- [Menu Simplification](#menu-simplification)
- [5. Content Simplification](#5-content-simplification)
- [Plain Language Rules](#plain-language-rules)
- [Visual Communication](#visual-communication)
- [Error Message Simplification](#error-message-simplification)
- [6. Onboarding Simplification](#6-onboarding-simplification)
- [Guided First-Run ("3 Things You Can Do")](#guided-first-run-3-things-you-can-do)
- [Empty State Guidance](#empty-state-guidance)
- [7. 2026 Trend Patterns](#7-2026-trend-patterns)
- [Adaptive Minimal Interfaces](#adaptive-minimal-interfaces)
- [Zero-UI / Invisible Interfaces](#zero-ui-invisible-interfaces)
- [AI as Silent Co-Designer](#ai-as-silent-co-designer)
- [Cognitive Inclusion Beyond WCAG](#cognitive-inclusion-beyond-wcag)
- [Multimodal Interaction](#multimodal-interaction)
- [Emotional Intelligence in UX](#emotional-intelligence-in-ux)
- [8. Case Study: ChatGPT / Claude Interface Dissection](#8-case-study-chatgpt-claude-interface-dissection)
- [Pattern Analysis](#pattern-analysis)
- [Adapting These Patterns for Non-Chat Products](#adapting-these-patterns-for-non-chat-products)
...
- [modern-ux-patterns.md](modern-ux-patterns.md) — Contemporary UX patterns and 2026 trends
