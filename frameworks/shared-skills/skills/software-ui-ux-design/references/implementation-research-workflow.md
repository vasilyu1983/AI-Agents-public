...
- [The Research-First Rule](#the-research-first-rule)
- [Step-by-Step Research Workflow](#step-by-step-research-workflow)
- [Step 1: Define What You're Building](#step-1-define-what-youre-building)
- [Step 2: Search Pattern Libraries](#step-2-search-pattern-libraries)
- [Step 3: Study Leader Implementations](#step-3-study-leader-implementations)
- [Implementation Study Template](#implementation-study-template)
- [App: [Name]](#app-name)
- [Step 4: Document Patterns](#step-4-document-patterns)
- [Step 5: Implement with Learnings](#step-5-implement-with-learnings)
- [Screen-by-Screen Research Guide](#screen-by-screen-research-guide)
- [Onboarding Flow Research](#onboarding-flow-research)
- [Checkout Flow Research](#checkout-flow-research)
- [Dashboard Research](#dashboard-research)
- [Settings & Account Research](#settings-&-account-research)
- [Pricing Page Research](#pricing-page-research)
- [Quick Reference: Component Patterns](#quick-reference-component-patterns)
- [Common UI Patterns by Component](#common-ui-patterns-by-component)
- [Tools Quick Reference](#tools-quick-reference)
- [Integration with Design Process](#integration-with-design-process)
...
- [Modern UX Patterns 2025](modern-ux-patterns.md) — Current interaction patterns
