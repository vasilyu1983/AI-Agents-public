...
- [Type Scale Systems](#type-scale-systems)
- [Scale Types](#scale-types)
- [Modular Scale Implementation](#modular-scale-implementation)
- [Fluid Typography](#fluid-typography)
- [Custom Scale (Non-Ratio)](#custom-scale-non-ratio)
- [Font Pairing Strategies](#font-pairing-strategies)
- [Pairing Principles](#pairing-principles)
- [Tested Pairings](#tested-pairings)
- [Anti-Patterns in Font Pairing](#anti-patterns-in-font-pairing)
- [Variable Fonts and Responsive Typography](#variable-fonts-and-responsive-typography)
- [Variable Font Axes](#variable-font-axes)
- [Variable Font Implementation](#variable-font-implementation)
- [Performance Benefit](#performance-benefit)
- [Line Height, Letter Spacing, and Measure](#line-height-letter-spacing-and-measure)
...
- [Vertical Rhythm and Baseline Grids](#vertical-rhythm-and-baseline-grids)
- [Vertical Rhythm](#vertical-rhythm)
- [When Strict Baseline Grids Break Down](#when-strict-baseline-grids-break-down)
- [Web Font Loading Strategies](#web-font-loading-strategies)
- [Loading Behaviors](#loading-behaviors)
- [`font-display` Values](#font-display-values)
- [Optimal Loading Pattern](#optimal-loading-pattern)
- [Font Subsetting](#font-subsetting)
- [Subset with pyftsubset (fonttools)](#subset-with-pyftsubset-fonttools)
- [Platform-Specific Typography](#platform-specific-typography)
- [iOS Dynamic Type](#ios-dynamic-type)
- [Android sp Units](#android-sp-units)
- [Web rem/em](#web-remem)
- [Typography Accessibility](#typography-accessibility)
- [Minimum Sizes](#minimum-sizes)
- [WCAG Text Spacing Requirements (SC 1.4.12)](#wcag-text-spacing-requirements-sc-1412)
- [Dyslexia-Friendly Typography](#dyslexia-friendly-typography)
- [Atkinson Hyperlegible Example](#atkinson-hyperlegible-example)
- [Design Token Integration](#design-token-integration)
- [Typography Token Structure](#typography-token-structure)
- [Composite Typography Tokens](#composite-typography-tokens)
- [Generating CSS from Tokens](#generating-css-from-tokens)
- [Typography Checklist](#typography-checklist)
