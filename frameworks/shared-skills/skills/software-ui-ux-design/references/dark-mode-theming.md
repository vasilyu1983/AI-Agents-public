...
- [Color System Design for Multi-Theme](#color-system-design-for-multi-theme)
- [Token Architecture](#token-architecture)
- [Why Semantic Tokens Matter](#why-semantic-tokens-matter)
- [Token Naming Conventions](#token-naming-conventions)
- [Dark Mode Color Principles](#dark-mode-color-principles)
- [Core Principles](#core-principles)
- [Elevation System for Dark Mode](#elevation-system-for-dark-mode)
- [Material Design 3 Dark Scheme](#material-design-3-dark-scheme)
- [M3 Color Roles in Dark Mode](#m3-color-roles-in-dark-mode)
- [Dynamic Color Generation](#dynamic-color-generation)
- [M3 Dark Theme Generator](#m3-dark-theme-generator)
- [iOS Dark Mode](#ios-dark-mode)
- [System Materials and Vibrancy](#system-materials-and-vibrancy)
- [Semantic Colors (UIKit / SwiftUI)](#semantic-colors-uikit-swiftui)
- [Elevated Surfaces on iOS](#elevated-surfaces-on-ios)
- [CSS Implementation](#css-implementation)
- [`prefers-color-scheme` Media Query](#prefers-color-scheme-media-query)
- [Tailwind CSS Dark Mode](#tailwind-css-dark-mode)
- [CSS Custom Properties with Class Toggle](#css-custom-properties-with-class-toggle)
- [Theme Switching](#theme-switching)
- [System Preference Detection](#system-preference-detection)
- [User Toggle with Persistence](#user-toggle-with-persistence)
- [Preventing Flash of Wrong Theme (FOWT)](#preventing-flash-of-wrong-theme-fowt)
- [Image and Media Adaptation](#image-and-media-adaptation)
- [Logo Adaptation](#logo-adaptation)
- [Image Adaptation](#image-adaptation)
- [Content That Needs Adaptation](#content-that-needs-adaptation)
- [Contrast Requirements](#contrast-requirements)
- [WCAG Contrast in Both Themes](#wcag-contrast-in-both-themes)
- [Common Contrast Failures in Dark Mode](#common-contrast-failures-in-dark-mode)
- [Testing Contrast](#testing-contrast)
- [Testing Dark Mode](#testing-dark-mode)
- [Visual Regression Testing](#visual-regression-testing)
- [Accessibility Audit per Theme](#accessibility-audit-per-theme)
- [Manual Testing Checklist](#manual-testing-checklist)
- [Common Dark Mode Mistakes](#common-dark-mode-mistakes)
- [The `color-scheme` Property](#the-color-scheme-property)
