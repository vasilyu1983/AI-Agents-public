...
- [Thumb Zone and Reachability](#thumb-zone-and-reachability)
- [Thumb Reach Zones](#thumb-reach-zones)
- [Design Implications](#design-implications)
- [Floating Action Button (FAB) Placement](#floating-action-button-fab-placement)
- [Mobile Navigation Patterns](#mobile-navigation-patterns)
- [Pattern Comparison](#pattern-comparison)
- [Tab Bar Best Practices](#tab-bar-best-practices)
- [Bottom Sheet Patterns](#bottom-sheet-patterns)
- [Gesture Patterns](#gesture-patterns)
- [Common Gestures](#common-gestures)
- [Gesture Design Principles](#gesture-design-principles)
- [Swipe-to-Action Pattern](#swipe-to-action-pattern)
- [Mobile Forms](#mobile-forms)
- [Input Type Optimization](#input-type-optimization)
- [Autofill Optimization](#autofill-optimization)
- [Mobile Form Layout Rules](#mobile-form-layout-rules)
- [Touch Target Sizing](#touch-target-sizing)
- [Platform Requirements](#platform-requirements)
- [Common Violations](#common-violations)
- [Mobile Onboarding Patterns](#mobile-onboarding-patterns)
- [Pattern Comparison](#pattern-comparison)
- [Onboarding Decision Framework](#onboarding-decision-framework)
- [Onboarding Anti-Patterns](#onboarding-anti-patterns)
- [Permission Request Patterns](#permission-request-patterns)
- [Best Practices by Type](#best-practices-by-type)
- [Pre-Prompt Pattern](#pre-prompt-pattern)
- [iOS 16+ Provisional Notifications](#ios-16-provisional-notifications)
- [Mobile Empty States and Loading Patterns](#mobile-empty-states-and-loading-patterns)
- [Empty State Design](#empty-state-design)
- [Loading Pattern Hierarchy](#loading-pattern-hierarchy)
- [Skeleton Screen Implementation](#skeleton-screen-implementation)
- [Platform-Specific Patterns: iOS vs Android](#platform-specific-patterns-ios-vs-android)
- [Navigation Differences](#navigation-differences)
- [Visual and Interaction Differences](#visual-and-interaction-differences)
- [When to Follow Platform Conventions vs Unify](#when-to-follow-platform-conventions-vs-unify)
- [Mobile Checkout and Payment UX](#mobile-checkout-and-payment-ux)
- [Checkout Flow Optimization](#checkout-flow-optimization)
- [Mobile Payment Hierarchy](#mobile-payment-hierarchy)
...
| **WCAG 2.5.5** Target Size (Enhanced) (Level AAA) | 44 x 44 CSS px | 44 x 44 CSS px | — |
| **WCAG 2.5.8** Target Size (Minimum) (Level AA) | 24 x 24 CSS px | 44 x 44 CSS px | — |
