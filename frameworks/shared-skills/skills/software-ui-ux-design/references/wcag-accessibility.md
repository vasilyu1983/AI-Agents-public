...
Web Content Accessibility Guidelines (WCAG) 2.2 are international standards for making web content accessible to people with disabilities. WCAG 2.2 is a W3C Recommendation (October 2023).
...
- [Common ARIA Patterns](#common-aria-patterns)
- [Testing Tools](#testing-tools)
- [Automated Testing](#automated-testing)
- [Install axe-core for automated tests](#install-axe-core-for-automated-tests)
- [Run Lighthouse](#run-lighthouse)
- [Manual Testing](#manual-testing)
- [Quick Checklist](#quick-checklist)
- [Essential (Level A)](#essential-level-a)
- [Standard (Level AA)](#standard-level-aa)
- [Enhanced (Level AAA)](#enhanced-level-aaa)
- [Common Accessibility Mistakes](#common-accessibility-mistakes)
- [WCAG 3.0 Watchlist](#wcag-30-watchlist)
...
WCAG conformance is no longer just a quality bar — for many products it is a legal requirement.

### European Accessibility Act (EAA)

The EAA is enforceable since **28 June 2025**. Scope and obligations:
...
The DOJ's April 2024 final rule under ADA Title II requires state and local government web content and mobile apps to meet **WCAG 2.1 AA**. An Interim Final Rule effective 20 April 2026 extended the original compliance dates by one year: entities serving a population of 50,000+ now have until **26 April 2027** (was April 2026), and entities under 50,000 (plus special districts) now have until **26 April 2028** (was April 2027). Verify current deadlines before advising a client, since DOJ rulemaking on this rule has already shifted once. Title III (private accommodation) case law continues to use WCAG 2.0/2.1 AA as the de-facto standard pending further DOJ rulemaking.

Sources: [Federal Register — Extension of Compliance Dates (2026-07663)](https://www.federalregister.gov/documents/2026/04/20/2026-07663/extension-of-compliance-dates-for-nondiscrimination-on-the-basis-of-disability-accessibility-of-web).

### Dark-Pattern Regulation (EU DSA Article 25)

Under the Digital Services Act, manipulative interface design ("dark patterns") is prohibited. In parallel, cookie-consent enforcement is escalating: in September 2025 the CNIL fined Google €325M and SHEIN €150M (under French ePrivacy/cookie rules) for cookie dark patterns — placing advertising cookies before consent and continuing to set cookies after "Refuse all". Equal visual weight for accept and reject, and honouring refusal, are now the operating standard. See `modern-ux-patterns.md` for the design implications.

---

## WCAG 3.0 Watchlist

W3C is developing WCAG 3.0, but it is still future-facing. Treat it as directional only, not as a current compliance target or policy baseline.

The most recent Working Draft (3 March 2026) contains 174 requirements but is still incomplete; Candidate Recommendation and a final W3C Recommendation remain years away, with W3C guidance pointing to standardisation after 2030. Teams shipping in 2026 should keep targeting WCAG 2.2 AA for design, audits, and legal/compliance work.
