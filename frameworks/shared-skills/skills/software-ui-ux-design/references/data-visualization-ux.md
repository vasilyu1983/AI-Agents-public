...
- [By Analytical Task](#by-analytical-task)
- [Decision Tree](#decision-tree)
- [Bar Chart Best Practices](#bar-chart-best-practices)
- [Line Chart Best Practices](#line-chart-best-practices)
- [Dashboard Layout Patterns](#dashboard-layout-patterns)
- [Information Hierarchy](#information-hierarchy)
- [KPI Card Design](#kpi-card-design)
- [Card Grid Layout](#card-grid-layout)
- [Responsive Dashboard Strategy](#responsive-dashboard-strategy)
- [Accessible Data Visualization](#accessible-data-visualization)
- [Color-Blind Safe Palettes](#color-blind-safe-palettes)
- [ARIA for Charts](#aria-for-charts)
- [Alt Text for Data Visualizations](#alt-text-for-data-visualizations)
- [Data Table Fallback](#data-table-fallback)
- [Interactive Visualization Patterns](#interactive-visualization-patterns)
- [Tooltips](#tooltips)
- [Drill-Down](#drill-down)
- [Filtering and Time Series Controls](#filtering-and-time-series-controls)
- [Cross-Filtering](#cross-filtering)
- [Mobile Data Visualization](#mobile-data-visualization)
- [Constraints and Adaptations](#constraints-and-adaptations)
- [Mobile Chart Patterns](#mobile-chart-patterns)
- [Anti-Patterns](#anti-patterns)
- [Tools Reference](#tools-reference)
- [D3 Accessibility Pattern](#d3-accessibility-pattern)
- [Recharts Responsive Setup](#recharts-responsive-setup)
- [Data Viz Accessibility Checklist](#data-viz-accessibility-checklist)
