...
- [Code Example (React)](#code-example-react)
...
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Confirmation Before Destructive Actions](#pattern-confirmation-before-destructive-actions)
...
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Inline Validation](#pattern-inline-validation)
- [Pattern: Smart Defaults](#pattern-smart-defaults)
- [6. Recognition Rather Than Recall](#6-recognition-rather-than-recall)
- [Why It Matters](#why-it-matters)
- [Implementation Guidelines](#implementation-guidelines)
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Breadcrumbs](#pattern-breadcrumbs)
- [Pattern: Recent Items](#pattern-recent-items)
- [7. Flexibility and Efficiency of Use](#7-flexibility-and-efficiency-of-use)
- [Implementation Guidelines](#implementation-guidelines)
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Command Palette](#pattern-command-palette)
...
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Progressive Disclosure](#pattern-progressive-disclosure)
...
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Helpful Error Messages](#pattern-helpful-error-messages)
- [Error Message Tone](#error-message-tone)
- [10. Help and Documentation](#10-help-and-documentation)
- [Why It Matters](#why-it-matters)
- [Implementation Guidelines](#implementation-guidelines)
- [Types of Help](#types-of-help)
- [Good Examples](#good-examples)
- [Bad Examples](#bad-examples)
- [Pattern: Contextual Tooltips](#pattern-contextual-tooltips)
- [Pattern: Onboarding Tour](#pattern-onboarding-tour)
- [Using Heuristics for Evaluation](#using-heuristics-for-evaluation)
- [Heuristic Evaluation Process](#heuristic-evaluation-process)
- [Severity Rating Scale](#severity-rating-scale)
- [Example Findings Format](#example-findings-format)
