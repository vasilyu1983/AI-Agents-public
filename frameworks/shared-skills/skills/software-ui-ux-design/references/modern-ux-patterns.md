...
- [State of UX Design](#state-of-ux-design)
- [Key Trends](#key-trends)
- [2026 Trend Additions](#2026-trend-additions)
- [1. Functional Minimalism with Purpose](#1-functional-minimalism-with-purpose)
- [2. Zero-Friction Cognition](#2-zero-friction-cognition)
- [3. Calm Technology / Ambient Status](#3-calm-technology-ambient-status)
- [4. Adaptive / Personalized Minimal Interfaces](#4-adaptive-personalized-minimal-interfaces)
- [5. Zero-UI / Invisible Interfaces](#5-zero-ui-invisible-interfaces)
- [6. Cognitive Inclusion Beyond Color Contrast](#6-cognitive-inclusion-beyond-color-contrast)
- [7. Multimodal Interaction (Click / Type / Speak)](#7-multimodal-interaction-click-type-speak)
- [8. Emotional Intelligence in UX](#8-emotional-intelligence-in-ux)
- [9. AI as Silent Co-Designer](#9-ai-as-silent-co-designer)
- [10. Spatial Design / Layered Information Hierarchy](#10-spatial-design-layered-information-hierarchy)
- [Optional: AI/Automation (Operational Patterns)](#optional-aiautomation-operational-patterns)
- [Core Modern Patterns](#core-modern-patterns)
- [1. Bento Grid Layouts (Replacing Carousels)](#1-bento-grid-layouts-replacing-carousels)
- [2. Skeleton Screens (Preferred Over Spinners)](#2-skeleton-screens-preferred-over-spinners)
- [2. Optimistic UI Updates](#2-optimistic-ui-updates)
- [3. Progressive Disclosure](#3-progressive-disclosure)
- [4. Empty States with Actionable Guidance](#4-empty-states-with-actionable-guidance)
- [5. Inline Validation (Real-time Feedback)](#5-inline-validation-real-time-feedback)
- [6. Context-Aware Defaults & Smart Suggestions](#6-context-aware-defaults-&-smart-suggestions)
- [7. Command Palettes & Power Navigation](#7-command-palettes-&-power-navigation)
- [8. Toast Notifications (Non-Blocking Feedback)](#8-toast-notifications-non-blocking-feedback)
- [9. Pagination with Infinite Scroll (Hybrid Approach)](#9-pagination-with-infinite-scroll-hybrid-approach)
- [10. Undo/Redo for Destructive Actions](#10-undoredo-for-destructive-actions)
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid)
- [AVOID 1: Auto-Playing Videos/Audio](#avoid-1-auto-playing-videosaudio)
- [AVOID 2: Carousels for Critical Content](#avoid-2-carousels-for-critical-content)
- [AVOID 3: Hamburger Menus for Essential Navigation](#avoid-3-hamburger-menus-for-essential-navigation)
- [AVOID 4: Disabled Buttons Without Explanation](#avoid-4-disabled-buttons-without-explanation)
- [AVOID 5: Generic Error Messages ("Something went wrong")](#avoid-5-generic-error-messages-something-went-wrong)
- [AVOID 6: Modal Overload](#avoid-6-modal-overload)
- [AVOID 7: Infinite Scroll Without Pagination](#avoid-7-infinite-scroll-without-pagination)
- [AVOID 8: Forced Registration Before Showing Value](#avoid-8-forced-registration-before-showing-value)
- [Testing Modern UX Patterns](#testing-modern-ux-patterns)
- [Resources](#resources)
...
The following trends emerged or accelerated in recent cycles. They complement the established patterns above.
