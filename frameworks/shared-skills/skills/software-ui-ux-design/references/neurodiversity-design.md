...
- [Quick Reference: Pattern Matrix](#quick-reference-pattern-matrix)
- [ADHD-Inclusive Design](#adhd-inclusive-design)
- [Core Challenges](#core-challenges)
- [Patterns](#patterns)
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid)
- [Autism Spectrum-Inclusive Design](#autism-spectrum-inclusive-design)
- [Core Challenges](#core-challenges)
- [Patterns](#patterns)
- [Component Patterns](#component-patterns)
- [Dyslexia-Inclusive Design](#dyslexia-inclusive-design)
- [Core Challenges](#core-challenges)
- [Typography Optimization](#typography-optimization)
- [Content Patterns](#content-patterns)
- [Reading Aids](#reading-aids)
- [Dyscalculia-Inclusive Design](#dyscalculia-inclusive-design)
- [Core Challenges](#core-challenges)
- [Patterns](#patterns)
- [Date & Time Patterns](#date-&-time-patterns)
...
- [Modern UX Patterns](modern-ux-patterns.md) - Progressive disclosure, skeleton screens
