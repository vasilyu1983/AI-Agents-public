...
- [Form Layout Fundamentals](#form-layout-fundamentals)
...
- [Error Message Placement](#error-message-placement)
...
- [Field Grouping and Visual Hierarchy](#field-grouping-and-visual-hierarchy)
- [Grouping Principles](#grouping-principles)
- [Field Order](#field-order)
- [Label Patterns](#label-patterns)
- [Pattern Comparison](#pattern-comparison)
- [Why Placeholder-Only Labels Fail](#why-placeholder-only-labels-fail)
- [Floating Label Implementation](#floating-label-implementation)
- [Error Recovery](#error-recovery)
- [Error Message Design](#error-message-design)
- [Error Summary (Supplement to Inline)](#error-summary-supplement-to-inline)
- [Prevention-First Patterns](#prevention-first-patterns)
- [Autofill and Autocomplete](#autofill-and-autocomplete)
- [Browser Autofill Best Practices](#browser-autofill-best-practices)
- [Address Autocomplete](#address-autocomplete)
- [Autocomplete Accessibility](#autocomplete-accessibility)
...
- [Mobile-Specific Rules](#mobile-specific-rules)
...
STEP INDICATOR (after step 2 completed):
  [x] Personal Info  ─────  ② Shipping  ─────  ③ Payment  ─────  ④ Review
