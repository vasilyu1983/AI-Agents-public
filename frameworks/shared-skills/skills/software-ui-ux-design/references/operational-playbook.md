...
- [Core Design Themes](#core-design-themes)
- [Pattern: Distinctive Frontend Aesthetics](#pattern-distinctive-frontend-aesthetics)
- [Cognitive Design Foundations](#cognitive-design-foundations)
- [Pattern: User-Centered Design (UCD)](#pattern-user-centered-design-ucd)
- [Pattern: Nielsen's 10 Usability Heuristics](#pattern-nielsens-10-usability-heuristics)
- [Pattern: WCAG Accessibility (POUR Principles)](#pattern-wcag-accessibility-pour-principles)
- [Pattern: Signifiers, Mappings, Constraints](#pattern-signifiers-mappings-constraints)
- [Pattern: Mobile-First Design](#pattern-mobile-first-design)
- [Pattern: Design Systems](#pattern-design-systems)
- [Pattern: Information Architecture](#pattern-information-architecture)
- [Pattern: Form Design Best Practices](#pattern-form-design-best-practices)
- [Pattern: Visual Hierarchy](#pattern-visual-hierarchy)
- [Pattern: Interaction Design](#pattern-interaction-design)
- [Optional: AI/Automation — Personalization and Automation UX](#optional-aiautomation-—-personalization-and-automation-ux)
- [Component Library Selection](#component-library-selection)
- [Modern UX Patterns](#modern-ux-patterns)
- [Quick Decision Framework](#quick-decision-framework)
- [Lean Testing Cadence](#lean-testing-cadence)
- [Common Anti-Patterns to Avoid](#common-anti-patterns-to-avoid)
- [Metrics and Testing](#metrics-and-testing)
...
See [references/frontend-aesthetics.md](frontend-aesthetics.md) for comprehensive implementation guide.
...
- **1st Choice**: shadcn/ui (copy-paste, full ownership)
- **Alternative**: Headless UI (official Tailwind companion)

**For Enterprise Applications:**
- **1st Choice**: MUI (Material Design, mature component ecosystem)
- **Alternative**: Ant Design (admin dashboards, data-heavy UI)
...
See [references/modern-ux-patterns.md](modern-ux-patterns.md) for implementation details and code examples.
