...
- [CRO Impact Hierarchy](#cro-impact-hierarchy)
- [Industry Benchmarks](#industry-benchmarks)
- [E-commerce Conversion Rates](#e-commerce-conversion-rates)
- [SaaS Conversion Rates](#saas-conversion-rates)
- [Lead Generation](#lead-generation)
- [Domain-Specific UI Benchmarks](#domain-specific-ui-benchmarks)
- [Fintech / Neobanks](#fintech-neobanks)
- [E-commerce / Marketplaces](#e-commerce-marketplaces)
- [SaaS / Productivity](#saas-productivity)
- [Healthcare / Telehealth](#healthcare-telehealth)
- [How to Use This Section](#how-to-use-this-section)
- [The CRO Process](#the-cro-process)
- [Research Phase](#research-phase)
- [Hypothesis Generation](#hypothesis-generation)
- [Prioritization Framework (PIE)](#prioritization-framework-pie)
- [Psychology Principles for CRO](#psychology-principles-for-cro)
- [Cialdini's 6 Principles](#cialdinis-6-principles)
- [Trust Signals](#trust-signals)
- [Reducing Friction](#reducing-friction)
- [Critical Flow Optimization](#critical-flow-optimization)
- [Checkout Flow](#checkout-flow)
- [Signup Flow](#signup-flow)
- [Onboarding Flow](#onboarding-flow)
- [Testing Methodology](#testing-methodology)
- [A/B Test Requirements](#ab-test-requirements)
- [Sample Size Calculator](#sample-size-calculator)
- [Common A/B Testing Mistakes](#common-ab-testing-mistakes)
- [Analytics Setup](#analytics-setup)
- [Essential Tracking](#essential-tracking)
- [Key Metrics Dashboard](#key-metrics-dashboard)
- [CRO Audit Template](#cro-audit-template)
- [Quick Audit (30 min)](#quick-audit-30-min)
- [Deep Audit (4-8 hours)](#deep-audit-4-8-hours)
- [Optimization Playbook](#optimization-playbook)
- [Quick Wins (Usually Safe)](#quick-wins-usually-safe)
- [Test Ideas by Page](#test-ideas-by-page)
...
- [Modern UX Patterns](modern-ux-patterns.md) - Interaction patterns
