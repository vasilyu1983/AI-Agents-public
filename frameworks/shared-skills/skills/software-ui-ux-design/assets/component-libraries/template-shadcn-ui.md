...
shadcn/ui is a collection of accessible, customizable React components built on top of utility-first styling and headless primitives. Unlike traditional UI libraries, shadcn/ui is not installed as a dependency: components are copied into your project for full ownership and customization.
...
**Primitives**: Historically Radix UI; current docs also cover Base UI migration paths
