...
- [Contents](#contents)
- [Onboarding Design Principles (2025)](#onboarding-design-principles-2025)
- [Onboarding Sequences](#onboarding-sequences)
- [Tutorial Design](#tutorial-design)
...
The ranges below are commonly cited rules of thumb, not results from a single named study — they vary enormously by product complexity, activation definition, and traffic quality. Treat them as a sanity check, not a target to hit; establish your own product's baseline before setting a goal.

| Metric | Definition | Commonly Cited Range (unverified, product-dependent) |
|--------|------------|-----------|
...
Same caveat as above: these are folklore ranges repeated across marketing content, not verified benchmarks from a named study as of 2026-07-11. Do not report them to stakeholders as industry standards without a citation.

| Metric | Definition | Commonly Cited Range (unverified) |
|--------|------------|--------|
