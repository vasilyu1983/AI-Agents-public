...
- [Contents](#contents)
- [WCAG 2.2 AA Requirements for Help Centers](#wcag-22-aa-requirements-for-help-centers)
...
- [Platform Accessibility Features](#platform-accessibility-features)
- [Legal Context](#legal-context)
- [Checklist: Help Center Accessibility Audit](#checklist-help-center-accessibility-audit)
- [Do/Avoid](#doavoid)
...
1. Automated scan (axe or Lighthouse)
   ...
   - Automated tools catch a minority of issues — cited estimates range roughly 20-40% of WCAG failures depending on the tool and how coverage is measured (some tools score higher against real-world audit findings); manual and screen-reader testing remain required, not optional
...
- Assuming automated tools catch all issues (widely cited estimates put it at roughly 20-40%, never 100%)
