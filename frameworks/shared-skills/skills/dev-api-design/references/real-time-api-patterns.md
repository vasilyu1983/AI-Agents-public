...
**Freshness anchor:** March 2026 — aligned with WebSocket API (RFC 6455), EventSource API, GraphQL over WebSocket Protocol (graphql-ws), and Socket.IO v4.x.

---
## Table of Contents

- [Quick Decision: Choosing a Real-Time Pattern](#quick-decision-choosing-a-real-time-pattern)
- [Decision Tree](#decision-tree)
- [WebSocket Patterns](#websocket-patterns)
- [Connection Lifecycle](#connection-lifecycle)
- [Heartbeat / Keep-Alive Implementation](#heartbeat-keep-alive-implementation)
- [Client Reconnection Strategy](#client-reconnection-strategy)
- [Connection State Management](#connection-state-management)
- [WebSocket Message Protocol Design](#websocket-message-protocol-design)
- [Server-Sent Events (SSE)](#server-sent-events-sse)
- [Implementation](#implementation)
- [SSE vs WebSocket Checklist](#sse-vs-websocket-checklist)
- [Long Polling](#long-polling)
- [Implementation Pattern](#implementation-pattern)
- [GraphQL Subscriptions](#graphql-subscriptions)
- [Setup with graphql-ws](#setup-with-graphql-ws)
- [Schema](#schema)
- [Scaling Real-Time Connections](#scaling-real-time-connections)
- [Architecture for Multiple Server Instances](#architecture-for-multiple-server-instances)
- [Scaling Checklist](#scaling-checklist)
- [Load Balancer Configuration](#load-balancer-configuration)
- [Connection Limits Reference](#connection-limits-reference)
- [Security Considerations](#security-considerations)
- [WebSocket Security Checklist](#websocket-security-checklist)
- [SSE Security Checklist](#sse-security-checklist)
- [Authentication Patterns for WebSocket](#authentication-patterns-for-websocket)
