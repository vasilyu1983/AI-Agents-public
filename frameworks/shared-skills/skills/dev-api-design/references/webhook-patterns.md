...
**Freshness anchor:** March 2026 — aligned with current webhook delivery, replay protection, and HMAC-SHA256 best practices.

---
## Table of Contents

- [Quick Decision: Webhook vs Polling vs Streaming](#quick-decision-webhook-vs-polling-vs-streaming)
- [Event Schema Design](#event-schema-design)
- [Schema Structure Checklist](#schema-structure-checklist)
- [Envelope Template](#envelope-template)
- [Versioning Strategy Decision Tree](#versioning-strategy-decision-tree)
- [Event Type Naming Convention](#event-type-naming-convention)
- [Delivery Guarantees](#delivery-guarantees)
- [At-Least-Once Delivery (Standard)](#at-least-once-delivery-standard)
- [Retry Strategy: Exponential Backoff](#retry-strategy-exponential-backoff)
- [Dead Letter Queue (DLQ) Setup](#dead-letter-queue-dlq-setup)
- [Signature Verification (HMAC)](#signature-verification-hmac)
- [Provider-Side Signing](#provider-side-signing)
- [Consumer-Side Verification](#consumer-side-verification)
- [Signature Verification Checklist](#signature-verification-checklist)
- [Idempotency](#idempotency)
- [Consumer Idempotency Implementation](#consumer-idempotency-implementation)
- [Idempotency Store Options](#idempotency-store-options)
- [Idempotency Key Rules](#idempotency-key-rules)
- [Webhook Testing Patterns](#webhook-testing-patterns)
- [Local Development Testing](#local-development-testing)
- [Automated Testing Checklist](#automated-testing-checklist)
- [Payload Fixture Management](#payload-fixture-management)
...
- [Consumer Endpoint Checklist](#consumer-endpoint-checklist)
