...
- [Strategy 1: JWT (JSON Web Tokens)](#strategy-1-jwt-json-web-tokens)
- [JWT Authentication Flow](#jwt-authentication-flow)
- [JWT Structure](#jwt-structure)
- [JWT Best Practices](#jwt-best-practices)
- [On refresh](#on-refresh)
- [Invalidate old refresh token](#invalidate-old-refresh-token)
- [Strategy 2: OAuth2 Authorization Code Flow](#strategy-2-oauth2-authorization-code-flow)
- [OAuth2 Flow](#oauth2-flow)
- [Strategy 3: API Key Authentication](#strategy-3-api-key-authentication)
- [API Key Patterns](#api-key-patterns)
- [API Key Best Practices](#api-key-best-practices)
- [Save hashed version](#save-hashed-version)
- [Validate](#validate)
- [Authorization Patterns](#authorization-patterns)
- [Pattern 1: RBAC (Role-Based Access Control)](#pattern-1-rbac-role-based-access-control)
- [Pattern 2: ABAC (Attribute-Based Access Control)](#pattern-2-abac-attribute-based-access-control)
- [Pattern 3: Resource-Based Authorization](#pattern-3-resource-based-authorization)
...
- [BAD: Storing Passwords in Plain Text](#bad-storing-passwords-in-plain-text)
- [Bad](#bad)
- [Good](#good)
- [Verify](#verify)
- [BAD: Long-Lived Access Tokens](#bad-long-lived-access-tokens)
- [BAD: No HTTPS](#bad-no-https)
- [BAD: Trusting Client-Side Authorization](#bad-trusting-client-side-authorization)
- [Implementation Examples](#implementation-examples)
- [FastAPI (Python) - JWT Auth](#fastapi-python-jwt-auth)
- [Express.js (TypeScript) - JWT Auth](#expressjs-typescript-jwt-auth)
