...
- [The Five RESTful Principles](#the-five-restful-principles)
- [URL Structure Best Practices](#url-structure-best-practices)
- [Collection Endpoints](#collection-endpoints)
- [List all resources (with pagination)](#list-all-resources-with-pagination)
- [Create a new resource](#create-a-new-resource)
- [Resource Endpoints](#resource-endpoints)
- [Get a specific resource](#get-a-specific-resource)
- [Replace entire resource (full update)](#replace-entire-resource-full-update)
- [Update specific fields (partial update)](#update-specific-fields-partial-update)
- [Delete a resource](#delete-a-resource)
- [Nested Resources](#nested-resources)
- [User's orders (belongs-to relationship)](#users-orders-belongs-to-relationship)
- [Order items (nested collection)](#order-items-nested-collection)
- [BAD: Bad - Too deeply nested](#bad-bad-too-deeply-nested)
- [GOOD: Good - Flatten with query parameters](#good-good-flatten-with-query-parameters)
- [Action Endpoints (Non-CRUD Operations)](#action-endpoints-non-crud-operations)
...
- [Mark as deleted instead of removing from database](#mark-as-deleted-instead-of-removing-from-database)
...
- [Calling twice creates TWO orders](#calling-twice-creates-two-orders)
- [Stateless Design](#stateless-design)
- [Server stores "current user" in session](#server-stores-current-user-in-session)
- [Design Checklist](#design-checklist)
- [Common Anti-Patterns](#common-anti-patterns)
- [BAD: Verbs in URLs](#bad-verbs-in-urls)
- [Bad](#bad)
- [Good](#good)
- [BAD: Using GET for Mutations](#bad-using-get-for-mutations)
- [Bad - GET changes state](#bad-get-changes-state)
- [Good - POST for state changes](#good-post-for-state-changes)
- [BAD: Inconsistent Plurality](#bad-inconsistent-plurality)
- [Bad - Mixed singular/plural](#bad-mixed-singularplural)
- [Good - Always plural for collections](#good-always-plural-for-collections)
- [BAD: Deep Nesting](#bad-deep-nesting)
- [Bad - Too deep](#bad-too-deep)
- [Good - Flatten with query params](#good-flatten-with-query-params)
...
- **[openapi-guide.md](openapi-guide.md)** - Documentation with the current OpenAPI guide
