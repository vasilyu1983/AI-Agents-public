...
- [Strategy 1: Offset-Based Pagination (Simple)](#strategy-1-offset-based-pagination-simple)
- [Request Pattern](#request-pattern)
- [Response Format](#response-format)
- [Implementation Examples](#implementation-examples)
- [Strategy 2: Cursor-Based Pagination (Recommended)](#strategy-2-cursor-based-pagination-recommended)
- [Request Pattern](#request-pattern)
- [Response Format](#response-format)
- [Cursor Structure](#cursor-structure)
- [Implementation Examples](#implementation-examples)
- [Strategy 3: Page-Based Pagination](#strategy-3-page-based-pagination)
- [Request Pattern](#request-pattern)
- [Response Format](#response-format)
- [Filtering Patterns](#filtering-patterns)
- [Query Parameter Filtering](#query-parameter-filtering)
- [Filter Operator Conventions](#filter-operator-conventions)
- [Advanced Filtering with JSON](#advanced-filtering-with-json)
- [Sorting Patterns](#sorting-patterns)
- [Single Field Sort](#single-field-sort)
- [Multi-Field Sort](#multi-field-sort)
- [Sort by name ascending, then by created_at descending](#sort-by-name-ascending-then-by-createdat-descending)
- [Sort Direction Conventions](#sort-direction-conventions)
- [Alternative Sort Syntax](#alternative-sort-syntax)
- [Combining Pagination, Filtering & Sorting](#combining-pagination-filtering-&-sorting)
- [Pagination Best Practices](#pagination-best-practices)
- [Default Limits](#default-limits)
- [Always enforce max limits](#always-enforce-max-limits)
- [Include Metadata](#include-metadata)
- [Provide Navigation Links](#provide-navigation-links)
- [Consistent Ordering](#consistent-ordering)
- [Performance Optimization](#performance-optimization)
- [Index Filter & Sort Columns](#index-filter-&-sort-columns)
- [Avoid COUNT(*) for Large Tables](#avoid-count-for-large-tables)
- [BAD: Expensive for millions of records](#bad-expensive-for-millions-of-records)
- [GOOD: Cache total count or skip it](#good-cache-total-count-or-skip-it)
- [Only provide "hasMore" flag instead](#only-provide-hasmore-flag-instead)
- [Use Covering Indexes](#use-covering-indexes)
- [Checklist](#checklist)
- [Common Anti-Patterns](#common-anti-patterns)
- [BAD: No Default Limit](#bad-no-default-limit)
- [Bad - Returns all records](#bad-returns-all-records)
- [Good - Default limit enforced](#good-default-limit-enforced)
- [BAD: No Ordering](#bad-no-ordering)
- [BAD: Exposing Database IDs in Cursors](#bad-exposing-database-ids-in-cursors)
- [Bad - Leaks database structure](#bad-leaks-database-structure)
- [Good - Opaque base64-encoded cursor](#good-opaque-base64-encoded-cursor)
- [Decision Matrix: Which Pagination Strategy?](#decision-matrix-which-pagination-strategy)
