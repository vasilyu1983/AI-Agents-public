...
Comprehensive guide to building scalable, maintainable, and developer-friendly APIs in 2026.

---
## Table of Contents

- [Core Design Principles](#core-design-principles)
- [1. Resource-Oriented Design (REST)](#1-resource-oriented-design-rest)
- [Nested resources (max 2 levels)](#nested-resources-max-2-levels)
...
- [Versioning in URLs](#versioning-in-urls)
- [Version in path (recommended)](#version-in-path-recommended)
- [Version in subdomain](#version-in-subdomain)
- [Response Design](#response-design)
- [Standard Response Envelope](#standard-response-envelope)
- [Data Formats](#data-formats)
- [JSON Best Practices](#json-best-practices)
- [Option 1: Include null fields](#option-1-include-null-fields)
- [Option 2: Omit null fields (preferred for bandwidth)](#option-2-omit-null-fields-preferred-for-bandwidth)
...
- [Request](#request)
- [Response](#response)
- [4. Field Selection](#4-field-selection)
- [Security Best Practices](#security-best-practices)
- [1. HTTPS Only](#1-https-only)
- [2. Authentication](#2-authentication)
- [3. Rate Limiting](#3-rate-limiting)
- [4. Input Validation](#4-input-validation)
- [Documentation Best Practices](#documentation-best-practices)
- [OpenAPI Specification](#openapi-specification)
- [Developer Portal Must-Haves](#developer-portal-must-haves)
- [REST vs GraphQL vs gRPC](#rest-vs-graphql-vs-grpc)
- [Testing APIs](#testing-apis)
- [Contract Testing](#contract-testing)
- [Dredd - API testing framework](#dredd-api-testing-framework)
...
- [3. No Versioning](#3-no-versioning)
- [4. Inconsistent Naming](#4-inconsistent-naming)
- [5. Missing Pagination](#5-missing-pagination)
- [6. Exposing Internal IDs](#6-exposing-internal-ids)
- [7. Generic Error Messages](#7-generic-error-messages)
- [Resources](#resources)
...
See [openapi-guide.md](openapi-guide.md) for the current OpenAPI guide.
