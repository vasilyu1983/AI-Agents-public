...
**Freshness anchor:** 2026-07-11 — aligned with Pact v5 (beta), Schemathesis v4.x (major CLI rework from the 3.x line), k6 v1.x (k6 2.0 direction announced at GrafanaCON 2026), MSW v2.x, WireMock 3.x, and OpenAPI 3.2 / 3.1 toolchains. Tool major versions move fast — re-check current versions before pinning CI configs.

---
## Table of Contents

- [API Test Pyramid](#api-test-pyramid)
- [Contract Testing](#contract-testing)
- [Decision Tree: Which Contract Testing Approach](#decision-tree-which-contract-testing-approach)
- [Pact (Consumer-Driven Contracts)](#pact-consumer-driven-contracts)
- [Schemathesis (Property-Based API Testing)](#schemathesis-property-based-api-testing)
- [Basic run against OpenAPI spec](#basic-run-against-openapi-spec)
- [Target specific endpoints](#target-specific-endpoints)
- [CI-friendly with JUnit output](#ci-friendly-with-junit-output)
- [Stateful testing (link operations together)](#stateful-testing-link-operations-together)
- [Integration Testing Patterns](#integration-testing-patterns)
- [HTTP Integration Test Checklist](#http-integration-test-checklist)
- [Test Database Strategies](#test-database-strategies)
...
- [MSW (Mock Service Worker) v2](#msw-mock-service-worker-v2)
- [WireMock](#wiremock)
- [Run WireMock in Docker](#run-wiremock-in-docker)
- [Prism (OpenAPI Mock Server)](#prism-openapi-mock-server)
- [Start mock server from OpenAPI spec](#start-mock-server-from-openapi-spec)
- [Validation proxy mode (validate real API against spec)](#validation-proxy-mode-validate-real-api-against-spec)
- [Load Testing](#load-testing)
- [Tool Comparison](#tool-comparison)
- [k6 Load Test Template](#k6-load-test-template)
- [Load Test Checklist](#load-test-checklist)
- [Snapshot Testing for API Responses](#snapshot-testing-for-api-responses)
- [When to Use Snapshots](#when-to-use-snapshots)
- [Snapshot Strategy](#snapshot-strategy)
- [Snapshot Maintenance Rules](#snapshot-maintenance-rules)
- [CI/CD Integration](#cicd-integration)
- [Pipeline Stage Mapping](#pipeline-stage-mapping)
- [CI Configuration Checklist](#ci-configuration-checklist)
