...
- [RFC 9457 Problem Details Standard (Obsoletes RFC 7807)](#rfc-9457-problem-details-standard-obsoletes-rfc-7807)
...
- [400 Bad Request - Malformed JSON](#400-bad-request-malformed-json)
- [401 Unauthorized - Missing Token](#401-unauthorized-missing-token)
- [403 Forbidden - Insufficient Permissions](#403-forbidden-insufficient-permissions)
- [404 Not Found - Resource Missing](#404-not-found-resource-missing)
- [409 Conflict - Duplicate Resource](#409-conflict-duplicate-resource)
- [422 Unprocessable Entity - Validation Errors](#422-unprocessable-entity-validation-errors)
- [429 Too Many Requests - Rate Limit](#429-too-many-requests-rate-limit)
- [500 Internal Server Error](#500-internal-server-error)
- [Validation Error Patterns](#validation-error-patterns)
- [Field-Level Errors](#field-level-errors)
- [Nested Field Errors](#nested-field-errors)
- [Error Codes Convention](#error-codes-convention)
- [Implementation Examples](#implementation-examples)
- [FastAPI (Python)](#fastapi-python)
- [Express.js (TypeScript)](#expressjs-typescript)
- [Best Practices Checklist](#best-practices-checklist)
- [Common Anti-Patterns](#common-anti-patterns)
- [BAD: Inconsistent Error Format](#bad-inconsistent-error-format)
- [BAD: Generic Error Messages](#bad-generic-error-messages)
- [BAD: Exposing Internal Errors](#bad-exposing-internal-errors)
- [BAD: No Trace ID](#bad-no-trace-id)
- [Error Response Decision Matrix](#error-response-decision-matrix)
