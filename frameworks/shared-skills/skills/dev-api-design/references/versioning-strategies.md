...
- [4. Content Negotiation (Media Type Versioning)](#4-content-negotiation-media-type-versioning)
- [5. Subdomain Versioning](#5-subdomain-versioning)
- [Choosing a Strategy](#choosing-a-strategy)
- [Versioning Best Practices](#versioning-best-practices)
- [1. Version Only Breaking Changes](#1-version-only-breaking-changes)
- [2. Use Semantic Versioning](#2-use-semantic-versioning)
- [3. Document Breaking Changes](#3-document-breaking-changes)
- [v2.0.0 (2026-01-20)](#v200-2026-01-20)
- [Breaking Changes](#breaking-changes)
- [Migration Guide](#migration-guide)
- [4. Support N-1 Versions (Minimum)](#4-support-n-1-versions-minimum)
- [5. Use Sunset Headers](#5-use-sunset-headers)
- [6. Default to Latest Stable](#6-default-to-latest-stable)
- [7. Version OpenAPI Specs](#7-version-openapi-specs)
- [openapi-v1.yaml](#openapi-v1yaml)
- [openapi-v2.yaml](#openapi-v2yaml)
- [Migration Strategies](#migration-strategies)
- [1. Dual-Write Pattern](#1-dual-write-pattern)
- [2. Adapter Pattern](#2-adapter-pattern)
- [3. Feature Flags](#3-feature-flags)
- [4. Proxy Pattern](#4-proxy-pattern)
- [Monitoring & Analytics](#monitoring-&-analytics)
- [Track Version Adoption](#track-version-adoption)
- [Deprecation Alerts](#deprecation-alerts)
- [Real-World Examples](#real-world-examples)
- [Stripe API](#stripe-api)
- [GitHub API](#github-api)
- [Twitter API](#twitter-api)
- [GraphQL Versioning](#graphql-versioning)
- [BAD: Don't version entire schema](#bad-dont-version-entire-schema)
- [GOOD: Deprecate fields, add new ones](#good-deprecate-fields-add-new-ones)
- [Checklist for New Version](#checklist-for-new-version)
- [Resources](#resources)
...
**Timeline:**
```
YYYY-MM-DD: v1 released
YYYY-MM-DD: v2 released (v1 still supported)
2026-01-01: v3 released (v1 deprecated, v2 supported)
2026-06-01: v1 sunset (only v2, v3 supported)
```
...
- Header: `Stripe-Version: 2024-12-18` <!-- as documented at time of writing; verify current version at https://stripe.com/docs/api/versioning -->
- Combines both approaches (path + header)

**Features:**
- Dated versions (2024-12-18) instead of v1, v2 <!-- as documented at time of writing -->
