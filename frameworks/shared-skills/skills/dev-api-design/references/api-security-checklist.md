...
- [OWASP Updates (March 2026)](#owasp-updates-march-2026)
...
- [User 123 can access order 456 even if it belongs to user 789](#user-123-can-access-order-456-even-if-it-belongs-to-user-789)
...
**OWASP Top 10 project** remains relevant for API-adjacent web risks, especially dependency, misconfiguration, and access control issues:

| New/Changed | Category | API Relevance |
|-------------|----------|---------------|
| **A03:2025** *(anticipated — no official 2025 list released at time of writing)* | Software Supply Chain Failures | Third-party API dependencies, SDK vulnerabilities |
| **A02:2025** *(anticipated)* | Security Misconfiguration (now #2) | API gateway configs, CORS, headers |
| **A01:2025** *(anticipated)* | Broken Access Control (SSRF merged) | BOLA, BFLA, SSRF all under access control |
...
See: [OWASP Top 10 project](https://owasp.org/www-project-top-ten/)
