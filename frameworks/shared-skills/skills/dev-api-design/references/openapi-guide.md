...
Complete guide to documenting REST APIs using OpenAPI. OAS 3.2 is the current spec line; OAS 3.1 remains widely deployed across tooling.

**Freshness anchor:** March 2026 — verified against the official OpenAPI spec site.
...
- [3. Response Examples](#3-response-examples)
- [4. Security Schemes](#4-security-schemes)
- [Best Practices](#best-practices)
- [1. Use Descriptive Operation IDs](#1-use-descriptive-operation-ids)
- [2. Include Examples](#2-include-examples)
- [3. Document Error Responses](#3-document-error-responses)
- [4. Use Tags for Organization](#4-use-tags-for-organization)
- [5. Document Deprecations](#5-document-deprecations)
- [Validation & Linting](#validation-&-linting)
- [Spectral (OpenAPI Linter)](#spectral-openapi-linter)
- [Install](#install)
- [Lint spec](#lint-spec)
- [OpenAPI Validator](#openapi-validator)
- [Swagger Editor](#swagger-editor)
- [Visit http://localhost:8080](#visit-httplocalhost8080)
- [Generating Documentation](#generating-documentation)
- [Swagger UI](#swagger-ui)
- [Redoc](#redoc)
- [Generating Client SDKs](#generating-client-sdks)
- [OpenAPI Generator](#openapi-generator)
- [Supported generators: typescript-axios, python, java, go, ruby, php, etc.](#supported-generators-typescript-axios-python-java-go-ruby-php-etc)
...
- [OK] **API contract testing** (Schemathesis, Pact)
- [TEST] **Mock servers** (Prism, MockServer)
- [SEARCH] **API linting** (Spectral)

**Version History:**
- OpenAPI 3.2 - Current spec line
- OpenAPI 3.1 (2021) - Widely deployed, JSON Schema compatible
...
components:
  ...
  responses:
    ...
    RateLimitError:
      ...
      headers:
        RateLimit:
          description: Current rate-limit state for this client
          schema:
            type: string
            example: "limit=1000, remaining=0, reset=60"
        RateLimit-Policy:
          description: Published quota policy for this endpoint
          schema:
            type: string
            example: "1000;w=60"
        Retry-After:
