...
- [tRPC Excels For](#trpc-excels-for)
- [tRPC Not Recommended For](#trpc-not-recommended-for)
...
- [Context with Auth](#context-with-auth)
- [Auth Middleware](#auth-middleware)
- [Error Handling](#error-handling)
- [tRPC Error Codes](#trpc-error-codes)
- [Structured Errors](#structured-errors)
- [Client Usage (React)](#client-usage-react)
- [Provider Setup](#provider-setup)
- [Query and Mutation Hooks](#query-and-mutation-hooks)
- [Performance Patterns](#performance-patterns)
- [Batching](#batching)
- [Prefetching](#prefetching)
- [Server-Side Rendering (Next.js)](#server-side-rendering-nextjs)
- [tRPC vs GraphQL vs REST](#trpc-vs-graphql-vs-rest)
