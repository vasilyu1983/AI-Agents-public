...
- [Contents](#contents)
- [Standalone API Testing](#standalone-api-testing)
- [APIRequestContext Creation](#apirequestcontext-creation)
- [Request Methods](#request-methods)
- [Header and Auth Management](#header-and-auth-management)
- [Response Validation Patterns](#response-validation-patterns)
- [JSON Schema Validation](#json-schema-validation)
- [Combining API and UI Tests](#combining-api-and-ui-tests)
- [File Upload and Download](#file-upload-and-download)
- [Multipart Form Data](#multipart-form-data)
- [API Test Fixtures](#api-test-fixtures)
- [Parallel API Testing](#parallel-api-testing)
- [Mocking External APIs](#mocking-external-apis)
- [API Test Organization](#api-test-organization)
