...
- [Contents](#contents)
- [Native toHaveScreenshot API](#native-tohavescreenshot-api)
- [Full-Page vs Element Screenshots](#full-page-vs-element-screenshots)
- [Masking Dynamic Content](#masking-dynamic-content)
- [Threshold Tuning](#threshold-tuning)
- [Cross-Platform Baseline Management](#cross-platform-baseline-management)
- [Third-Party Integrations](#third-party-integrations)
- [Update Workflow](#update-workflow)
- [CI Integration](#ci-integration)
- [Responsive Visual Testing](#responsive-visual-testing)
- [Dark Mode Visual Testing](#dark-mode-visual-testing)
- [Component Visual Testing](#component-visual-testing)
...
test('homepage visual regression', async ({ page }) => {
  await page.goto('/');
  // Wait for explicit UI readiness instead of relying on networkidle.
...
FROM mcr.microsoft.com/playwright:v1.61.1-noble  # pin matches references/playwright-ci.md baseline
WORKDIR /app
COPY package*.json ./
RUN npm ci
COPY . .
...
| **Percy** | AI-powered diff | Chrome, Firefox, Safari, Edge | Paid, tiered (verify current pricing at https://www.browserstack.com/pricing as of 2026-07-11) | Web dashboard | GitHub, GitLab, Bitbucket |
...
| No explicit readiness assertion before screenshot | Captures loading states | Wait for a stable element or UI state, then capture |
...
- [Percy Playwright SDK](https://www.browserstack.com/docs/percy/integrate/playwright)
