...
- [Contents](#contents)
- [StorageState Pattern](#storagestate-pattern)
- [Global Setup for Authentication](#global-setup-for-authentication)
- [Project Dependencies for Auth](#project-dependencies-for-auth)
- [Multi-User Authentication](#multi-user-authentication)
- [Multi-Factor Auth Handling](#multi-factor-auth-handling)
- [OAuth/OIDC Flow Testing](#oauthoidc-flow-testing)
- [API-Based Login](#api-based-login)
- [Token Refresh Handling](#token-refresh-handling)
- [Session Expiry Testing](#session-expiry-testing)
- [Auth Fixture Patterns](#auth-fixture-patterns)
- [Persistent Auth Across Test Files](#persistent-auth-across-test-files)
- [Security Considerations](#security-considerations)
- [Auth Pattern Decision Matrix](#auth-pattern-decision-matrix)
...
StorageState saves and restores authenticated browser state, eliminating redundant login flows across tests. In current Playwright, that can include cookies, localStorage, and IndexedDB when needed.
...
setup('authenticate', async ({ page }) => {
  ...
  // Save signed-in state. Include IndexedDB for apps like Firebase Auth.
...
|----------|-------------|
| Cookies (all domains) | sessionStorage |
| localStorage (all origins) | Service worker registrations |
| IndexedDB (when `indexedDB: true`) | In-memory state |
