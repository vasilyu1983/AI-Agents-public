...
- [Decision Tree: Extract or Inline?](#decision-tree-extract-or-inline)
- [Naming Conventions](#naming-conventions)
- [File Names](#file-names)
- [Function Names](#function-names)
- [Utility Categories](#utility-categories)
- [1. Authentication Utilities](#1-authentication-utilities)
- [2. Error Utilities](#2-error-utilities)
- [3. Config Utilities](#3-config-utilities)
- [4. Logger Utilities](#4-logger-utilities)
- [5. Resilience Utilities](#5-resilience-utilities)
- [Import Patterns](#import-patterns)
- [Path Aliases (Recommended)](#path-aliases-recommended)
- [Usage](#usage)
- [Multi-Language Patterns](#multi-language-patterns)
- [TypeScript/Node.js](#typescriptnodejs)
- [Python](#python)
- [Go](#go)
- [Template Integration](#template-integration)
- [Checklist Before Copying Code](#checklist-before-copying-code)
