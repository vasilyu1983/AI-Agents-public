...
- [Error Classes (`src/utils/errors.ts`)](#error-classes-srcutilserrorsts)
- [RFC 9457 Problem Details Type](#rfc-9457-problem-details-type)
- [Correlation ID Utilities (`src/utils/correlation.ts`)](#correlation-id-utilities-srcutilscorrelationts)
- [Error Handler Middleware (`src/middleware/error-handler.ts`)](#error-handler-middleware-srcmiddlewareerror-handlerts)
- [Express App Setup](#express-app-setup)
- [Effect Library Pattern (TypeScript)](#effect-library-pattern-typescript)
- [Effect Error Mapping to HTTP](#effect-error-mapping-to-http)
- [Python (FastAPI)](#python-fastapi)
- [Error Classes (`src/utils/errors.py`)](#error-classes-srcutilserrorspy)
- [Correlation ID context variable](#correlation-id-context-variable)
- [Correlation ID Middleware (`src/middleware/correlation.py`)](#correlation-id-middleware-srcmiddlewarecorrelationpy)
- [Exception Handlers (`src/middleware/error_handler.py`)](#exception-handlers-srcmiddlewareerrorhandlerpy)
- [FastAPI App Setup](#fastapi-app-setup)
- [src/main.py](#srcmainpy)
- [Middleware (order matters)](#middleware-order-matters)
- [Exception handlers](#exception-handlers)
- [Go (Fiber)](#go-fiber)
- [Error Types with Correlation (`internal/utils/errors.go`)](#error-types-with-correlation-internalutilserrorsgo)
- [Error Handler with Correlation (`internal/middleware/error_handler.go`)](#error-handler-with-correlation-internalmiddlewareerrorhandlergo)
- [Usage Examples](#usage-examples)
- [Throwing Errors with Correlation](#throwing-errors-with-correlation)
- [Python](#python)
- [RFC 9457 Problem Details Response Format](#rfc-9457-problem-details-response-format)
