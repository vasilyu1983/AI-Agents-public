...
- [Types (`src/types/auth.ts`)](#types-srctypesauthts)
- [Utilities (`src/utils/auth.ts`)](#utilities-srcutilsauthts)
- [Middleware (`src/middleware/auth.ts`)](#middleware-srcmiddlewareauthts)
- [Python (FastAPI)](#python-fastapi)
- [Utilities (`src/utils/auth.py`)](#utilities-srcutilsauthpy)
- [Argon2id with OWASP-recommended parameters](#argon2id-with-owasp-recommended-parameters)
- [============================================](#============================================)
...
- [============================================](#============================================)
- [Dependencies (`src/dependencies/auth.py`)](#dependencies-srcdependenciesauthpy)
- [Go (Fiber)](#go-fiber)
- [Utilities (`internal/utils/auth.go`)](#utilities-internalutilsauthgo)
- [Middleware (`internal/middleware/auth.go`)](#middleware-internalmiddlewareauthgo)
- [OAuth 2.1 / PKCE (TypeScript)](#oauth-21-pkce-typescript)
- [PKCE Utilities (`src/utils/oauth.ts`)](#pkce-utilities-srcutilsoauthts)
- [OAuth Client Setup](#oauth-client-setup)
- [Usage Examples](#usage-examples)
- [TypeScript Service](#typescript-service)
- [Python Router](#python-router)
- [src/routers/auth.py](#srcroutersauthpy)
- [Migration Guide: bcrypt → Argon2](#migration-guide-bcrypt-→-argon2)
- [Gradual Migration Pattern](#gradual-migration-pattern)
