...
- [TypeScript: Vitest (Recommended)](#typescript-vitest-recommended)
- [Dependencies](#dependencies)
- [Factory Pattern (`src/test/factories/user.factory.ts`)](#factory-pattern-srctestfactoriesuserfactoryts)
- [Database Fixtures (`src/test/fixtures/database.ts`)](#database-fixtures-srctestfixturesdatabasets)
- [API Mocks with MSW (`src/test/mocks/api.mock.ts`)](#api-mocks-with-msw-srctestmocksapimockts)
- [Test Setup (`src/test/helpers/setup.ts`)](#test-setup-srctesthelperssetupts)
- [Example Test (`src/test/user.service.test.ts`)](#example-test-srctestuserservicetestts)
- [Python: pytest + Factory Boy](#python-pytest-factory-boy)
- [Dependencies](#dependencies)
- [Factory Pattern (`tests/factories/user_factory.py`)](#factory-pattern-testsfactoriesuserfactorypy)
- [Convenience functions](#convenience-functions)
- [Database Fixtures (`tests/fixtures/database.py`)](#database-fixtures-testsfixturesdatabasepy)
- [API Mocks with respx (`tests/mocks/api_mock.py`)](#api-mocks-with-respx-testsmocksapimockpy)
- [Test Helpers (`tests/helpers.py`)](#test-helpers-testshelperspy)
- [Example Test (`tests/test_user_service.py`)](#example-test-teststestuserservicepy)
- [Testing Best Practices](#testing-best-practices)
- [Factory Guidelines](#factory-guidelines)
- [Mock Guidelines](#mock-guidelines)
- [Database Test Guidelines](#database-test-guidelines)
- [Anti-Pattern: Hardcoded Test Data](#anti-pattern-hardcoded-test-data)
