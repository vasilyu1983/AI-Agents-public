...
- [TypeScript: Zod 3.24+](#typescript-zod-324)
- [Dependencies](#dependencies)
- [Schema (`src/config/schema.ts`)](#schema-srcconfigschemats)
- [Config Export (`src/config/index.ts`)](#config-export-srcconfigindexts)
- [TypeScript: Valibot (Lightweight Alternative)](#typescript-valibot-lightweight-alternative)
- [Dependencies](#dependencies)
- [Schema (`src/config/schema.ts`)](#schema-srcconfigschemats)
- [Config Export (`src/config/index.ts`)](#config-export-srcconfigindexts)
- [Zod vs Valibot Comparison](#zod-vs-valibot-comparison)
- [Python: Pydantic 2.x](#python-pydantic-2x)
- [Dependencies](#dependencies)
- [Settings (`src/config/settings.py`)](#settings-srcconfigsettingspy)
- [Usage](#usage)
- [Go 1.25+](#go-125)
- [Dependencies](#dependencies)
- [Config (`internal/config/config.go`)](#config-internalconfigconfiggo)
- [Usage](#usage)
- [Secrets Management](#secrets-management)
- [1Password CLI (Recommended for Teams)](#1password-cli-recommended-for-teams)
- [Install 1Password CLI](#install-1password-cli)
- [Authenticate](#authenticate)
- [Load secrets at runtime](#load-secrets-at-runtime)
- [Or use op run for full env injection](#or-use-op-run-for-full-env-injection)
- [Doppler (Cloud-Native)](#doppler-cloud-native)
- [Install Doppler CLI](#install-doppler-cli)
- [Setup project](#setup-project)
- [Run with injected secrets](#run-with-injected-secrets)
- [Or export to .env (for local dev only)](#or-export-to-env-for-local-dev-only)
...
- [Non-Null Assertions on Environment Variables](#non-null-assertions-on-environment-variables)
- [Scattered Config Access](#scattered-config-access)
- [Secrets in Code](#secrets-in-code)
- [No Startup Validation](#no-startup-validation)
