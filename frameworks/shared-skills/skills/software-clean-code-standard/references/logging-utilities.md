...
**Node.js**: 24 LTS (verify current) | **Python**: 3.14+ (verify current) | **Go**: 1.25+ (verify current)

---
## Table of Contents

- [File Structure](#file-structure)
- [TypeScript/Node.js (pino v9 + OpenTelemetry)](#typescriptnodejs-pino-v9-opentelemetry)
- [Dependencies](#dependencies)
- [Logger Singleton (`src/utils/logger.ts`)](#logger-singleton-srcutilsloggerts)
- [Request Logger Middleware (`src/middleware/request-logger.ts`)](#request-logger-middleware-srcmiddlewarerequest-loggerts)
- [Usage Examples](#usage-examples)
- [Python (structlog + OpenTelemetry)](#python-structlog-opentelemetry)
- [Dependencies](#dependencies)
- [Logger Setup (`src/utils/logger.py`)](#logger-setup-srcutilsloggerpy)
- [Module-level logger](#module-level-logger)
- [Log with span helper](#log-with-span-helper)
- [Request Logging Middleware (`src/middleware/logging.py`)](#request-logging-middleware-srcmiddlewareloggingpy)
- [Usage](#usage)
- [Basic logging (trace context auto-injected)](#basic-logging-trace-context-auto-injected)
- [With context](#with-context)
- [Module-specific logger](#module-specific-logger)
- [Log with automatic span](#log-with-automatic-span)
- [Go (zap + OpenTelemetry)](#go-zap-opentelemetry)
- [Dependencies](#dependencies)
- [Logger Setup (`internal/utils/logger.go`)](#logger-setup-internalutilsloggergo)
- [Request Logger Middleware (`internal/middleware/logger.go`)](#request-logger-middleware-internalmiddlewareloggergo)
- [Usage](#usage)
- [Log Levels Guide](#log-levels-guide)
- [What to Log](#what-to-log)
- [What NOT to Log](#what-not-to-log)
- [Sensitive Data Redaction](#sensitive-data-redaction)
- [Anti-Pattern: Scattered Logger Creation](#anti-pattern-scattered-logger-creation)
