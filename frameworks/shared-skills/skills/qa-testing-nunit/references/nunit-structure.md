...
- NUnit 4 requires minimum .NET Framework 4.6.2 or .NET 6.0. Do not add NUnit 4 to .NET 5 or below targets.
...
- Current stable: NUnit 4.6.1 (May 2026). Pin to the latest patch unless you have an explicit reason to hold back.
