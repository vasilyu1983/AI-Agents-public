...
public sealed class DatabaseLauncher : IAsyncDisposable
{
    ...
    private const string MainMigratorImage = "registry.example.com/sc.tool/sc_tool_fluentmigrator:latest";
    private const string DependencyMigratorImage = "registry.example.com/company/dependency-migrator:latest";
    private const string AuxiliaryMigratorImage = "registry.example.com/company/aux-migrator:latest";
