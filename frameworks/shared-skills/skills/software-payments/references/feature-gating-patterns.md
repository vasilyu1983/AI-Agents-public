...
- [Consumable vs. Binary Unlock Architecture](#consumable-vs-binary-unlock-architecture)
- [Binary Unlocks](#binary-unlocks)
- [Consumables](#consumables)
- [Spread-Then-Override Tier Filtering](#spread-then-override-tier-filtering)
- [Spread-Then-Override (PASS: Forward-Compatible)](#spread-then-override-pass-forward-compatible)
- [Allowlist (FAIL: Brittle)](#allowlist-fail-brittle)
- [Fraud Prevention Patterns](#fraud-prevention-patterns)
- [1. Cross-Account Intro Pricing Detection](#1-cross-account-intro-pricing-detection)
- [2. Refund-and-Revoke](#2-refund-and-revoke)
- [3. Stale Feature Cache Invalidation](#3-stale-feature-cache-invalidation)
- [4. Rate Limiting LLM-Costly Features](#4-rate-limiting-llm-costly-features)
- [Discriminated Union for Gated Fields](#discriminated-union-for-gated-fields)
- [Type Definition](#type-definition)
- [API Response Usage](#api-response-usage)
- [React Component with Render Props](#react-component-with-render-props)
- [Why Discriminated Union over Optional Fields](#why-discriminated-union-over-optional-fields)
