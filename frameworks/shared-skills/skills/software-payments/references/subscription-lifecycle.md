...
- [Webhook Events Per Transition](#webhook-events-per-transition)
- [Trial Management](#trial-management)
- [Trial Configuration](#trial-configuration)
- [trial_will_end Handling](#trialwillend-handling)
- [Trial Conversion Optimisation](#trial-conversion-optimisation)
- [Upgrade / Downgrade Flows](#upgrade-downgrade-flows)
- [Proration Strategies](#proration-strategies)
- [Upgrade Flow](#upgrade-flow)
- [Downgrade Flow](#downgrade-flow)
- [Cancellation Patterns](#cancellation-patterns)
- [Cancel-at-Period-End (Recommended Default)](#cancel-at-period-end-recommended-default)
- [Immediate Cancellation](#immediate-cancellation)
- [Cancellation with Survey](#cancellation-with-survey)
- [Reactivation and Win-Back](#reactivation-and-win-back)
- [Reactivate Before Period End](#reactivate-before-period-end)
- [Win-Back Expired Subscriptions](#win-back-expired-subscriptions)
- [Win-Back Email Sequence](#win-back-email-sequence)
- [Dunning Management](#dunning-management)
- [Retry Schedule (Stripe Default)](#retry-schedule-stripe-default)
- [Smart Retries](#smart-retries)
- [Grace Period Pattern](#grace-period-pattern)
- [Customer Notification During Dunning](#customer-notification-during-dunning)
- [Pause and Resume](#pause-and-resume)
- [Stripe Subscription Pause (2026+)](#stripe-subscription-pause-2026)
