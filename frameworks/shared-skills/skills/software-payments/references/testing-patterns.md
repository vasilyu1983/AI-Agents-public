...
- [Stripe CLI for Local Webhook Testing](#stripe-cli-for-local-webhook-testing)
- [Forward events to local webhook endpoint](#forward-events-to-local-webhook-endpoint)
- [Trigger specific events for testing](#trigger-specific-events-for-testing)
- [Test Card Numbers](#test-card-numbers)
- [Playwright E2E for Checkout Flows](#playwright-e2e-for-checkout-flows)
- [Subscription State Sync for Tests](#subscription-state-sync-for-tests)
- [Test Environment Setup Checklist](#test-environment-setup-checklist)
