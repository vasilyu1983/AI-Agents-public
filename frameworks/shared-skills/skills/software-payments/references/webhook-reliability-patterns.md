...
- [Why Webhook Reliability Matters](#why-webhook-reliability-matters)
- [Idempotency Key Design](#idempotency-key-design)
- [Strategy 1: Event ID (Recommended)](#strategy-1-event-id-recommended)
- [Strategy 2: Metadata Hash](#strategy-2-metadata-hash)
- [Database Schema for Idempotency](#database-schema-for-idempotency)
- [Deduplication Window](#deduplication-window)
- [Retry Handling](#retry-handling)
- [Stripe Retry Schedule](#stripe-retry-schedule)
- [Response Codes and Their Meaning](#response-codes-and-their-meaning)
- [Handler Timeout Strategy](#handler-timeout-strategy)
...
- [Example Datadog/Grafana alert rules](#example-datadoggrafana-alert-rules)
- [Event Ordering](#event-ordering)
- [The Ordering Problem](#the-ordering-problem)
- [Solution: Use Event Timestamps](#solution-use-event-timestamps)
- [Add to Schema](#add-to-schema)
- [Signature Verification](#signature-verification)
- [Timing-Safe Comparison](#timing-safe-comparison)
- [Replay Prevention](#replay-prevention)
- [Raw Body Requirement](#raw-body-requirement)
- [Queue-Based Webhook Processing](#queue-based-webhook-processing)
- [Architecture](#architecture)
- [Implementation with Bull/BullMQ (Redis)](#implementation-with-bullbullmq-redis)
- [Testing Webhook Reliability](#testing-webhook-reliability)
- [Stripe CLI for Local Testing](#stripe-cli-for-local-testing)
- [Forward webhooks to local endpoint](#forward-webhooks-to-local-endpoint)
- [Trigger specific events](#trigger-specific-events)
- [Replay a specific event from Stripe Dashboard](#replay-a-specific-event-from-stripe-dashboard)
- [Chaos Testing](#chaos-testing)
- [Multi-Environment Webhook Routing](#multi-environment-webhook-routing)
- [Environment Configuration](#environment-configuration)
- [Stripe CLI for Development](#stripe-cli-for-development)
- [Use Stripe CLI for local development](#use-stripe-cli-for-local-development)
- [The CLI provides a temporary webhook secret (whsec_...)](#the-cli-provides-a-temporary-webhook-secret-whsec)
- [Use this in your .env.local](#use-this-in-your-envlocal)
- [Webhook Registration](#webhook-registration)
- [Register staging webhook via Stripe CLI](#register-staging-webhook-via-stripe-cli)
- [List registered endpoints](#list-registered-endpoints)
- [Webhook API Version Migration](#webhook-api-version-migration)
- [Handling Version Changes](#handling-version-changes)
