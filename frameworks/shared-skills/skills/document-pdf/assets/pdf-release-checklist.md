...
- [ ] If the PDF is public, customer-facing, or regulated, it is tagged and checked with PAC or Acrobat Accessibility Checker
...
- [ ] If archival output is required, validate the PDF/A variant with veraPDF
