...
- What signal is missing? logs / metrics / traces / profiles / assertions / tool traces
...
- For agentic failures, capture prompt/version, model/provider, retrieval inputs, tool arguments/results, and policy decisions.
