...
> Purpose: Operational reference for writing effective SQL in Metabase — variables, field filters, template tags, SQL snippets, caching, performance tuning, and common gotchas. Freshness anchor: July 2026 (content is version-stable SQL/template-tag syntax).

---
## Table of Contents

- [Quick Reference: Template Tag Types](#quick-reference-template-tag-types)
- [Variables (Text, Number, Date)](#variables-text-number-date)
- [Basic Variable Syntax](#basic-variable-syntax)
- [Variable Configuration](#variable-configuration)
- [Optional Variables (Handle NULL)](#optional-variables-handle-null)
- [Variable Gotchas](#variable-gotchas)
- [Field Filters](#field-filters)
- [What Makes Field Filters Special](#what-makes-field-filters-special)
- [Field Filter Syntax](#field-filter-syntax)
- [Field Filter Configuration](#field-filter-configuration)
- [Field Filter on Non-Date Columns](#field-filter-on-non-date-columns)
- [Field Filter Limitations](#field-filter-limitations)
- [Field Filter in CTE Workaround](#field-filter-in-cte-workaround)
- [SQL Snippets](#sql-snippets)
- [Creating Snippets](#creating-snippets)
- [Snippet Examples](#snippet-examples)
- [Snippet Best Practices](#snippet-best-practices)
- [Saved Question Reuse (Card References)](#saved-question-reuse-card-references)
- [Syntax](#syntax)
- [Use Cases](#use-cases)
- [Gotchas with Card References](#gotchas-with-card-references)
- [Result Caching Configuration](#result-caching-configuration)
- [Cache Settings](#cache-settings)
- [Per-Question Cache Override](#per-question-cache-override)
- [Cache Strategy Decision](#cache-strategy-decision)
- [Cache Monitoring](#cache-monitoring)
- [Query Performance in Metabase](#query-performance-in-metabase)
- [Performance Checklist](#performance-checklist)
- [Identifying Slow Queries](#identifying-slow-queries)
- [Common Metabase SQL Patterns](#common-metabase-sql-patterns)
- [Pattern: Date Spine with Metrics](#pattern-date-spine-with-metrics)
- [Pattern: Running Total](#pattern-running-total)
- [Pattern: Top N with "Other"](#pattern-top-n-with-other)
...
- [data-sql-optimization skill](../../data-sql-optimization/SKILL.md) — Table partitioning and database monitoring for query performance

---

*Last updated: 2026-07-11 | Next review: 2026-10-11*
