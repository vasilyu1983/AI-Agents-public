...
> Purpose: Operational guide for configuring Metabase permissions — group-based access control, collection hierarchy, data sandboxing, database/table permissions, API automation, and multi-team organization. Freshness anchor: June 2026.

---
## Table of Contents

- [Decision Tree: Permission Architecture](#decision-tree-permission-architecture)
- [Quick Reference: Permission Levels](#quick-reference-permission-levels)
- [Data Permissions (Database/Schema/Table)](#data-permissions-databaseschematable)
- [Collection Permissions](#collection-permissions)
- [Native Query Permissions](#native-query-permissions)
- [Group-Based Permission Model](#group-based-permission-model)
- [Core Concept](#core-concept)
- [Recommended Group Structure](#recommended-group-structure)
- [Setup via Admin UI](#setup-via-admin-ui)
- [Collection Hierarchy](#collection-hierarchy)
- [Design Principles](#design-principles)
- [Recommended Structure](#recommended-structure)
- [Collection Permission Override](#collection-permission-override)
- [Data Sandboxing](#data-sandboxing)
- [What It Does](#what-it-does)
- [Row-Level Sandboxing](#row-level-sandboxing)
- [How It Works](#how-it-works)
- [Column-Level Sandboxing](#column-level-sandboxing)
- [Sandbox Configuration Checklist](#sandbox-configuration-checklist)
- [Sandbox Limitations](#sandbox-limitations)
- [Database-Level vs Table-Level Permissions](#database-level-vs-table-level-permissions)
- [When to Use Each](#when-to-use-each)
- [Granular Table Permissions](#granular-table-permissions)
- [Admin API for Permission Automation](#admin-api-for-permission-automation)
- [List Groups](#list-groups)
- [GET all groups](#get-all-groups)
- [Create Group](#create-group)
- [POST new group](#post-new-group)
- [Set Data Permissions](#set-data-permissions)
- [PUT data permissions for a group](#put-data-permissions-for-a-group)
- [Set Collection Permissions](#set-collection-permissions)
- [PUT collection permissions](#put-collection-permissions)
- [Automated Customer Onboarding](#automated-customer-onboarding)
- [Multi-Team Organization Patterns](#multi-team-organization-patterns)
- [Pattern 1: Department-Based](#pattern-1-department-based)
- [Pattern 2: Role-Based](#pattern-2-role-based)
- [Pattern 3: Hybrid (Department + Role)](#pattern-3-hybrid-department-role)
- [Audit Logging](#audit-logging)
- [What Metabase Logs](#what-metabase-logs)
- [Audit Queries (Application Database)](#audit-queries-application-database)
...
- v62+ (Pro/Enterprise): the Library's Data and Metrics collections can hold sub-collections with their own permissions, inherited from the parent by default — use this to scope table/metric visibility per team without duplicating the whole Library
...
- [software-security-appsec skill](../../software-security-appsec/SKILL.md) — Data lake security underlying Metabase permissions
