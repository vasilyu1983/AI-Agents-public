...
**Freshness anchor:** June 2026 — verify current SPDX identifiers, source-available license terms, and tooling support before making policy calls.

---
## Table of Contents

- [License Quick Reference](#license-quick-reference)
- [Common License Types](#common-license-types)
- [Risk Classification](#risk-classification)
- [License Compatibility Matrix](#license-compatibility-matrix)
- [Can I combine these licenses in one project?](#can-i-combine-these-licenses-in-one-project)
- [GPL Contamination Decision Tree](#gpl-contamination-decision-tree)
- [Automated Tooling](#automated-tooling)
- [Tool Comparison](#tool-comparison)
- [npm: license-checker](#npm-license-checker)
- [List all licenses](#list-all-licenses)
- [Check for prohibited licenses](#check-for-prohibited-licenses)
- [Exclude dev dependencies](#exclude-dev-dependencies)
- [Output CSV for legal review](#output-csv-for-legal-review)
- [Custom allow list](#custom-allow-list)
- [Python: pip-licenses](#python-pip-licenses)
- [List all licenses](#list-all-licenses)
- [JSON output for automation](#json-output-for-automation)
- [Fail on disallowed licenses](#fail-on-disallowed-licenses)
- [Allow-list mode](#allow-list-mode)
- [Go: go-licenses](#go-go-licenses)
- [Check all licenses](#check-all-licenses)
- [Save license files](#save-license-files)
- [Report format](#report-format)
- [FOSSA CLI](#fossa-cli)
- [Initialize project](#initialize-project)
- [Analyze dependencies](#analyze-dependencies)
- [Check policy compliance (blocks on violations)](#check-policy-compliance-blocks-on-violations)
- [Generate SBOM](#generate-sbom)
- [CI/CD Integration](#cicd-integration)
- [Pipeline Configuration](#pipeline-configuration)
- [GitHub Actions example](#github-actions-example)
- [CI Checklist](#ci-checklist)
- [Handling CI Failures](#handling-ci-failures)
- [Enterprise Compliance Workflow](#enterprise-compliance-workflow)
- [License Approval Process](#license-approval-process)
- [Policy Document Template](#policy-document-template)
- [License Policy](#license-policy)
- [Auto-Approved Licenses](#auto-approved-licenses)
- [Conditionally Approved](#conditionally-approved)
- [Prohibited (Require Exception)](#prohibited-require-exception)
- [Exceptions](#exceptions)
- [Review Cadence](#review-cadence)
- [Dual Licensing Considerations](#dual-licensing-considerations)
- [Common Dual-License Models](#common-dual-license-models)
- [Decision Framework](#decision-framework)
- [SBOM Generation](#sbom-generation)
- [Software Bill of Materials (SBOM) Checklist](#software-bill-of-materials-sbom-checklist)
- [Generation Commands](#generation-commands)
- [Trivy SPDX SBOM](#trivy-spdx-sbom)
- [CycloneDX (Node.js)](#cyclonedx-nodejs)
- [CycloneDX (Python)](#cyclonedx-python)
- [Syft (multi-language)](#syft-multi-language)
...
- `legal-emi-region-us/references/ip-protection-guide.md` — intellectual property considerations
- `legal-emi-region-*/SKILL.md` — region-specific legal compliance guidance
