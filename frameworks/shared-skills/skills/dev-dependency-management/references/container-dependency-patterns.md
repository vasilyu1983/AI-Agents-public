...
**Freshness anchor:** June 2026 — verify current container scanner, base image, and BuildKit behavior before recommending version-specific flags.

---
## Table of Contents

- [Base Image Selection Decision Tree](#base-image-selection-decision-tree)
- [Base Image Comparison](#base-image-comparison)
- [Alpine Gotchas Checklist](#alpine-gotchas-checklist)
- [Multi-Stage Build Patterns](#multi-stage-build-patterns)
- [Standard Multi-Stage Pattern](#standard-multi-stage-pattern)
...
- [Build vs Runtime Dependencies](#build-vs-runtime-dependencies)
- [Multi-Stage Checklist](#multi-stage-checklist)
- [Layer Caching Optimization](#layer-caching-optimization)
- [Layer Ordering Rules](#layer-ordering-rules)
- [Caching Optimization Checklist](#caching-optimization-checklist)
- [BuildKit Cache Mounts](#buildkit-cache-mounts)
- [Node.js - cache npm](#nodejs-cache-npm)
- [Python - cache pip](#python-cache-pip)
- [Go - cache module downloads and build cache](#go-cache-module-downloads-and-build-cache)
- [Rust - cache cargo registry and build artifacts](#rust-cache-cargo-registry-and-build-artifacts)
- [.dockerignore Template](#dockerignore-template)
- [Vulnerability Scanning](#vulnerability-scanning)
- [Tool Comparison](#tool-comparison)
- [Trivy Integration](#trivy-integration)
- [Scan a built image](#scan-a-built-image)
- [Scan with exit code for CI gating](#scan-with-exit-code-for-ci-gating)
- [Scan filesystem (lock files)](#scan-filesystem-lock-files)
- [Scan and output SARIF for GitHub Security](#scan-and-output-sarif-for-github-security)
- [Ignore unfixed vulnerabilities](#ignore-unfixed-vulnerabilities)
- [Grype Integration](#grype-integration)
- [Scan an image](#scan-an-image)
- [Fail on high/critical](#fail-on-highcritical)
- [Output JSON for processing](#output-json-for-processing)
- [Scanning Pipeline Checklist](#scanning-pipeline-checklist)
- [Vulnerability SLA Reference](#vulnerability-sla-reference)
- [Reproducible Builds](#reproducible-builds)
- [Pinning Strategies](#pinning-strategies)
- [Reproducibility Checklist](#reproducibility-checklist)
- [Base Image Update Strategy](#base-image-update-strategy)
