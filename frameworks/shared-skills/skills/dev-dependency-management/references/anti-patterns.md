...
- [Overview](#overview)
- [Critical Anti-Patterns (NEVER Do These)](#critical-anti-patterns-never-do-these)
- [1. Not Committing Lockfiles](#1-not-committing-lockfiles)
- [.gitignore](#gitignore)
- [Commit lockfiles](#commit-lockfiles)
- [2. Using Wildcards (`*`) for Version Ranges](#2-using-wildcards-for-version-ranges)
- [3. Manual Lockfile Editing](#3-manual-lockfile-editing)
- [Manually editing package-lock.json](#manually-editing-package-lockjson)
- [Change version numbers by hand](#change-version-numbers-by-hand)
- [Use package manager commands](#use-package-manager-commands)
- [Let the package manager manage the lockfile](#let-the-package-manager-manage-the-lockfile)
- [4. Ignoring Security Audits](#4-ignoring-security-audits)
- [Developer: "I'll fix it later"](#developer-ill-fix-it-later)
- [(Never fixes it)](#never-fixes-it)
- [Run audit regularly](#run-audit-regularly)
- [Fix automatically (safe)](#fix-automatically-safe)
- [Review and fix manually (risky fixes)](#review-and-fix-manually-risky-fixes)
- [Set up automated alerts](#set-up-automated-alerts)
- [Use Dependabot, Snyk, or GitHub Advanced Security](#use-dependabot-snyk-or-github-advanced-security)
- [5. Adding Dependencies Without Review](#5-adding-dependencies-without-review)
- [Developer sees a cool package on Twitter](#developer-sees-a-cool-package-on-twitter)
- [No review, no research, no questions](#no-review-no-research-no-questions)
- [Before adding ANY dependency:](#before-adding-any-dependency)
- [Document decision](#document-decision)
- [Add to ADR (Architecture Decision Record)](#add-to-adr-architecture-decision-record)
- [Dangerous Anti-Patterns (Avoid These)](#dangerous-anti-patterns-avoid-these)
- [6. Never Updating Dependencies](#6-never-updating-dependencies)
- [Stale package.json example](#stale-packagejson-example)
- [Update regularly (monthly or quarterly)](#update-regularly-monthly-or-quarterly)
- [Or use automated tools](#or-use-automated-tools)
- [Dependabot, Renovate](#dependabot-renovate)
- [7. Using Deprecated Packages](#7-using-deprecated-packages)
- [Look for "DEPRECATED" warning](#look-for-deprecated-warning)
- [8. Mixing Package Managers](#8-mixing-package-managers)
- [Project has both](#project-has-both)
- [Team uses different package managers](#team-uses-different-package-managers)
- [Lockfiles conflict](#lockfiles-conflict)
- [Choose ONE package manager](#choose-one-package-manager)
- [Document in README.md](#document-in-readmemd)
- [Add to package.json](#add-to-packagejson)
- [9. Using `--force` or `--legacy-peer-deps` Without Understanding](#9-using-force-or-legacy-peer-deps-without-understanding)
- [Error during npm install](#error-during-npm-install)
- [Developer: "I'll just force it"](#developer-ill-just-force-it)
- [or](#or)
- [Understand WHY the error occurred](#understand-why-the-error-occurred)
- [Fix the root cause](#fix-the-root-cause)
- [Option 1: Update the dependency](#option-1-update-the-dependency)
- [Option 2: Install missing peer dependency](#option-2-install-missing-peer-dependency)
- [Option 3: Use overrides (if necessary)](#option-3-use-overrides-if-necessary)
- [Document why (if using --legacy-peer-deps)](#document-why-if-using-legacy-peer-deps)
- [10. Not Using Virtual Environments (Python)](#10-not-using-virtual-environments-python)
- [Installing globally (Python)](#installing-globally-python)
- [System Python polluted](#system-python-polluted)
- [Conflicts between projects](#conflicts-between-projects)
- [Use virtual environments](#use-virtual-environments)
- [Or use poetry](#or-use-poetry)
- [Moderate Anti-Patterns (Be Careful)](#moderate-anti-patterns-be-careful)
- [11. Overusing Overrides](#11-overusing-overrides)
- [12. Ignoring Peer Dependency Warnings](#12-ignoring-peer-dependency-warnings)
- [Developer: "It's just a warning, ignore it"](#developer-its-just-a-warning-ignore-it)
- [Install the correct peer dependency](#install-the-correct-peer-dependency)
- [Or check if library supports your version](#or-check-if-library-supports-your-version)
- [13. Committing `node_modules/`](#13-committing-nodemodules)
- [.gitignore missing node_modules/](#gitignore-missing-nodemodules)
- [.gitignore](#gitignore)
- [Commit lockfiles instead](#commit-lockfiles-instead)
- [14. Using Development Dependencies in Production](#14-using-development-dependencies-in-production)
- [or](#or)
- [Checklist: Avoiding Anti-Patterns](#checklist-avoiding-anti-patterns)
- [Summary](#summary)
...
Production: Installs axios@1.4.0 (known vulnerability in the deployed range)
...
1. Check recent releases and changelog quality
2. Check maintainer and ownership health
3. Check issue response and support quality
...
// - axios override: temporary security mitigation, remove after upstream upgrade
```
