...
- One repository test platform is chosen and reflected consistently in local and CI commands.
...
- CI-native outputs, provenance, and SBOM are enabled where the platform supports them.
