...
- [Mobile Testing Pyramid](#mobile-testing-pyramid)
- [iOS Testing](#ios-testing)
- [XCTest (Unit + Integration)](#xctest-unit-integration)
- [Swift Testing (Swift 6.1+)](#swift-testing-swift-61)
- [XCUITest (UI Testing)](#xcuitest-ui-testing)
- [Android Testing](#android-testing)
- [JUnit + ViewModel Testing](#junit-viewmodel-testing)
- [Espresso (UI Testing)](#espresso-ui-testing)
- [Compose Test](#compose-test)
- [UIAutomator (Cross-App Testing)](#uiautomator-cross-app-testing)
- [React Native Testing](#react-native-testing)
- [Jest (Unit Testing)](#jest-unit-testing)
- [Detox (E2E Testing)](#detox-e2e-testing)
- [Maestro (YAML-Based E2E)](#maestro-yaml-based-e2e)
- [flows/login.yaml](#flowsloginyaml)
- [Snapshot and Screenshot Testing](#snapshot-and-screenshot-testing)
- [iOS Snapshot Testing](#ios-snapshot-testing)
- [Android Compose Screenshot Testing](#android-compose-screenshot-testing)
- [Device Farm Testing](#device-farm-testing)
- [Platform Comparison](#platform-comparison)
- [Firebase Test Lab Configuration](#firebase-test-lab-configuration)
- [.github/workflows/android-test.yml](#githubworkflowsandroid-testyml)
- [Device Matrix Strategy](#device-matrix-strategy)
- [CI/CD Integration](#cicd-integration)
- [iOS CI Pipeline](#ios-ci-pipeline)
- [.github/workflows/ios.yml](#githubworkflowsiosyml)
- [Android CI Pipeline](#android-ci-pipeline)
- [.github/workflows/android.yml](#githubworkflowsandroidyml)
- [React Native CI Pipeline](#react-native-ci-pipeline)
- [.github/workflows/rn.yml](#githubworkflowsrnyml)
- [Flaky Test Management](#flaky-test-management)
- [Common Causes of Flaky Mobile Tests](#common-causes-of-flaky-mobile-tests)
- [Flaky Test Strategy](#flaky-test-strategy)
- [Performance Testing](#performance-testing)
- [Key Metrics](#key-metrics)
- [Android Macrobenchmark](#android-macrobenchmark)
