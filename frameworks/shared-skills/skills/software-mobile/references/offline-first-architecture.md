...
- [Offline-First vs Offline-Capable](#offline-first-vs-offline-capable)
- [Architecture Decision](#architecture-decision)
- [Local Database Strategies](#local-database-strategies)
- [Platform Comparison](#platform-comparison)
- [iOS: Core Data / SwiftData](#ios-core-data-swiftdata)
- [Android: Room](#android-room)
- [React Native: WatermelonDB](#react-native-watermelondb)
- [Sync Strategies](#sync-strategies)
- [Strategy Comparison](#strategy-comparison)
- [Delta Sync Pattern](#delta-sync-pattern)
- [Conflict Resolution](#conflict-resolution)
- [Strategies](#strategies)
- [Field-Level Merge Implementation](#field-level-merge-implementation)
- [Manual Resolution UI Pattern](#manual-resolution-ui-pattern)
- [Queue-Based Operation Patterns](#queue-based-operation-patterns)
- [Command Queue (Outbox Pattern)](#command-queue-outbox-pattern)
- [Network State Detection](#network-state-detection)
...
- [Data Migration for Local Databases](#data-migration-for-local-databases)
- [Room Migration](#room-migration)
- [Core Data Lightweight Migration](#core-data-lightweight-migration)
- [Testing Offline Scenarios](#testing-offline-scenarios)
- [Network Condition Simulation](#network-condition-simulation)
- [Unit Testing Sync Logic](#unit-testing-sync-logic)
