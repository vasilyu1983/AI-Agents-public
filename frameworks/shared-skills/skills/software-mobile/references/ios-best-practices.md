...
- [@Bindable for NavigationStack](#@bindable-for-navigationstack)
- [Concurrency](#concurrency)
- [Swift Concurrency (Swift 5.5+)](#swift-concurrency-swift-55)
- [Swift 6 Migration / Strict Concurrency Checks](#swift-6-migration-strict-concurrency-checks)
- [Networking](#networking)
- [Defensive API Decoding](#defensive-api-decoding)
- [Missing Required Fields](#missing-required-fields)
- [Array vs Dictionary Format](#array-vs-dictionary-format)
- [Multiple Key Formats (snake_case vs camelCase)](#multiple-key-formats-snakecase-vs-camelcase)
- [Security](#security)
...
- [Version Support (Guidance)](#version-support-guidance)
- [References](#references)
- [Shared Utilities (Backend Integration Patterns)](#shared-utilities-backend-integration-patterns)
...
- `@Observable + @State` for view-owned ViewModels (iOS 17+)
...
For iOS design accessibility (VoiceOver, Dynamic Type, dark mode, color contrast), see [software-ios-design](../../software-ios-design/SKILL.md).

For implementation patterns, apply:
- Accessibility labels on all interactive elements
- Dynamic Type support (`.font(.body)` instead of fixed sizes)
...
- [auth-utilities.md](../../software-clean-code-standard/references/auth-utilities.md) — OAuth 2.1/PKCE patterns for mobile clients, JWT handling
- [error-handling.md](../../software-clean-code-standard/references/error-handling.md) — Result types, error patterns (Swift has native Result, but align with backend)
- [resilience-utilities.md](../../software-clean-code-standard/references/resilience-utilities.md) — Retry patterns, circuit breaker concepts for network calls
- [testing-utilities.md](../../software-clean-code-standard/references/testing-utilities.md) — Test factories, fixtures, mock patterns
