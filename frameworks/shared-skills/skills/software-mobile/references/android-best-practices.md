...
- [Security](#security)
- [Play Integrity API (Preferred — SafetyNet Deprecated)](#play-integrity-api-preferred-—-safetynet-deprecated)
- [Performance](#performance)
- [Jetpack Compose Performance (Version-Agnostic)](#jetpack-compose-performance-version-agnostic)
- [Legacy Compose Optimization](#legacy-compose-optimization)
- [Testing](#testing)
- [Accessibility](#accessibility)
- [Play Store Guidelines](#play-store-guidelines)
