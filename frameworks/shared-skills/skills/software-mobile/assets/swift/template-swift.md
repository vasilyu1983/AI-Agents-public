...
1. **Architecture**
   ...
   - Prefer @Observable + @Environment (iOS 17+) over ObservableObject/@EnvironmentObject when your deployment target allows it
...
3. **State Management**
   ...
   - Use @Observable + @State for view-owned ViewModels (iOS 17+)
