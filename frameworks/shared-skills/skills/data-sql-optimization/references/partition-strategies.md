...
> Purpose: Operational guide for implementing table partitioning — PostgreSQL declarative partitioning, MySQL partitioning, partition key selection, maintenance operations, query optimization with partition pruning, and migration patterns.
---
## Table of Contents

- [Decision Tree: Should You Partition?](#decision-tree-should-you-partition)
- [Quick Reference: Partition Types](#quick-reference-partition-types)
- [PostgreSQL Declarative Partitioning](#postgresql-declarative-partitioning)
- [Range Partitioning (By Date)](#range-partitioning-by-date)
- [List Partitioning (By Category)](#list-partitioning-by-category)
- [Hash Partitioning (Even Distribution)](#hash-partitioning-even-distribution)
- [Sub-Partitioning](#sub-partitioning)
- [MySQL Partitioning](#mysql-partitioning)
- [Range Partitioning](#range-partitioning)
- [MySQL-Specific Constraints](#mysql-specific-constraints)
- [Partition Key Selection](#partition-key-selection)
- [Decision Criteria](#decision-criteria)
- [Common Partition Keys](#common-partition-keys)
- [Partition Count Guidelines](#partition-count-guidelines)
- [Maintenance Operations](#maintenance-operations)
- [Creating Future Partitions](#creating-future-partitions)
- [Detaching and Dropping Old Partitions](#detaching-and-dropping-old-partitions)
- [Retention Policy Automation](#retention-policy-automation)
- [Attaching Existing Tables as Partitions](#attaching-existing-tables-as-partitions)
- [Query Optimization with Partition Pruning](#query-optimization-with-partition-pruning)
- [How Pruning Works](#how-pruning-works)
- [Verifying Partition Pruning](#verifying-partition-pruning)
- [Pruning Checklist](#pruning-checklist)
- [Queries That Defeat Pruning](#queries-that-defeat-pruning)
- [Migration: Unpartitioned to Partitioned](#migration-unpartitioned-to-partitioned)
- [Strategy 1: Create New + Backfill (Recommended)](#strategy-1-create-new-backfill-recommended)
- [Strategy 2: pg_partman Extension](#strategy-2-pgpartman-extension)
...
│
├─ Existing indexes already solve the problem and retention is simple
│   └─ Partitioning is probably unnecessary complexity
│
├─ Queries or retention operations still hurt even with reasonable indexing
│   │
...
| InnoDB user-defined partitioning has foreign-key limitations | Limits schema design for some workloads | Verify current engine docs before adopting partitioning |
...
|-------------|---------|-----|
| Partitioning without a pruning or retention benefit | Complexity without gain | Prove why indexes alone are not enough |
