...
Indicative numbers from published GPT-4-era studies; re-calibrate on your own labeled set with current-generation judges.

| Judge Configuration | Precision | Recall | Cost | Speed |
|--------------------|-----------|--------|------|-------|
| Frontier judge, single pass | 0.85 | 0.78 | High | Slow |
| Frontier judge with chain-of-thought | 0.91 | 0.83 | High | Slow |
| Mid-tier judge (Sonnet-class) | 0.87 | 0.81 | Medium | Medium |
