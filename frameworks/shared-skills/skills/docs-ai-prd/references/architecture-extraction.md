...
- [Quick Extraction Process](#quick-extraction-process)
- [1. Get directory structure](#1-get-directory-structure)
- [2. Identify entry points](#2-identify-entry-points)
- [3. Find configuration](#3-find-configuration)
- [4. Check package.json/requirements.txt for dependencies](#4-check-packagejsonrequirementstxt-for-dependencies)
- [5. Find architectural patterns in imports](#5-find-architectural-patterns-in-imports)
...
- [Trace a Request](#trace-a-request)
- [Document the Flow](#document-the-flow)
- [Data Flow](#data-flow)
- [Abstraction Identification](#abstraction-identification)
- [Find Core Abstractions](#find-core-abstractions)
- [Find interfaces/abstract classes](#find-interfacesabstract-classes)
- [Find type definitions](#find-type-definitions)
- [Find base classes](#find-base-classes)
- [Document Key Abstractions](#document-key-abstractions)
- [Key Abstractions](#key-abstractions)
- [Dependency Analysis](#dependency-analysis)
- [Analyze Import Patterns](#analyze-import-patterns)
- [Most imported files (indicates core components)](#most-imported-files-indicates-core-components)
- [External dependency usage](#external-dependency-usage)
...
- [Clean/Hexagonal](#cleanhexagonal)
