...
- [What is Tribal Knowledge?](#what-is-tribal-knowledge)
- [Git History Mining](#git-history-mining)
- [Find Decision Commits](#find-decision-commits)
- [Commits explaining "why"](#commits-explaining-why)
- [Architectural changes](#architectural-changes)
- [Breaking changes](#breaking-changes)
- [Bug fix context](#bug-fix-context)
- [Performance decisions](#performance-decisions)
- [Analyze Commit Messages](#analyze-commit-messages)
- [Most active areas (indicates complexity/importance)](#most-active-areas-indicates-complexityimportance)
- [Find commits with detailed messages (likely important context)](#find-commits-with-detailed-messages-likely-important-context)
- [Blame Analysis](#blame-analysis)
- [Who knows this code best?](#who-knows-this-code-best)
- [When was this section last meaningfully changed?](#when-was-this-section-last-meaningfully-changed)
- [Comment Mining](#comment-mining)
- [Find Explanatory Comments](#find-explanatory-comments)
- [TODO/FIXME/HACK comments (often explain workarounds)](#todofixmehack-comments-often-explain-workarounds)
- ["Because" explanations](#because-explanations)
- [Historical context](#historical-context)
- [Decision comments](#decision-comments)
- [Categorize Findings](#categorize-findings)
- [Documentation Archaeology](#documentation-archaeology)
- [Search Existing Docs](#search-existing-docs)
- [Find all documentation](#find-all-documentation)
- [Search for architectural notes](#search-for-architectural-notes)
- [Find API documentation](#find-api-documentation)
...
- [Package.json scripts (often have hidden context)](#packagejson-scripts-often-have-hidden-context)
...
- [Identify Implicit Conventions](#identify-implicit-conventions)
- [Naming patterns](#naming-patterns)
- [File organization patterns](#file-organization-patterns)
- [Import patterns](#import-patterns)
- [Common Implicit Patterns](#common-implicit-patterns)
- [Documentation Template](#documentation-template)
- [Tribal Knowledge](#tribal-knowledge)
- [Why We Made These Decisions](#why-we-made-these-decisions)
- [Known Gotchas](#known-gotchas)
- [Historical Context](#historical-context)
- [Undocumented Processes](#undocumented-processes)
- [Recovery Checklist](#recovery-checklist)
- [Red Flags to Document](#red-flags-to-document)
