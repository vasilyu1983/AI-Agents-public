...
- [Timeline Targets](#timeline-targets)
- [3. User Personas](#3-user-personas)
- [User Personas](#user-personas)
- [Primary Persona: "Product Manager Paula"](#primary-persona-product-manager-paula)
- [Secondary Persona: "Executive Emma"](#secondary-persona-executive-emma)
- [4. Requirements](#4-requirements)
- [Functional Requirements](#functional-requirements)
- [Non-Functional Requirements](#non-functional-requirements)
- [5. Edge Cases](#5-edge-cases)
- [Edge Cases](#edge-cases)
- [6. Success Metrics (Detailed)](#6-success-metrics-detailed)
...
- [Product/Design Risks](#productdesign-risks)
...
- [AVOID: Anti-Pattern 1 – Solution Before Problem](#avoid-anti-pattern-1-–-solution-before-problem)
- [Problem](#problem)
- [Problem](#problem)
- [AVOID: Anti-Pattern 2 – Feature List Disguised as Goals](#avoid-anti-pattern-2-–-feature-list-disguised-as-goals)
- [Goals](#goals)
- [Goals](#goals)
- [AVOID: Anti-Pattern 3 – Vague Requirements](#avoid-anti-pattern-3-–-vague-requirements)
- [AVOID: Anti-Pattern 4 – No Edge Cases](#avoid-anti-pattern-4-–-no-edge-cases)
- [AVOID: Anti-Pattern 5 – No Mitigation Plans for Risks](#avoid-anti-pattern-5-–-no-mitigation-plans-for-risks)
- [Risks](#risks)
- [Risks](#risks)
- [Related Resources](#related-resources)
- [When to Use This Guide vs. Agentic Coding Workflows](#when-to-use-this-guide-vs-agentic-coding-workflows)
...
- User Interview Summary (Nov 2024)
- Competitive Analysis: Export Features in 5 Competitors
- Prototype Testing Results (Dec 2024)
```
