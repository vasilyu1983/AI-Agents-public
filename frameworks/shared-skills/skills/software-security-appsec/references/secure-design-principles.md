...
- [3. Fail Securely](#3-fail-securely)
- [4. Complete Mediation](#4-complete-mediation)
- [5. Separation of Duties](#5-separation-of-duties)
- [6. Open Design (No Security Through Obscurity)](#6-open-design-no-security-through-obscurity)
- [7. Secure by Default](#7-secure-by-default)
- [8. Keep It Simple](#8-keep-it-simple)
- [Secure Design Patterns](#secure-design-patterns)
- [Pattern 1: Threat Modeling (STRIDE)](#pattern-1-threat-modeling-stride)
- [Pattern 2: Zero Trust Architecture](#pattern-2-zero-trust-architecture)
- [Pattern 3: Secure Session Management](#pattern-3-secure-session-management)
- [Pattern 4: Security Boundaries](#pattern-4-security-boundaries)
