...
- [Key Changes from 2021 → 2025](#key-changes-from-2021-→-2025)
- [2025 Methodology Updates](#2025-methodology-updates)
...
- [Use dependency scanning tools](#use-dependency-scanning-tools)
- [Check Python dependencies](#check-python-dependencies)
- [Use Dependabot or Renovate for automated updates](#use-dependabot-or-renovate-for-automated-updates)
...
- [Prevention](#prevention)
- [A10:2025 — Mishandling of Exceptional Conditions (NEW in 2025)](#a102025--mishandling-of-exceptional-conditions-new-in-2025)
- [Common Issues](#common-issues)
- [Attack Scenarios](#attack-scenarios)
- [Prevention](#prevention)
- [SSRF Prevention (Now Part of A01)](#ssrf-prevention-now-part-of-a01)
- [References](#references)


## Current Baseline

**OWASP Top 10:2025 is now FINAL.** Announced November 2025 at the OWASP Global AppSec conference; final version published January 2026: https://owasp.org/Top10/2025/
...
- Analyzed **643 unique CWEs mapped to CVEs** (up from 241 in 2021, per owasp.org/Top10/2025/0x00_2025-Introduction/)
- Incorporated **~175,000 CVE records** (up from ~125,000 in 2021) in the National Vulnerability Database
...
**Risk**: Using libraries, frameworks, or modules with known vulnerabilities, plus compromised build, publish, and distribution paths. This category replaces and expands 2021's "Vulnerable and Outdated Components" — it now also covers dependency confusion, compromised maintainer or publish credentials, tampered CI/CD pipelines, and unsigned or unverifiable artifacts. See [supply-chain-security.md](supply-chain-security.md) for the full control stack (SBOM, provenance, trusted publishing, incident patterns including the Shai-Hulud npm worm).
