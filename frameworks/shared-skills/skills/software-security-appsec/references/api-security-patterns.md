# API Security Patterns — Comprehensive Guide

Practical API security patterns covering OWASP API Security Top 10 (2023 edition; verify current), authorization vulnerabilities, rate limiting, API key management, and protocol-specific security for REST, GraphQL, and gRPC.
...
- [Prevention Architecture](#prevention-architecture)
- [BFLA Testing Strategy](#bfla-testing-strategy)
- [Mass Assignment Protection](#mass-assignment-protection)
- [Vulnerable Pattern](#vulnerable-pattern)
- [Secure Pattern — Allowlist](#secure-pattern-—-allowlist)
- [DTOs and Schema Validation](#dtos-and-schema-validation)
- [Rate Limiting Strategies](#rate-limiting-strategies)
- [Strategy Comparison](#strategy-comparison)
- [Implementation — Express.js](#implementation-—-expressjs)
- [Rate Limit Headers (RFC 6585 / Draft RFC 9110)](#rate-limit-headers-rfc-6585-draft-rfc-9110)
- [API Key Management](#api-key-management)
- [Lifecycle](#lifecycle)
- [Key Generation Example](#key-generation-example)
- [Key Validation Middleware](#key-validation-middleware)
- [GraphQL-Specific Security](#graphql-specific-security)
- [Query Depth and Complexity Limiting](#query-depth-and-complexity-limiting)
...
- [Interceptors for Auth](#interceptors-for-auth)
- [Deadline Propagation](#deadline-propagation)
- [API Versioning Security Implications](#api-versioning-security-implications)
- [Version Deprecation Security](#version-deprecation-security)
- [Sunset Header Implementation](#sunset-header-implementation)
- [OpenAPI/Swagger Security Definitions](#openapiswagger-security-definitions)
- [openapi.yaml](#openapiyaml)
- [Anti-Patterns](#anti-patterns)
- [Decision Framework: Choosing API Auth](#decision-framework-choosing-api-auth)
