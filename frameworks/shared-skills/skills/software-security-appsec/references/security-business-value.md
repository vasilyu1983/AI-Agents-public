...
- [Breach Cost Modeling (2024-2025 Data)](#breach-cost-modeling-2024-2025-data)
...
- [Business Case: [Security Tool]](#business-case-security-tool)
...
- [Business Case: [Compliance Certification]](#business-case-compliance-certification)
...
- [Incident Business Impact: [Incident Name]](#incident-business-impact-incident-name)
- [Direct Costs](#direct-costs)
- [Indirect Costs](#indirect-costs)
- [Prevention Investment](#prevention-investment)
- [Recommendation](#recommendation)
...
- [If Budget is $100K-250K (Startup)](#if-budget-is-$100k-250k-startup)
- [If Budget is $250K-500K (Growth)](#if-budget-is-$250k-500k-growth)
- [If Budget is $500K-1M (Scale)](#if-budget-is-$500k-1m-scale)
- [Sources](#sources)
...
> Verify current figures at [ibm.com/reports/data-breach](https://www.ibm.com/reports/data-breach). Values below are from a prior edition and may have changed.
