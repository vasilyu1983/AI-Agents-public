...
- [Pattern: Authentication](#pattern-authentication)
- [JWT-Based Authentication](#jwt-based-authentication)
- [OAuth 2.0 / 2.1 Flow](#oauth-20-flow)
- [Pattern: Authorization](#pattern-authorization)
- [Role-Based Access Control (RBAC)](#role-based-access-control-rbac)
- [Attribute-Based Access Control (ABAC)](#attribute-based-access-control-abac)
- [Pattern: Input Validation & Sanitization](#pattern-input-validation-&-sanitization)
- [Allowlist Validation](#allowlist-validation)
- [SQL Injection Prevention](#sql-injection-prevention)
- [XSS Prevention](#xss-prevention)
- [CSRF Prevention](#csrf-prevention)
- [Pattern: Cryptography](#pattern-cryptography)
- [Password Hashing](#password-hashing)
- [Data Encryption](#data-encryption)
- [Pattern: Secure API Design](#pattern-secure-api-design)
...
- [Resources (Detailed Guides)](#resources-detailed-guides)
- [Templates (Production-Ready)](#templates-production-ready)
- [Web Application Templates](#web-application-templates)
- [API Templates](#api-templates)
- [Cloud-Native Templates](#cloud-native-templates)
- [External Resources](#external-resources)


## OWASP Top 10:2025

1. **A01 Broken Access Control** - Unauthorized access to resources (now includes SSRF)
2. **A02 Security Misconfiguration** - Insecure defaults, incomplete configs
3. **A03 Software Supply Chain Failures** - Compromised dependencies, build/publish paths, or CVEs in outdated components
4. **A04 Cryptographic Failures** - Weak encryption or exposed sensitive data
5. **A05 Injection** - SQL, NoSQL, OS command, LDAP injection
6. **A06 Insecure Design** - Missing threat modeling and secure patterns
7. **A07 Authentication Failures** - Weak credential management
8. **A08 Software or Data Integrity Failures** - Unverified code/data modifications
9. **A09 Security Logging and Alerting Failures** - Insufficient monitoring and incident response
10. **A10 Mishandling of Exceptional Conditions** - Unsafe error/exception handling (new in 2025)

Numbering is per the OWASP Top 10:2025 final release (published January 2026); it replaces the 2021 list's ordering, including folding SSRF into A01. See [references/owasp-top-10.md](owasp-top-10.md) for detailed prevention strategies.
...
### OAuth 2.0 / 2.1 (prefer 2.1 for new builds) Flow
