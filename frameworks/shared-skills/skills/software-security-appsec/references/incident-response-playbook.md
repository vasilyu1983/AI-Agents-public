...
- [IR Team Composition and Roles](#ir-team-composition-and-roles)
- [Escalation Contact Sheet](#escalation-contact-sheet)
- [Detection and Triage](#detection-and-triage)
- [Severity Classification](#severity-classification)
- [Triage Decision Tree](#triage-decision-tree)
- [Detection Sources](#detection-sources)
- [Containment Procedures by Incident Type](#containment-procedures-by-incident-type)
...
- [Immediately preserve logs before rotation or deletion](#immediately-preserve-logs-before-rotation-or-deletion)
- [Application logs](#application-logs)
- [Access logs](#access-logs)
- [Database audit logs](#database-audit-logs)
- [Cloud provider audit trail](#cloud-provider-audit-trail)
- [Forensic Imaging](#forensic-imaging)
- [Chain of Custody](#chain-of-custody)
- [Communication Templates](#communication-templates)
- [Internal Stakeholder Notification (P0/P1)](#internal-stakeholder-notification-p0p1)
- [Customer Notification (Data Breach)](#customer-notification-data-breach)
- [Regulatory Notification Checklist](#regulatory-notification-checklist)
- [Remediation Checklists](#remediation-checklists)
- [Secret Rotation](#secret-rotation)
- [Access Revocation](#access-revocation)
- [Patch Deployment](#patch-deployment)
- [Recovery Procedures](#recovery-procedures)
- [Service Restoration](#service-restoration)
- [Monitoring Enhancement](#monitoring-enhancement)
- [Post-Incident Review (Blameless Postmortem)](#post-incident-review-blameless-postmortem)
- [Template](#template)
- [Postmortem Principles](#postmortem-principles)
- [Legal and Regulatory Notification Requirements](#legal-and-regulatory-notification-requirements)
- [GDPR 72-Hour Rule](#gdpr-72-hour-rule)
- [US State Breach Notification](#us-state-breach-notification)
- [IR Automation — SOAR Playbooks](#ir-automation-—-soar-playbooks)
- [Automatable Actions](#automatable-actions)
- [Example: Automated Secret Leak Response](#example-automated-secret-leak-response)
- [GitHub Actions workflow for leaked secret response](#github-actions-workflow-for-leaked-secret-response)
