...
└────────┬─────────┘
         ├── Instrumentation 1 → Test A [OK]
         ├── Instrumentation 2 → Test B [OK]
         ├── Instrumentation 3 → Test C CRASH (isolated)
         ├── Instrumentation 4 → Test D [OK]
         └── Instrumentation 5 → Test E [OK]
```
...
// Verify current versions at https://developer.android.com/jetpack/androidx/releases/test
dependencies {
    androidTestImplementation("androidx.test:runner:1.7.0")
    androidTestImplementation("androidx.test:rules:1.6.1")
