...
**Freshness anchor:** aligned with SonarQube static analysis metrics, CodeClimate, and industry technical debt management practices.

---
## Table of Contents

- [Technical Debt Quadrant](#technical-debt-quadrant)
- [Quadrant Decision Guide](#quadrant-decision-guide)
- [Debt Identification Patterns](#debt-identification-patterns)
- [Code-Level Indicators](#code-level-indicators)
- [Architecture-Level Indicators](#architecture-level-indicators)
- [Process-Level Indicators](#process-level-indicators)
- [Automated Detection Checklist](#automated-detection-checklist)
- [Tracking Systems](#tracking-systems)
- [Tagging Approach](#tagging-approach)
- [Tech Debt Ticket Template](#tech-debt-ticket-template)
- [Tech Debt: [Title]](#tech-debt-title)
- [Current State](#current-state)
- [Impact](#impact)
- [Proposed Solution](#proposed-solution)
- [Acceptance Criteria](#acceptance-criteria)
- [Context](#context)
- [ADR (Architecture Decision Record) for Debt](#adr-architecture-decision-record-for-debt)
- [ADR-NNN: [Decision that creates known debt]](#adr-nnn-decision-that-creates-known-debt)
- [Context](#context)
- [Decision](#decision)
- [Debt Created](#debt-created)
- [Payback Plan](#payback-plan)
- [Consequences](#consequences)
- [Sprint Allocation Strategies](#sprint-allocation-strategies)
- [Strategy Comparison](#strategy-comparison)
- [Decision Tree: Choosing a Strategy](#decision-tree-choosing-a-strategy)
- [Making the 20% Rule Work](#making-the-20%-rule-work)
- [Prioritization Framework](#prioritization-framework)
- [Impact-Effort Matrix for Tech Debt](#impact-effort-matrix-for-tech-debt)
- [Prioritization Scoring](#prioritization-scoring)
- [Urgency Signals (Promote to P1)](#urgency-signals-promote-to-p1)
- [Stakeholder Communication](#stakeholder-communication)
- [Framing Tech Debt for Non-Technical Stakeholders](#framing-tech-debt-for-non-technical-stakeholders)
- [Debt Health Dashboard](#debt-health-dashboard)
- [Reporting Cadence](#reporting-cadence)
- [Prevention Patterns](#prevention-patterns)
- [Preventing New Debt Accumulation](#preventing-new-debt-accumulation)
- [Code Review Debt Gates](#code-review-debt-gates)
