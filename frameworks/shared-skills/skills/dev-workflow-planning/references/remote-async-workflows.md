...
**Freshness anchor:** aligned with tooling: Linear, Notion, Loom, Slack workflows, GitHub Discussions, and async-first practices from GitLab, Doist, and Basecamp.

---
## Table of Contents

- [Async vs Sync Decision Tree](#async-vs-sync-decision-tree)
- [Meeting Necessity Checklist](#meeting-necessity-checklist)
- [Documentation-Driven Development](#documentation-driven-development)
- [Core Principle](#core-principle)
- [Document-First Workflow](#document-first-workflow)
- [RFC (Request for Comments) Template](#rfc-request-for-comments-template)
- [RFC: [Title]](#rfc-title)
...
- [ADR (Architecture Decision Record) Template](#adr-architecture-decision-record-template)
- [ADR-NNN: [Short title of decision]](#adr-nnn-short-title-of-decision)
- [Context](#context)
- [Decision](#decision)
- [Consequences](#consequences)
- [ADR Management Rules](#adr-management-rules)
- [Async Standup Patterns](#async-standup-patterns)
- [Written Standup (Slack/Linear)](#written-standup-slacklinear)
- [Standup — [Name] — [YYYY-MM-DD]](#standup-—-name-—-yyyy-mm-dd)
- [Loom Video Standup](#loom-video-standup)
- [Standup Bot Configuration](#standup-bot-configuration)
- [Async Standup Rules](#async-standup-rules)
- [Timezone-Distributed Coordination](#timezone-distributed-coordination)
- [Overlap Windows Strategy](#overlap-windows-strategy)
- [Coordination Patterns by Timezone Gap](#coordination-patterns-by-timezone-gap)
- [Handoff Document Template](#handoff-document-template)
- [End-of-Day Handoff — [Name] — [YYYY-MM-DD]](#end-of-day-handoff-—-name-—-yyyy-mm-dd)
- [Distributed Team Checklist](#distributed-team-checklist)
- [Tool Configuration](#tool-configuration)
- [Communication Layer Map](#communication-layer-map)
- [Slack Configuration for Async](#slack-configuration-for-async)
- [Linear/Jira Async Workflow](#linearjira-async-workflow)
- [Async Retrospectives](#async-retrospectives)
- [Async Retro Process](#async-retro-process)
- [When to Use Sync vs Async Retro](#when-to-use-sync-vs-async-retro)
- [Meeting Minimization Strategies](#meeting-minimization-strategies)
- [Meeting Audit Process](#meeting-audit-process)
- [Meeting Replacement Patterns](#meeting-replacement-patterns)
- [Meeting Rules for Async-First Teams](#meeting-rules-for-async-first-teams)
...
```markdown
## End-of-Day Handoff — [Name] — [YYYY-MM-DD]
...
- `startup-operating-system/references/remote-team-management.md` — broader remote team management
- `startup-operating-system/references/culture-and-values-design.md` — async culture design
- `startup-operating-system/references/founder-delegation-patterns.md` — delegation in async environments
