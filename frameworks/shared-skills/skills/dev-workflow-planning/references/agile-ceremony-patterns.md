...
**Freshness anchor:** aligned with Scrum Guide 2020, SAFe 6.0, and remote-first tooling (Linear, Jira, Miro, Notion).

---
## Table of Contents

- [Ceremony Quick Reference](#ceremony-quick-reference)
- [Sprint Planning](#sprint-planning)
- [Decision Tree: Planning Approach](#decision-tree-planning-approach)
- [Sprint Planning Agenda](#sprint-planning-agenda)
- [Capacity Calculation](#capacity-calculation)
- [Sprint Planning Checklist](#sprint-planning-checklist)
- [Daily Standup](#daily-standup)
- [Format Options](#format-options)
- [Walk-the-Board Protocol](#walk-the-board-protocol)
- [Async Standup Template](#async-standup-template)
- [Daily Update — [Name] — [Date]](#daily-update-—-name-—-date)
- [Standup Facilitation Rules](#standup-facilitation-rules)
- [Retrospective](#retrospective)
- [Format Selection Guide](#format-selection-guide)
- [Retrospective Facilitation Agenda](#retrospective-facilitation-agenda)
...
- [Refinement Session Structure](#refinement-session-structure)
- [Definition of Ready Checklist](#definition-of-ready-checklist)
- [Estimation Methods](#estimation-methods)
- [Estimation Anti-Patterns](#estimation-anti-patterns)
- [PI Planning (SAFe)](#pi-planning-safe)
- [PI Planning Agenda (2 Days)](#pi-planning-agenda-2-days)
- [PI Planning Outputs](#pi-planning-outputs)
...
- `startup-operating-system/references/remote-team-management.md` — managing distributed agile teams
