...
- [Feature Implementation Plan](#feature-implementation-plan)
...
- [Bug Fix Plan](#bug-fix-plan)
- [Bug Fix Plan: [Issue Title]](#bug-fix-plan-issue-title)
...
- [Refactoring Plan: [Component/Module]](#refactoring-plan-componentmodule)
- [Current State](#current-state)
- [Target State](#target-state)
- [Constraints](#constraints)
- [Steps (in order of execution)](#steps-in-order-of-execution)
- [Rollback Plan](#rollback-plan)
- [Spike/Research Plan](#spikeresearch-plan)
- [Spike: [Research Topic]](#spike-research-topic)
...
- [Migration Plan: [From X to Y]](#migration-plan-from-x-to-y)
- [Scope](#scope)
...
- [Daily/Sprint Planning](#dailysprint-planning)
- [[Date] Planning](#date-planning)
- [Today's Goal](#todays-goal)
- [Priority Tasks](#priority-tasks)
- [Blockers](#blockers)
- [Carry-over from Yesterday](#carry-over-from-yesterday)
- [End of Day Checkpoint](#end-of-day-checkpoint)
- [Parallel Implementation Plan](#parallel-implementation-plan)
- [Implementation Plan: [Feature Name]](#implementation-plan-feature-name)
- [Goal](#goal)
- [Success Criteria](#success-criteria)
...
- [WIP Limits Reference](#wip-limits-reference)
- [Recommended Limits](#recommended-limits)
- [Setting WIP Limits](#setting-wip-limits)
- [When to Violate (thoughtfully)](#when-to-violate-thoughtfully)
...
Use this template when the plan will be executed by multiple parallel agents.
...
### Execution Strategy
- [ ] **Sequential** (default when files or interfaces overlap)
- [ ] **Wave Parallel** (launch only unblocked tasks with clear file ownership)
- [ ] **Prototype Burst** (explicitly allow speculative parallel work and reconcile centrally)
...
### Conflict Resolution
[If using any parallel mode: who owns shared interfaces, which output takes priority if assumptions drift, and what triggers rescoping back to sequential work?]
