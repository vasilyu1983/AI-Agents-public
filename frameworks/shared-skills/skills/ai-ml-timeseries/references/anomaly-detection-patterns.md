...
- [Decision Tree: Choosing a Detection Method](#decision-tree-choosing-a-detection-method)
- [Quick Reference: Methods Comparison](#quick-reference-methods-comparison)
- [Operational Patterns](#operational-patterns)
- [Pattern 1: Statistical Baseline (Start Here)](#pattern-1-statistical-baseline-start-here)
- [Pattern 2: STL Decomposition + Residual Detection](#pattern-2-stl-decomposition-residual-detection)
- [For multiple seasonality: use MSTL](#for-multiple-seasonality-use-mstl)
- [Pattern 3: Isolation Forest for Multivariate](#pattern-3-isolation-forest-for-multivariate)
- [Pattern 4: Matrix Profile for Subsequence Anomalies](#pattern-4-matrix-profile-for-subsequence-anomalies)
- [Compute matrix profile](#compute-matrix-profile)
- [Discord (most unusual subsequence)](#discord-most-unusual-subsequence)
- [Top-k anomalous subsequences](#top-k-anomalous-subsequences)
- [Threshold: discords with distance > mean + 3*std of all distances](#threshold-discords-with-distance-mean-3std-of-all-distances)
- [Pattern 5: Autoencoder for Complex Patterns](#pattern-5-autoencoder-for-complex-patterns)
- [Train on normal data only](#train-on-normal-data-only)
- [Anomaly = high reconstruction error](#anomaly-=-high-reconstruction-error)
- [Production Alerting Configuration](#production-alerting-configuration)
- [Alert Fatigue Management](#alert-fatigue-management)
