...
- [Why Psychological Safety Matters](#why-psychological-safety-matters)
- [Core Principles](#core-principles)
- [1. Focus on Code, Not People](#1-focus-on-code-not-people)
- [2. Ask Questions, Don't Command](#2-ask-questions-dont-command)
- [3. Explain the "Why"](#3-explain-the-why)
- [4. Balance Criticism with Praise](#4-balance-criticism-with-praise)
- [5. Share Learning Moments](#5-share-learning-moments)
- [Comment Structure Templates](#comment-structure-templates)
- [For Bugs and Critical Issues](#for-bugs-and-critical-issues)
- [For Design Improvements](#for-design-improvements)
- [For Questions and Clarifications](#for-questions-and-clarifications)
- [For Positive Feedback](#for-positive-feedback)
- [Communication Patterns](#communication-patterns)
- [Pattern: Collaborative Discovery](#pattern-collaborative-discovery)
- [Pattern: Offering Alternatives](#pattern-offering-alternatives)
- [Pattern: Acknowledging Constraints](#pattern-acknowledging-constraints)
...
- [When You Disagree with an Approach](#when-you-disagree-with-an-approach)
- [When Someone Disagrees with Your Feedback](#when-someone-disagrees-with-your-feedback)
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid)
- [1. Bikeshedding](#1-bikeshedding)
- [2. Nitpicking Without Impact](#2-nitpicking-without-impact)
- [3. Vague Criticism](#3-vague-criticism)
- [4. "Just" Language](#4-just-language)
- [5. Approval Without Review](#5-approval-without-review)
- [Cultural Practices](#cultural-practices)
- [1. Normalize Learning](#1-normalize-learning)
- [2. Celebrate Good Code](#2-celebrate-good-code)
- [3. Share Context](#3-share-context)
- [4. Welcome Questions](#4-welcome-questions)
- [Review Etiquette](#review-etiquette)
- [Timing](#timing)
- [Response](#response)
- [Tone](#tone)
- [Example: Full Review with Psychological Safety](#example-full-review-with-psychological-safety)
- [Summary](#summary)
- [Strengths](#strengths)
- [Required Changes](#required-changes)
- [1. Password Hashing (Security)](#1-password-hashing-security)
- [2. SQL Injection Prevention](#2-sql-injection-prevention)
- [Suggestions](#suggestions)
- [1. Token Expiration](#1-token-expiration)
...
A mixed-methods study in *Empirical Software Engineering* — interviews plus a 423-person survey of agile teams — found that **psychological safety induces social enablers that advance teams' ability to pursue software quality** ("The Role of Psychological Safety in Promoting Software Quality in Agile Teams," Springer). Treat this as strong support for the practice, not as a claim that every team will see identical effects. When developers feel safe:
...
The steps below (Understand → Present → Suggest → Escalate) cover tone and de-escalation — how to disagree without damaging the relationship. They do not say whose argument wins when good-faith disagreement remains after Step 3. Use this order to decide:

1. **Technical facts and data override opinions.** A benchmark, a reproduction, a profiler trace, or a citation to the language/framework spec settles the question. If one side has evidence and the other has a preference, the evidence wins — restate the disagreement as "show me the data" before it becomes a style debate.
2. **Style guides are the absolute authority on style matters.** If the codebase has an enforced style guide (linter config, documented convention, prior team decision), that guide decides formatting, naming, and structural-style questions — not either reviewer's personal taste. Reopening a settled style-guide call in review is bikeshedding (see Anti-Patterns below).
3. **Software design is evaluated on engineering principles, not personal preference.** Absent hard data or a style-guide rule, fall back to named principles (coupling, cohesion, testability, blast radius, Rule 11's "match the codebase's conventions") rather than "I'd just do it this way." An argument grounded in a principle outranks an argument grounded in taste.

Work through the levels in order: check for facts/data first, then a style-guide rule, then engineering principles. Only fall through to the Step 4 escalation path once all three are checked and the disagreement is still unresolved — escalation is for when precedence doesn't produce an answer, not a substitute for applying it.
...
- **Related research**: [Understanding and Effectively Mitigating Code Review Anxiety](https://link.springer.com/article/10.1007/s10664-024-10550-9) (Empirical Software Engineering, Springer) — a cognitive-behavioral intervention that reduced review-related anxiety
