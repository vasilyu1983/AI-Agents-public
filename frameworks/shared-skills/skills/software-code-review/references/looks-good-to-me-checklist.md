...
## Review Hygiene
- Timebox: keep sessions to roughly 60–90 minutes; schedule follow-ups rather than rush (see `references/large-pr-review-strategies.md` for the source data).
- Size: prefer 200–400 LOC per review; split large changes; avoid “pass-through” approvals.
