...
### 2. Controlled Release Automation

Use these when you want Conventional Commits to drive versioning, but you still want a human-reviewed release step.
...
**`release-please`**:
- Best fit for GitHub repositories
- Opens a release PR with the proposed version and notes
- Lets maintainers review before publishing

**Legacy note**: `standard-version` is in maintenance mode. Keep it only for existing workflows you are not ready to migrate.
