...
- [Contents](#contents)
- [Hook Types and Use Cases](#hook-types-and-use-cases)
- [Husky Setup (v9+)](#husky-setup-v9)
- [lefthook Setup](#lefthook-setup)
- [lint-staged Integration](#lint-staged-integration)
- [commitlint Integration](#commitlint-integration)
- [Custom Hooks: Secrets, File Size, Branch Naming](#custom-hooks-secrets-file-size-branch-naming)
- [Bypassing Hooks](#bypassing-hooks)
- [Team Distribution Strategies](#team-distribution-strategies)
- [Example Configuration: Husky + lint-staged + commitlint](#example-configuration-husky--lint-staged--commitlint)
- [Do / Avoid](#do--avoid)
