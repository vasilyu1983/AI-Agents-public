...
- [Contents](#contents)
- [When Monorepo vs Polyrepo](#when-monorepo-vs-polyrepo)
- [Branching Strategy: Trunk-Based for Monorepos](#branching-strategy-trunk-based-for-monorepos)
- [Partial Clone and Sparse Checkout](#partial-clone-and-sparse-checkout)
- [CODEOWNERS and Path-Based Review Rules](#codeowners-and-path-based-review-rules)
- [Affected-Only CI](#affected-only-ci)
- [GitHub Actions: Path-Based Triggers](#github-actions-path-based-triggers)
- [Tooling Comparison](#tooling-comparison)
- [Merge Queue Considerations](#merge-queue-considerations)
- [Decision Table: Monorepo vs Polyrepo](#decision-table-monorepo-vs-polyrepo)
- [Do / Avoid](#do--avoid)
...
**Path-based merge rules** (prefer GitHub rulesets; use branch protection only if needed):
...
| Many PRs competing to merge | GitHub merge queue or GitLab merge trains with grouping |
