...
- [Merge Strategy Checklist](#merge-strategy-checklist)
- [Stacked Diffs Checklist](#stacked-diffs-checklist)
- [Rebase Checklist](#rebase-checklist)
- [Release Branch Checklist (GitFlow)](#release-branch-checklist-gitflow)
