...
- [GitHub Flow - Detailed Guide](#github-flow---detailed-guide)
- [What](#what)
- [Progress](#progress)
- [Questions](#questions)
- [Trunk-Based Development - Detailed Guide](#trunk-based-development---detailed-guide)
- [GitFlow - Detailed Guide](#gitflow---detailed-guide)
- [Migration Paths](#migration-paths)
- [Team Size Recommendations](#team-size-recommendations)
- [Branching Strategy Checklist](#branching-strategy-checklist)
...
git checkout -b release/YYYY-wNN main
git push origin release/YYYY-wNN
