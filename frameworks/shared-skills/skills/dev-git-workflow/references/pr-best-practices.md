...
- [Contents](#contents)
- [PR Sizing Heuristics](#pr-sizing-heuristics)
...
- [Advanced PR Patterns](#advanced-pr-patterns)
- [Status](#status)
- [Progress](#progress)
- [Early Feedback Needed](#early-feedback-needed)
- [Next Steps](#next-steps)
- [CI/CD Integration](#cicd-integration)
- [Metrics and Measurement](#metrics-and-measurement)
- [Common Pitfalls and Solutions](#common-pitfalls-and-solutions)
- [PR Templates by Project Type](#pr-templates-by-project-type)
...
Treat PR size as an operational heuristic, not a universal law. The right size is the largest change your reviewers can understand quickly without losing context.

| PR Shape | Typical Outcome | Recommendation |
|----------|-----------------|----------------|
| Hotfix / one-file change | Fast review | Merge as one focused PR |
| One logical feature | Usually reviewable | Keep it self-contained and well described |
| Mixed feature + refactor + bugfix | Review quality drops fast | Split into separate PRs or a stack |
| Long-running branch with dependencies | Merge friction rises | Use stacked PRs or feature flags |
...
### Example Team Operating Targets

Use these as starting internal targets, then tune them to your team and codebase.
