...
- [Contents](#contents)
- [When to Use Bisect](#when-to-use-bisect)
- [Manual Bisect Workflow](#manual-bisect-workflow)
- [Automated Bisect with Test Scripts](#automated-bisect-with-test-scripts)
- [Writing a Bisect Test Script](#writing-a-bisect-test-script)
- [Handling Merge Commits](#handling-merge-commits)
- [Bisect Log and Replay](#bisect-log-and-replay)
- [Tips for Faster Bisects](#tips-for-faster-bisects)
- [Integration with Debugging Workflow](#integration-with-debugging-workflow)
