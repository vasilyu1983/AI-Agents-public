...
- [Contents](#contents)
- [Auto-Squash Workflow (Modern Practice)](#auto-squash-workflow-modern-practice)
- [Interactive Rebase Commands](#interactive-rebase-commands)
- [Quick Example - Clean Up Before PR](#quick-example---clean-up-before-pr)
- [Rewriting Commit Messages](#rewriting-commit-messages)
...
- [Advanced: Autosquash with Commit Hash](#advanced-autosquash-with-commit-hash)
