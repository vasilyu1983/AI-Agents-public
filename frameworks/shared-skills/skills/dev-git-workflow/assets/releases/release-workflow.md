...
```bash
# Option 1: Use release-it (recommended for controlled/manual releases)
...
- v1.x: Supported until YYYY-MM-DD
...
|-------------|----------------|-----------------|-----------------|
| 2.1.x       | >= 2.0.0       | v5              | YYYY-MM-DD      |
| 2.0.x       | >= 1.5.0       | v4              | YYYY-MM-DD      |
| 1.x.x       | >= 1.0.0       | v3              | YYYY-MM-DD      |
```
...
|------|----------|------|------|
| **semantic-release** | Fully automated | CI/CD native, strong conventional-commit support | Less manual control |
| **release-it** | Controlled/manual | Dry-run support, interactive flow | Not fully automated |
| **release-please** | GitHub release PRs | Reviewable version PRs and notes | GitHub-centric workflow |
