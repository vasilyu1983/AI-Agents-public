...
- [dlt with compression](#dlt-with-compression)
- [ClickHouse compression](#clickhouse-compression)
- [Partitioning Strategy](#partitioning-strategy)
- [Lifecycle Policies](#lifecycle-policies)
- [S3 lifecycle for data tiers](#s3-lifecycle-for-data-tiers)
- [Compute Optimization](#compute-optimization)
- [ClickHouse](#clickhouse)
- [Query Optimization](#query-optimization)
- [Cost Monitoring](#cost-monitoring)
- [Tracking Query Costs](#tracking-query-costs)
