...
- [Time-based schedule](#time-based-schedule)
- [Event-based sensor](#event-based-sensor)
- [Resources and IO Managers](#resources-and-io-managers)
...
- [Dagster: Built-in asset observations](#dagster-built-in-asset-observations)
