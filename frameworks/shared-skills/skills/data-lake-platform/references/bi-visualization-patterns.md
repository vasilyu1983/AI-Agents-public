...
- [Metabase Operations](#metabase-operations)
- [Quick Reference](#quick-reference)
- [Connection Checklist](#connection-checklist)
- [Performance Optimization](#performance-optimization)
- [Permissions Model](#permissions-model)
- [Apache Superset Operations](#apache-superset-operations)
- [Quick Reference](#quick-reference)
- [Connection Configuration](#connection-configuration)
- [SQLAlchemy URI examples](#sqlalchemy-uri-examples)
- [ClickHouse](#clickhouse)
- [Trino](#trino)
- [PostgreSQL](#postgresql)
- [BigQuery](#bigquery)
- [Dataset Best Practices](#dataset-best-practices)
- [Security Model](#security-model)
- [Grafana Operations](#grafana-operations)
- [Quick Reference](#quick-reference)
...
- [Example: Data freshness alert](#example-data-freshness-alert)
- [Integration Patterns](#integration-patterns)
- [Lakehouse → BI Stack](#lakehouse-→-bi-stack)
- [Semantic Layer Pattern](#semantic-layer-pattern)
- [Embedding Pattern](#embedding-pattern)
- [Metabase signed embedding](#metabase-signed-embedding)
