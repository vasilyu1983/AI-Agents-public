...
- [Tool Selection (SQLMesh vs dbt)](#tool-selection-sqlmesh-vs-dbt)
- [Semantic Layers](#semantic-layers)
- [dbt Semantic Layer](#dbt-semantic-layer)
- [models/semantic/metrics.yml](#modelssemanticmetricsyml)
- [Cube.js (Alternative)](#cubejs-alternative)
- [SQLMesh Patterns](#sqlmesh-patterns)
...
- [Apply to development environment](#apply-to-development-environment)
- [Apply to production](#apply-to-production)
- [Run specific model](#run-specific-model)
- [dbt Patterns](#dbt-patterns)
- [Project Structure](#project-structure)
- [Model Configuration](#model-configuration)
- [Schema Tests](#schema-tests)
- [models/marts/_marts__models.yml](#modelsmartsmartsmodelsyml)
- [Medallion Layer Patterns](#medallion-layer-patterns)
- [Bronze (Raw Staging)](#bronze-raw-staging)
- [Silver (Cleaned)](#silver-cleaned)
- [Gold (Business-Ready)](#gold-business-ready)
- [Testing Patterns](#testing-patterns)
- [SQLMesh Unit Tests](#sqlmesh-unit-tests)
- [tests/test_order_total.yaml](#teststestordertotalyaml)
- [Data Quality Audits](#data-quality-audits)
- [CI/CD Integration](#cicd-integration)
- [GitHub Actions (SQLMesh)](#github-actions-sqlmesh)
- [GitHub Actions (dbt)](#github-actions-dbt)
