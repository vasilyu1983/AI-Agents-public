...
> Purpose: Operational reference for securing data lakes — ACL patterns, row/column-level security, encryption, PII handling, compliance automation, and audit logging.

---
## Table of Contents

- [Decision Tree: Choosing an Access Control Model](#decision-tree-choosing-an-access-control-model)
- [Quick Reference: Security Layers](#quick-reference-security-layers)
- [ACL Patterns for Iceberg / Delta](#acl-patterns-for-iceberg-delta)
- [Unity Catalog (Databricks) — Recommended](#unity-catalog-databricks-—-recommended)
- [AWS Lake Formation](#aws-lake-formation)
- [Apache Ranger Policy (Open-source)](#apache-ranger-policy-open-source)
- [Row-Level Security (RLS)](#row-level-security-rls)
- [Snowflake RLS](#snowflake-rls)
- [BigQuery RLS](#bigquery-rls)
- [PostgreSQL RLS](#postgresql-rls)
- [Column-Level Security and Dynamic Masking](#column-level-security-and-dynamic-masking)
- [Unity Catalog Column Masking](#unity-catalog-column-masking)
- [Snowflake Dynamic Masking](#snowflake-dynamic-masking)
- [Masking Strategy by Data Type](#masking-strategy-by-data-type)
- [Encryption](#encryption)
- [At-Rest Encryption Checklist](#at-rest-encryption-checklist)
- [Encryption Configuration](#encryption-configuration)
- [AWS S3 — SSE-KMS (recommended)](#aws-s3-—-sse-kms-recommended)
- [In-Transit Encryption](#in-transit-encryption)
- [PII Detection and Handling](#pii-detection-and-handling)
- [Automated PII Scanning](#automated-pii-scanning)
- [PII Classification Tags](#pii-classification-tags)
- [Compliance Patterns](#compliance-patterns)
- [GDPR Checklist](#gdpr-checklist)
- [CCPA Checklist](#ccpa-checklist)
- [Right to Erasure](#right-to-erasure)
- [Audit Logging](#audit-logging)
- [What to Log](#what-to-log)
- [Audit Query Sources](#audit-query-sources)
- [Access Control Automation](#access-control-automation)
- [Infrastructure-as-Code](#infrastructure-as-code)
- [Role Hierarchy Best Practice](#role-hierarchy-best-practice)
...
### Unity Catalog (Databricks) — Recommended
