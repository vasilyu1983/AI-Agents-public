...
- [prometheus/clickhouse-alerts.yaml](#prometheusclickhouse-alertsyaml)
- [Incident Response](#incident-response)
- [Pipeline Failure](#pipeline-failure)
- [Data Quality Issue](#data-quality-issue)
- [ClickHouse Performance Degradation](#clickhouse-performance-degradation)
- [Migration Procedures](#migration-procedures)
- [Adding New Data Source](#adding-new-data-source)
- [Schema Change](#schema-change)
- [Table Format Migration (e.g., Parquet → Iceberg)](#table-format-migration-eg-parquet-→-iceberg)
- [Backup & Recovery](#backup-&-recovery)
- [ClickHouse Backup](#clickhouse-backup)
- [Using clickhouse-backup](#using-clickhouse-backup)
- [Restore](#restore)
- [Iceberg Time Travel (Recovery)](#iceberg-time-travel-recovery)
- [Runbook Template](#runbook-template)
- [Runbook: [Issue Type]](#runbook-issue-type)
- [Symptoms](#symptoms)
- [Impact](#impact)
