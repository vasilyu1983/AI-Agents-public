...
> Purpose: Operational reference for implementing data quality across data lake architectures — testing strategies, anomaly detection, SLO definition, automated remediation, and observability dashboards.

---
## Table of Contents

- [Decision Tree: Choosing a Data Quality Approach](#decision-tree-choosing-a-data-quality-approach)
- [Quick Reference: Data Quality Dimensions](#quick-reference-data-quality-dimensions)
- [Great Expectations Integration](#great-expectations-integration)
- [Setup for Data Lake](#setup-for-data-lake)
- [great_expectations/datasources/lake_config.py](#greatexpectationsdatasourceslakeconfigpy)
- [S3/Delta Lake datasource](#s3delta-lake-datasource)
- [Add data asset](#add-data-asset)
- [Expectation Suite for Lake Tables](#expectation-suite-for-lake-tables)
- [great_expectations/expectations/lake_orders_suite.py](#greatexpectationsexpectationslakeorderssuitepy)
- [Completeness](#completeness)
- [Uniqueness](#uniqueness)
- [Volume](#volume)
- [Validity](#validity)
- [Distribution](#distribution)
- [Freshness (custom)](#freshness-custom)
- [dbt Test Strategies for Lakes](#dbt-test-strategies-for-lakes)
- [Layer-Specific Testing](#layer-specific-testing)
- [Source Quality Gate](#source-quality-gate)
- [models/staging/sources.yml](#modelsstagingsourcesyml)
- [Anomaly Detection for Pipelines](#anomaly-detection-for-pipelines)
- [Volume Anomaly Detection](#volume-anomaly-detection)
- [Schema Change Detection](#schema-change-detection)
- [monitors/schema_drift.py](#monitorsschemadriftpy)
- [Distribution Shift Detection](#distribution-shift-detection)
- [SLO Definition for Data Quality](#slo-definition-for-data-quality)
- [SLO Template](#slo-template)
- [SLO Configuration](#slo-configuration)
- [quality/slos/fct_orders_slo.yml](#qualityslosfctorderssloyml)
- [Automated Remediation Workflows](#automated-remediation-workflows)
- [Remediation Decision Matrix](#remediation-decision-matrix)
- [Auto-Deduplication Pattern](#auto-deduplication-pattern)
- [Circuit Breaker Pattern](#circuit-breaker-pattern)
- [Data Observability Tools](#data-observability-tools)
- [Quality Dashboard Components](#quality-dashboard-components)
