...
- [Kafka Connect (Source)](#kafka-connect-source)
- [Kafka Connect (Sink to ClickHouse)](#kafka-connect-sink-to-clickhouse)
- [Apache Flink](#apache-flink)
- [Stream Processing (Python)](#stream-processing-python)
- [Define Kafka source](#define-kafka-source)
- [Define ClickHouse sink](#define-clickhouse-sink)
- [Windowed aggregation](#windowed-aggregation)
- [Flink SQL (Stateful Processing)](#flink-sql-stateful-processing)
- [Spark Structured Streaming](#spark-structured-streaming)
- [Basic Stream](#basic-stream)
- [Read from Kafka](#read-from-kafka)
- [Parse JSON](#parse-json)
- [Windowed aggregation](#windowed-aggregation)
- [Write to Iceberg](#write-to-iceberg)
- [Streaming to ClickHouse](#streaming-to-clickhouse)
- [Architecture Patterns](#architecture-patterns)
- [Kappa with Iceberg](#kappa-with-iceberg)
- [Lambda with ClickHouse](#lambda-with-clickhouse)
