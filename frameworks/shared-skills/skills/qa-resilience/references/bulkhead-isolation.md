...
- [Pattern: Bulkhead Isolation](#pattern-bulkhead-isolation)
- [Thread Pool Sizing](#thread-pool-sizing)
- [Database Connection Pooling](#database-connection-pooling)
- [Separate engines for read and write](#separate-engines-for-read-and-write)
- [Queue-Based Bulkheads](#queue-based-bulkheads)
- [Monitoring Bulkheads](#monitoring-bulkheads)
- [Pool utilization](#pool-utilization)
- [Queue depth](#queue-depth)
- [Wait time in queue](#wait-time-in-queue)
- [Checklist](#checklist)
