...
- [Pattern: Circuit Breaker (Classic)](#pattern-circuit-breaker-classic)
- [Configure circuit breaker](#configure-circuit-breaker)
- [Fallback function](#fallback-function)
- [Usage with fallback](#usage-with-fallback)
- [Pattern: Adaptive Circuit Breaker (2024-2025)](#pattern-adaptive-circuit-breaker-2024-2025)
...
## Pattern: Adaptive Circuit Breaker
...
- Michael T. Nygard, *Release It! Design and Deploy Production-Ready Software* (2nd ed., Pragmatic Bookshelf, 2018) — the original source of the circuit-breaker stability pattern as applied to software systems (author/title verified 2026-07-11).
