...
- [Contents](#contents)
- [Overview](#overview)
- [Phase 1: Discovery Scan](#phase-1-discovery-scan)
- [Component Inventory](#component-inventory)
- [Phase 2: Coverage Analysis](#phase-2-coverage-analysis)
- [Phase 3: Generate Documentation](#phase-3-generate-documentation)
- [Priority 1 Gaps (5 items)](#priority-1-gaps-5-items)
- [Progress Update](#progress-update)
- [Phase 4: Maintain Coverage](#phase-4-maintain-coverage)
- [Documentation Checklist](#documentation-checklist)
- [Documentation Ownership](#documentation-ownership)
- [Audit Types](#audit-types)
- [Targeted Audit: Payment Service](#targeted-audit-payment-service)
...
A named owner in this table is necessary but not sufficient — judge whether the ownership model
has an enforcement mechanism (`CODEOWNERS` on the docs path, a docs-on-call rotation, a charter
line) or is just a name nobody is accountable to. See "Ownership Models That Keep Docs Alive" in
[SKILL.md](../SKILL.md) for the tradeoffs between models.
