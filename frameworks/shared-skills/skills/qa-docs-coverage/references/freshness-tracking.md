...
| ---- | ------- | ----------- |
| [Lychee](https://github.com/lycheeverse/lychee) (v0.24.x current mid-2026; confirm via lycheeverse/lychee-action) | External link detection | CI/CD |
| [Vale](https://vale.sh/) (moved from errata-ai/vale to vale-cli/vale; check github.com/vale-cli/vale/releases for current version) | Prose linting; LSP and Views support | Pre-commit |
