...
- [Overview](#overview)
- [Load Generation & Benchmarking](#load-generation-&-benchmarking)
- [Workload Characterization](#workload-characterization)
- [Sample real production traffic](#sample-real-production-traffic)
- [Log: timestamp, prompt_len, completion_len, latency](#log-timestamp-promptlen-completionlen-latency)
- [Analyze distributions](#analyze-distributions)
- [Distribution percentiles](#distribution-percentiles)
- [Load Testing with vLLM Benchmark](#load-testing-with-vllm-benchmark)
- [Install vLLM](#install-vllm)
- [Run benchmark](#run-benchmark)
- [Benchmark with realistic workload](#benchmark-with-realistic-workload)
- [Run load test](#run-load-test)
- [Metrics Collection](#metrics-collection)
- [Performance Budgets & SLOs](#performance-budgets-&-slos)
- [Define Service Level Objectives](#define-service-level-objectives)
- [Production SLO definition](#production-slo-definition)
- [Establishing Performance Budgets](#establishing-performance-budgets)
- [Define budgets based on SLOs](#define-budgets-based-on-slos)
- [Validate configuration meets budgets](#validate-configuration-meets-budgets)
- [Capacity Planning](#capacity-planning)
- [Replica Count Derivation](#replica-count-derivation)
- [Example calculation](#example-calculation)
- [Autoscaling Policies](#autoscaling-policies)
- [KV Cache Size Planning](#kv-cache-size-planning)
- [Example: Llama-2-13B](#example-llama-2-13b)
- [Regression Guards & CI/CD Integration](#regression-guards-&-cicd-integration)
- [Performance Testing in CI](#performance-testing-in-ci)
- [scripts/check_budgets.py](#scriptscheckbudgetspy)
- [Benchmark Report Storage](#benchmark-report-storage)
- [Profiling Tools & Techniques](#profiling-tools-&-techniques)
- [GPU Profiling with nvidia-smi](#gpu-profiling-with-nvidia-smi)
- [Watch GPU metrics (1s refresh)](#watch-gpu-metrics-1s-refresh)
- [Fields:](#fields)
- [- pwr: Power usage](#pwr-power-usage)
- [- gtemp: GPU temperature](#gtemp-gpu-temperature)
- [- sm: SM (streaming multiprocessor) utilization](#sm-sm-streaming-multiprocessor-utilization)
- [- mem: Memory utilization](#mem-memory-utilization)
- [- enc: Encoder utilization](#enc-encoder-utilization)
- [- dec: Decoder utilization](#dec-decoder-utilization)
- [- mclk: Memory clock](#mclk-memory-clock)
- [- pclk: Graphics clock](#pclk-graphics-clock)
- [Continuous logging](#continuous-logging)
- [Stop logging](#stop-logging)
- [CUDA Profiling with Nsight](#cuda-profiling-with-nsight)
- [Install Nsight Systems](#install-nsight-systems)
- [Download from: https://developer.nvidia.com/nsight-systems](#download-from-httpsdevelopernvidiacomnsight-systems)
- [Profile inference](#profile-inference)
- [View in GUI](#view-in-gui)
- [Mark regions](#mark-regions)
- [Python Profiling](#python-profiling)
- [Checklist: Performance Validation Complete](#checklist-performance-validation-complete)
