...
- [0. Operating Principles (REQUIRED)](#0-operating-principles-required)
- [1. Measurement Protocol (REQUIRED)](#1-measurement-protocol-required)
- [Define traffic shape](#define-traffic-shape)
- [Measure the right metrics](#measure-the-right-metrics)
- [Tag every measurement run](#tag-every-measurement-run)
- [2. Latency Optimization (TTFT and Total)](#2-latency-optimization-ttft-and-total)
- [If TTFT is high](#if-ttft-is-high)
- [If decode is slow (high ITL)](#if-decode-is-slow-high-itl)
- [3. Throughput Optimization (QPS / tok/s)](#3-throughput-optimization-qps-toks)
- [Scheduling and batching](#scheduling-and-batching)
- [Parallelism](#parallelism)
- [4. Cost Optimization (Budget and Unit Economics)](#4-cost-optimization-budget-and-unit-economics)
- [5. Decision Tree: What to Optimize First?](#5-decision-tree-what-to-optimize-first)
- [6. Anti-Patterns (AVOID)](#6-anti-patterns-avoid)
- [7. Baseline Checklist (Before Shipping)](#7-baseline-checklist-before-shipping)
