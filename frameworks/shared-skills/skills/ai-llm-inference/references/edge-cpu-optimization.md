...
- [Overview](#overview)
- [CPU-Optimized Stacks](#cpu-optimized-stacks)
- [llama.cpp](#llamacpp)
- [GGML & GGUF Formats](#ggml-&-gguf-formats)
- [From HuggingFace](#from-huggingface)
- [Convert HuggingFace → GGUF](#convert-huggingface-→-gguf)
- [OpenVINO (Intel CPUs)](#openvino-intel-cpus)
- [Optimize HuggingFace model for CPU](#optimize-huggingface-model-for-cpu)
- [ONNX Runtime](#onnx-runtime)
- [HuggingFace → ONNX](#huggingface-→-onnx)
- [MLC-LLM (Mobile/Edge)](#mlc-llm-mobileedge)
- [CPU Performance Optimization](#cpu-performance-optimization)
- [Threading Configuration](#threading-configuration)
- [Rule of thumb: physical cores (not hyperthreads)](#rule-of-thumb-physical-cores-not-hyperthreads)
- [llama.cpp](#llamacpp)
- [ONNX Runtime](#onnx-runtime)
- [SIMD Acceleration](#simd-acceleration)
- [Linux](#linux)
- [macOS](#macos)
- [Auto-detect SIMD](#auto-detect-simd)
- [Explicit AVX512](#explicit-avx512)
- [Apple Silicon (Metal)](#apple-silicon-metal)
- [BLAS Libraries (Matrix Multiplication)](#blas-libraries-matrix-multiplication)
- [Memory Bandwidth Optimization](#memory-bandwidth-optimization)
- [llama.cpp](#llamacpp)
- [Linux](#linux)
- [Larger batches = better throughput (up to memory limit)](#larger-batches-=-better-throughput-up-to-memory-limit)
- [Edge Device Deployment](#edge-device-deployment)
- [Raspberry Pi (ARM Cortex-A)](#raspberry-pi-arm-cortex-a)
- [Build llama.cpp for ARM](#build-llamacpp-for-arm)
- [Run with limited resources](#run-with-limited-resources)
- [Mobile Devices (iOS/Android)](#mobile-devices-iosandroid)
- [Browser (WebAssembly + WebGPU)](#browser-webassembly-webgpu)
- [Benchmarking & Validation](#benchmarking-&-validation)
- [Performance Testing](#performance-testing)
- [Output includes:](#output-includes)
- [- Prompt eval time (prefill)](#prompt-eval-time-prefill)
- [- Token generation time (decode)](#token-generation-time-decode)
- [- Tokens per second](#tokens-per-second)
- [Quality Validation](#quality-validation)
- [Original model](#original-model)
- [Test prompts](#test-prompts)
- [Compare outputs (original vs quantized)](#compare-outputs-original-vs-quantized)
- [Run both models and check:](#run-both-models-and-check)
- [1. Factual correctness](#1-factual-correctness)
- [2. Coherence](#2-coherence)
- [3. Instruction following](#3-instruction-following)
- [Validation Checklist](#validation-checklist)
- [Production Deployment Patterns](#production-deployment-patterns)
- [Serverless CPU Inference](#serverless-cpu-inference)
- [Lambda handler with llama.cpp](#lambda-handler-with-llamacpp)
- [Load model at cold start (outside handler)](#load-model-at-cold-start-outside-handler)
