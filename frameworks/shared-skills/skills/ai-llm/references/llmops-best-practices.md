...
- [Pattern 1: LLM Project Preflight & Lifecycle](#pattern-1-llm-project-preflight-&-lifecycle)
- [Pattern 2: LLMOps Lifecycle—End-to-End Steps](#pattern-2-llmops-lifecycle—end-to-end-steps)
- [Pattern 3: Production Readiness—Quality Gates](#pattern-3-production-readiness—quality-gates)
- [Decision Matrices](#decision-matrices)
- [Model Path Selection Table](#model-path-selection-table)
- [Deployment Pattern Matrix](#deployment-pattern-matrix)
- [Common Mistakes & Anti-Patterns](#common-mistakes-&-anti-patterns)
- [Quick Reference](#quick-reference)
- [LLMOps Production Checklist](#llmops-production-checklist)
