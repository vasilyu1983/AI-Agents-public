...
- [Pattern 1: Minimal RAG Pipeline](#pattern-1-minimal-rag-pipeline)
- [Pattern 2: Advanced RAG (Reranking, Filtering, Hybrid)](#pattern-2-advanced-rag-reranking-filtering-hybrid)
- [Pattern 3: Modular RAG](#pattern-3-modular-rag)
- [Decision Matrices](#decision-matrices)
- [Chunking Strategy Table](#chunking-strategy-table)
- [RAG Mode Selector](#rag-mode-selector)
- [Advanced RAG Architectures (2026)](#advanced-rag-architectures-2026)
- [Pattern 4: Agentic RAG](#pattern-4-agentic-rag)
- [Pattern 5: GraphRAG (Knowledge Graph RAG)](#pattern-5-graphrag-knowledge-graph-rag)
- [Architecture Comparison (2026)](#architecture-comparison-2026)
