...
- [LLM Lifecycle Checklist](#llm-lifecycle-checklist)
- [Performance Budget & Goodput Gates](#performance-budget--goodput-gates)
- [Reliability & Data Infrastructure (DDIA-Grade)](#reliability--data-infrastructure-ddia-grade)
...
- [ ] Adaptation path documented: prompt-only, RAG, tool use, adapters/SFT, preference optimization, or hybrid
...
- [ ] Reasoning mode selected deliberately (internal by default; visible steps only when required)
...
- [llm-utilities.md](../../software-clean-code-standard/references/llm-utilities.md) — Token counting (tiktoken), streaming, cost estimation, rate limit handling
- [error-handling.md](../../software-clean-code-standard/references/error-handling.md) — Effect Result types, correlation IDs for LLM error handling
...
- [logging-utilities.md](../../software-clean-code-standard/references/logging-utilities.md) — pino v9 + OpenTelemetry for LLM logging
- [observability-utilities.md](../../software-clean-code-standard/references/observability-utilities.md) — OpenTelemetry SDK, tracing for LLM latency/cost tracking
- [config-validation.md](../../software-clean-code-standard/references/config-validation.md) — Zod 3.24+ for API key validation, secrets management
- [testing-utilities.md](../../software-clean-code-standard/references/testing-utilities.md) — Vitest, MSW v2 for mocking LLM APIs
