...
**Note:** This file is a lightweight reference inside `ai-llm`. For canonical prompt depth, use [../../ai-prompt-engineering/SKILL.md](../../ai-prompt-engineering/SKILL.md).
...
### Pattern 2: Reasoning Contract Prompt
...
```text
TASK:
If a train leaves at 8:00am and travels 60 miles at 30 mph, what time does it arrive?

RULES:
- Think through the answer internally.
- Return the final answer first.
- Then provide a brief justification in 1-2 bullets.

OUTPUT:
Final answer: 10:00am.
Why:
- 60 miles at 30 mph takes 2 hours.
- 8:00am + 2 hours = 10:00am.
```

**Checklist:**

- [ ] Default to internal reasoning or brief justification
- [ ] Only request explicit visible steps when the task is educational, auditable, or the user asks for them
