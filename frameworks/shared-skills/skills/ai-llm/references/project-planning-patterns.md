...
- [Project Planning & Stack Selection (AI Engineering Stack)](#project-planning-&-stack-selection-ai-engineering-stack)
- [Planning Checklist](#planning-checklist)
- [Decision Framework](#decision-framework)
- [Stack Selection Matrix](#stack-selection-matrix)
- [Feature/Training/Inference (FTI) Pipeline Blueprint](#featuretraininginference-fti-pipeline-blueprint)
- [Feature Pipeline](#feature-pipeline)
- [Training Pipeline](#training-pipeline)
- [Inference Pipeline](#inference-pipeline)
- [Traceability](#traceability)
- [AI Engineering Stack Patterns](#ai-engineering-stack-patterns)
- [Monolithic vs Modular Architecture](#monolithic-vs-modular-architecture)
- [Selection Criteria](#selection-criteria)
- [Performance Budgeting](#performance-budgeting)
- [Setting Budgets Up Front](#setting-budgets-up-front)
- [Profiling Harness](#profiling-harness)
- [Load generation with mixed prompt lengths](#load-generation-with-mixed-prompt-lengths)
- [Rollout Gates](#rollout-gates)
- [Regression Loop](#regression-loop)
