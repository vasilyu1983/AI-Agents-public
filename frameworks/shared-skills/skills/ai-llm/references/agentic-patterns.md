...
- [Pattern 1: Agent Workflow Loop](#pattern-1-agent-workflow-loop)
- [Pattern 2: Tool Use & Reflection](#pattern-2-tool-use-&-reflection)
- [Pattern 3: Multi-Agent Collaboration](#pattern-3-multi-agent-collaboration)
- [Decision Matrices](#decision-matrices)
- [Agent Type Selection Table](#agent-type-selection-table)
- [Step Limit and Escalation Matrix](#step-limit-and-escalation-matrix)
- [Common Mistakes & Anti-Patterns](#common-mistakes-&-anti-patterns)
- [Quick Reference](#quick-reference)
- [Agentic System Production Checklist](#agentic-system-production-checklist)
