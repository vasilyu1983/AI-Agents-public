...
**Last Updated:** 2026-03-24 (fixed duplicate comment labels, added freshness date)
...
// BAD: Single admin has all powers
...
// BAD: Partial state changes possible
...
```solidity
// GOOD: Indexed fields for filtering, all data included
event Transfer(
