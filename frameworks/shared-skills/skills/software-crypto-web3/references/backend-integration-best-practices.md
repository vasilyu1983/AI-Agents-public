# Backend Crypto Integration Best Practices (.NET/C#)
...
> **Scope note**: This reference covers .NET/C#-specific patterns (MediatR, FluentResults, NUnit, Kafka). The architectural principles (CQRS, idempotent handlers, multi-provider abstraction, webhook security, transaction lifecycle) apply to any backend language. For Node.js/Python/Go backend patterns, see the [software-backend](../../software-backend/SKILL.md) skill and adapt the architecture patterns from this reference.

**Last Updated:** 2026-03-24 (added scope clarification, freshness date)
