...
- **Ownership model:** Owning team, on-call boundary, contract owners, and deploy authority  
...
- **What not to build yet:** Deferred services, deferred platform layers, or controls not yet justified  
