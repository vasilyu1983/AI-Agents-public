...
See [data/sources.json](../data/sources.json) for the full set of curated references on:
...
- AI-native architecture and interoperability (RAG, agent patterns, MCP, A2A)
