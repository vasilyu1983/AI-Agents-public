...
*Use when:* The task is about incident severity, paging, escalation, communications, or postmortem structure and you need the incident-management workflow itself.
...
- PagerDuty/Jira Service Management pages on-call
...
**Checklist:**
- [ ] Escalation contacts up-to-date in PagerDuty/Jira Service Management
...
**First 5 Minutes:**
- [ ] Acknowledge alert in PagerDuty/Jira Service Management
...
**Scenario:** PagerDuty/Jira Service Management is down during incident
