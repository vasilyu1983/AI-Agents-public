# Remix / React Router (v7/v8) Best Practices & Patterns

Operational patterns for building full-stack React applications with React Router (v7 framework mode, current major v8) and legacy Remix v2. React Router v8 has shipped and Remix v2 is now End-of-Life (no security patches) — treat React Router's own docs as the current source of truth for all new work, and use this file's Remix v2 material only to read or migrate an existing legacy codebase.

---
## Table of Contents

- [Remix v2 vs React Router v7](#remix-v2-vs-react-router-v7)
- [The Merger](#the-merger)
- [Import Migration Map](#import-migration-map)
- [When to Start New Projects](#when-to-start-new-projects)
- [Vite Configuration](#vite-configuration)
- [React Router v7 (New Projects)](#react-router-v7-new-projects)
- [Remix v2 with Vite (Migration Path)](#remix-v2-with-vite-migration-path)
- [Loader & Action Patterns](#loader-&-action-patterns)
- [Basic Loader (React Router v7)](#basic-loader-react-router-v7)
- [Parallel Data Loading](#parallel-data-loading)
- [Action with Validation](#action-with-validation)
- [Multiple Actions (Intent Pattern)](#multiple-actions-intent-pattern)
- [clientLoader & clientAction](#clientloader-&-clientaction)
- [When to Use](#when-to-use)
- [Cache-First Pattern](#cache-first-pattern)
- [clientAction for Optimistic Writes](#clientaction-for-optimistic-writes)
- [Client-Only Data (No Server Loader)](#client-only-data-no-server-loader)
- [Form Patterns & Optimistic UI](#form-patterns-&-optimistic-ui)
- [Form with Validation Feedback](#form-with-validation-feedback)
- [Optimistic UI with useFetcher](#optimistic-ui-with-usefetcher)
- [Streaming & Deferred Data](#streaming-&-deferred-data)
- [Returning Promises (React Router v7 / Single Fetch)](#returning-promises-react-router-v7-single-fetch)
- [Revalidation Control](#revalidation-control)
- [shouldRevalidate](#shouldrevalidate)
- [useRevalidator](#userevalidator)
- [Nested Routes & Layouts](#nested-routes-&-layouts)
- [File-Based Route Structure](#file-based-route-structure)
- [Layout Route with Outlet](#layout-route-with-outlet)
- [Route Config (React Router v7 Alternative)](#route-config-react-router-v7-alternative)
- [SPA Mode](#spa-mode)
- [Resource Routes](#resource-routes)
- [Session & Auth Patterns](#session-&-auth-patterns)
- [Error Handling](#error-handling)
- [Route-Level Error Boundary](#route-level-error-boundary)
- [Performance Patterns](#performance-patterns)
- [Link Prefetching](#link-prefetching)
- [Single Fetch (React Router v7)](#single-fetch-react-router-v7)
- [Code Splitting](#code-splitting)
- [Testing Patterns](#testing-patterns)
- [Loader Unit Test](#loader-unit-test)
- [Anti-Patterns](#anti-patterns)
- [1. Fetching Data in useEffect Instead of Loaders](#1-fetching-data-in-useeffect-instead-of-loaders)
- [2. Using useState for Server-Fetched Data](#2-using-usestate-for-server-fetched-data)
- [3. Calling json() in React Router v7 with Single Fetch](#3-calling-json-in-react-router-v7-with-single-fetch)
- [4. Sequential Loader Waterfall](#4-sequential-loader-waterfall)
- [5. Skipping shouldRevalidate on Static Data](#5-skipping-shouldrevalidate-on-static-data)
- [6. Using window.location for Navigation](#6-using-windowlocation-for-navigation)
- [Decision Frameworks](#decision-frameworks)
- [Loader vs clientLoader](#loader-vs-clientloader)
- [SSR vs SPA vs Prerendering](#ssr-vs-spa-vs-prerendering)
- [When to Use Form vs useFetcher](#when-to-use-form-vs-usefetcher)
...
Remix merged into React Router. React Router v7 is effectively "Remix v3" — same team, same architecture, new package name. **Currency note (2026): React Router v8 has since shipped, and with that release the React Router team marked Remix v2 (and React Router v6) End-of-Life — they no longer receive security patches.** The three operating modes introduced in v7 (declarative, data, framework) carry forward into v8, so everything below about "React Router v7" applies equally to v8 unless noted. Understanding the v2-to-v7/v8 mapping is still critical for reading or maintaining legacy Remix v2 code, and for import paths and documentation lookups.

| Aspect | Remix v2 (EOL — no security patches) | React Router v7 / v8 |
|--------|----------|-----------------|
...
| Status | End-of-life — migrate off, don't build new work on it | Active development |
...
Starting a new project?
  ...
  +-- Existing Remix v2 app?
      +-- Small/medium app -> migrate to RR7/v8 now (incremental, low risk)
      +-- Large app with custom compiler plugins -> plan migration urgently
      +-- Remix v2 is End-of-Life as of React Router v8's release — it no
          longer receives security patches, so "no rush" is no longer a
          safe default; treat migration as a scheduled priority, not optional
```
