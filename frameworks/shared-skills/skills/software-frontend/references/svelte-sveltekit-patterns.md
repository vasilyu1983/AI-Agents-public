...
- [Contents](#contents)
- [Svelte 5 Runes (New Reactivity System)](#svelte-5-runes-new-reactivity-system)
- [Universal Reactivity (Runes in .svelte.ts files)](#universal-reactivity-runes-in-sveltets-files)
- [SvelteKit Patterns](#sveltekit-patterns)
