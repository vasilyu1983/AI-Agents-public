...
- [Contents](#contents)
- [Pattern: Next.js 16 App Router Architecture](#pattern-nextjs-16-app-router-architecture)
- [Pattern: Server vs Client Components](#pattern-server-vs-client-components)
- [Pattern: TypeScript Component Props](#pattern-typescript-component-props)
- [Pattern: Data Fetching & Server Actions](#pattern-data-fetching--server-actions)
- [Pattern: Form Handling with React Hook Form + Zod](#pattern-form-handling-with-react-hook-form--zod)
- [Pattern: Styling with Tailwind CSS & shadcn/ui](#pattern-styling-with-tailwind-css--shadcnui)
- [Pattern: State Management](#pattern-state-management)
- [Pattern: Performance Optimization](#pattern-performance-optimization)
- [Pattern: Accessibility (WCAG 2.2)](#pattern-accessibility-wcag-22)
- [Pattern: Testing](#pattern-testing)
- [Pattern: Frontend Security](#pattern-frontend-security)
- [Component Type Selection](#component-type-selection)
- [State Management Selection](#state-management-selection)
- [Styling Approach](#styling-approach)
- [Next.js 16 Migration Checklist](#nextjs-16-migration-checklist)
...
- **Zustand** or **Jotai** for lightweight client state (Redux alternatives)
...
Is it global client state? -> Zustand/Jotai
...
**Angular:**
- `assets/angular/template-angular21-standalone.md` - Angular 19-22 + Standalone Components + Signals (filename kept for stability; content covers current Angular 22 patterns)
...
- `angular-patterns.md` - Angular 19-22 patterns (current major is Angular 22, released June 2026):
