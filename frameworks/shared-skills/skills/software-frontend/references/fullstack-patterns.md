...
- [Contents](#contents)
- [Overview](#overview)
- [Backend: Authentication API](#backend-authentication-api)
- [Frontend: Authentication UI](#frontend-authentication-ui)
- [Backend: Blog API](#backend-blog-api)
- [Frontend: Blog UI](#frontend-blog-ui)
- [Backend: Direct Database Access](#backend-direct-database-access)
- [Frontend: Server Component (No API Call!)](#frontend-server-component-no-api-call)
- [Server Actions](#server-actions)
- [Frontend: Form with Server Action](#frontend-form-with-server-action)
- [Why tRPC?](#why-trpc)
- [Backend: tRPC Router Setup](#backend-trpc-router-setup)
- [Frontend: tRPC Client Setup](#frontend-trpc-client-setup)
- [tRPC vs REST API Comparison](#trpc-vs-rest-api-comparison)
...
- [error-handling.md](../../software-clean-code-standard/references/error-handling.md) - Effect Result types, correlation IDs
- [config-validation.md](../../software-clean-code-standard/references/config-validation.md) - Zod 3.24+, Valibot for client validation
- [logging-utilities.md](../../software-clean-code-standard/references/logging-utilities.md) - Structured logging patterns
...
- [auth-utilities.md](../../software-clean-code-standard/references/auth-utilities.md) - jose JWT for frontend auth flows
