...
const nextConfig: NextConfig = {
  // Enable if you plan to use "use cache" or cacheLife/cacheTag
...
// NOTE: `proxy.ts` runs on the Node.js runtime.
// `middleware.ts` still exists for Edge-specific legacy cases, but it is deprecated.
