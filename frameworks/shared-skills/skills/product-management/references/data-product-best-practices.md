...
- [3.1 Phase 1 — Problem Framing](#31-phase-1-—-problem-framing)
- [3.2 Phase 2 — Sourcing & Ingestion](#32-phase-2-—-sourcing-&-ingestion)
- [3.3 Phase 3 — Transformation & Modeling](#33-phase-3-—-transformation-&-modeling)
- [3.4 Phase 4 — Serving Layer](#34-phase-4-—-serving-layer)
- [3.5 Phase 5 — Monitoring & Quality](#35-phase-5-—-monitoring-&-quality)
- [4. Data Quality Score (Operational)](#4-data-quality-score-operational)
- [5. Golden Data Platform Requirements](#5-golden-data-platform-requirements)
- [6. Data Contract Template](#6-data-contract-template)
- [7. Data Governance Patterns](#7-data-governance-patterns)
- [7.1 Governance Checklist](#71-governance-checklist)
- [7.2 Decision Workflow for Data Access Requests](#72-decision-workflow-for-data-access-requests)
- [8. ML Data Pipeline Patterns](#8-ml-data-pipeline-patterns)
- [8.1 Feature Store Template](#81-feature-store-template)
- [8.2 Training Data Checklist](#82-training-data-checklist)
- [9. Decision Trees](#9-decision-trees)
- [9.1 Should You Create a Data Product?](#91-should-you-create-a-data-product)
- [9.2 Batch vs Streaming](#92-batch-vs-streaming)
- [10. Definition of Done (Data Product)](#10-definition-of-done-data-product)
