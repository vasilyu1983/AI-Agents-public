...
- [2. Product Strategy Structure (Operational)](#2-product-strategy-structure-operational)
- [2.1 Strategy Template](#21-strategy-template)
- [3. Strategy Focus Areas (Patterns)](#3-strategy-focus-areas-patterns)
- [Common patterns](#common-patterns)
- [4. Strategic Bet Patterns](#4-strategic-bet-patterns)
- [Bet Starter Templates](#bet-starter-templates)
- [Bet Types](#bet-types)
- [5. Competitive Mapping Patterns](#5-competitive-mapping-patterns)
- [5.1 Competitive Alternatives Table](#51-competitive-alternatives-table)
- [5.2 Differentiation Pattern](#52-differentiation-pattern)
- [Differentiation Types](#differentiation-types)
- [6. Strategy Prioritization](#6-strategy-prioritization)
- [6.1 Strategic Alignment Test](#61-strategic-alignment-test)
- [6.2 Portfolio Balance Pattern](#62-portfolio-balance-pattern)
- [7. OKR Pattern Library (Strategy-Aligned)](#7-okr-pattern-library-strategy-aligned)
- [7.1 OKR Structure](#71-okr-structure)
- [Examples (fill-in patterns)](#examples-fill-in-patterns)
- [8. Strategy Decision Trees](#8-strategy-decision-trees)
- [8.1 Do you have a strategy?](#81-do-you-have-a-strategy)
- [8.2 Should we add a new strategic bet?](#82-should-we-add-a-new-strategic-bet)
- [9. Product Explainability](#9-product-explainability)
- [9.1 Why This Matters](#91-why-this-matters)
- [9.2 Explainability Checklist](#92-explainability-checklist)
- [9.3 Explainability Audit Template](#93-explainability-audit-template)
- [10. Anti-Patterns](#10-anti-patterns)
- [10. Definition of Done (Strategy)](#10-definition-of-done-strategy)
...
Ensure your bets form a balanced portfolio across time horizons. This follows the McKinsey Three Horizons lineage (H1 = core/defend, H2 = emerging, H3 = options/bets).

The right split is stage-conditional:

- **Pre-PMF startups**: Put the overwhelming majority of capacity on near-term PMF work. Survival depends on it. Long-horizon bets consume resources before the core is proven — most capacity on H1, minimal on H2, near-zero on H3.
- **Established multi-product companies**: A common reference allocation is **50% near-term** (H1, Now/Next) / **30% medium-term** (H2, Next/Later) / **20% long-term** (H3, frontier bets). Use this as a calibration point, not a rule.
- **Mature products with a stable core**: Can afford more H2/H3 investment once near-term revenues are secured and core retention is healthy.

Adjust based on competitive pressure, burn rate, and how much conviction you have in the core.  
