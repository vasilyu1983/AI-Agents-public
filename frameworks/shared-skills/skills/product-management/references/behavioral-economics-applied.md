...
**Regulatory exposure.** In the UK, forced continuity without clear disclosure violates CMA Consumer Markets Investigation guidance on subscription traps (2022), CPRs 2008 (aggressive commercial practice), and in some cases ASA CAP rules on misleading promotions. In the EU, the EU Omnibus Directive (2022) requires explicit confirmation before automatic renewal. In the US, the FTC's Negative Option Rule (2023 update) requires clear and conspicuous disclosure and simple cancellation.
