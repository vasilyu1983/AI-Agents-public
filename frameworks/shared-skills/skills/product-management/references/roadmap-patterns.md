...
- [1.1 Outcome-Based Roadmap (Primary Pattern)](#11-outcome-based-roadmap-primary-pattern)
- [1.2 Theme-Based Roadmap](#12-theme-based-roadmap)
- [1.3 Now / Next / Later Pattern](#13-now-next-later-pattern)
- [2. Prioritization Patterns](#2-prioritization-patterns)
- [2.1 The 3 Filters (minimal, effective)](#21-the-3-filters-minimal-effective)
- [2.2 RICE (Operational Adaptation)](#22-rice-operational-adaptation)
- [2.3 Problem Scoring Matrix](#23-problem-scoring-matrix)
- [2.4 Opportunity Scoring](#24-opportunity-scoring)
- [2.5 ICE Scoring (Lightweight Alternative)](#25-ice-scoring-lightweight-alternative)
- [3. Standing Roadmap Reviews](#3-standing-roadmap-reviews)
- [3.1 Monthly Review (Operative)](#31-monthly-review-operative)
- [3.2 Quarterly Refresh (Strategic)](#32-quarterly-refresh-strategic)
- [4. Roadmap Communication Patterns](#4-roadmap-communication-patterns)
- [4.1 Stakeholder Alignment Deck (5 slides)](#41-stakeholder-alignment-deck-5-slides)
- [4.2 Script for “Outcome Roadmap Walkthrough”](#42-script-for-“outcome-roadmap-walkthrough”)
- [4.3 Handling Feature Requests (Pattern)](#43-handling-feature-requests-pattern)
- [5. Decision Trees](#5-decision-trees)
- [5.1 Should This Go on the Roadmap?](#51-should-this-go-on-the-roadmap)
- [5.2 Time Horizon Assignment](#52-time-horizon-assignment)
- [6. Anti-Patterns (Do Not Use)](#6-anti-patterns-do-not-use)
- [7. Definition of Done (Roadmap)](#7-definition-of-done-roadmap)
...
Definitions (Janna Bastow / ProdPad canonical framing):

- **Now** = Committed, high confidence, in progress or immediately next. No date commitment beyond sprint or cycle boundaries.
- **Next** = Researched, likely, not date-committed. Problem space understood; solution not yet fully designed or validated.
- **Later** = Directional only, low confidence, problem-space framing. Not staffed, not sized. May shift significantly as strategy evolves.

Keep dates off all three horizons. If stakeholders ask for a time hint, label it explicitly as indicative, not a commitment. The value of Now/Next/Later is the confidence and commitment gradient, not a schedule.
...
See references/prioritization-frameworks.md for the canonical Impact scale and full RICE guidance.
