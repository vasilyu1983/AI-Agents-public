...
- [Resources (Operational Best Practices)](#resources-operational-best-practices)
- [Templates (Copy-Paste Ready)](#templates-copy-paste-ready)
- [1. Discovery](#1-discovery)
- [2. Strategy & Vision](#2-strategy-&-vision)
- [3. AI & Data Products](#3-ai-&-data-products)
- [4. Roadmaps & Planning](#4-roadmaps-&-planning)
- [5. Metrics & Goals](#5-metrics-&-goals)
- [6. Team Operations & Leadership](#6-team-operations-&-leadership)
- [How to Use This Skill](#how-to-use-this-skill)
- [1. Always Anchor in a Template or Pattern](#1-always-anchor-in-a-template-or-pattern)
- [2. Use Resources to Choose or Adapt Patterns](#2-use-resources-to-choose-or-adapt-patterns)
- [3. Keep Everything Operational](#3-keep-everything-operational)
- [4. Prioritize Outcomes and Problems](#4-prioritize-outcomes-and-problems)
- [Example Flows to Execute](#example-flows-to-execute)
- [A. Turn a vague idea into a discovery plan](#a-turn-a-vague-idea-into-a-discovery-plan)
- [B. Design an AI-powered feature (agentic)](#b-design-an-ai-powered-feature-agentic)
- [C. Build an outcome-based roadmap](#c-build-an-outcome-based-roadmap)
- [Recap](#recap)
...
- **Strategy & Positioning**
 ...
 - OKR patterns rooted in outcomes (Doerr's *Measure What Matters*; Perri's *Escaping the Build Trap*; Cagan & Jones's *Empowered* on outcome-based objectives — three distinct sources, not one)
...
- **AI & Data Products**
 ...
 - AI Product Development Lifecycle (Nika, Parzen, Li — Harvard Business School technical note, 2024)
 ...
 - Data product canvas (Jessika Milhomem, *Data Product Management in the AI Age*)
