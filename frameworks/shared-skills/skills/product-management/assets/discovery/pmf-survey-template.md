...
> **Related template:** For the instrumentation-side survey (Sean Ellis / Vohra 7Q wired for the PMF Insight Engine detector #1), see [`marketing-product-analytics/assets/sean-ellis-survey-template.md`](../../../marketing-product-analytics/assets/sean-ellis-survey-template.md). Keep Q1 wording aligned — detector #1 ingestion depends on it.
