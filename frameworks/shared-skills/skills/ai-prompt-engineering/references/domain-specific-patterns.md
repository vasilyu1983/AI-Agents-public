...
- [Contents](#contents)
- [1. Frontend / Visual Code Patterns](#1-frontend--visual-code-patterns)
- [2. Research Task Patterns](#2-research-task-patterns)
- [3. Agentic Coding Patterns](#3-agentic-coding-patterns)
- [4. Cross-Domain Best Practices](#4-cross-domain-best-practices)
- [5. Claude/Codex Communication Adaptations](#5-claudecodex-communication-adaptations)
- [Quick Reference](#quick-reference)
- [Integration with Core Patterns](#integration-with-core-patterns)

*Purpose: Cross-model patterns for specialized domains (frontend, research, agentic coding), with explicit notes where Claude/Codex behaviors matter.*
...
- Claude/Codex communication adaptations
...
**Why This Works** (especially on Claude/Codex-style coding models):

- Strong coding models respond to quality modifiers in prompts
...
- Dark mode with deep teal accent (#0F766E)
...
## 5. Claude/Codex Communication Adaptations

### 5.1 Request Summaries When Needed

Some current coding models are more concise by default. If you need visibility:
