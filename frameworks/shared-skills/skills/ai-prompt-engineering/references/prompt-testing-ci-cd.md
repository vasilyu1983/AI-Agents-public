...
**Freshness anchor:** March 2026 — covers provider-native eval workflows plus Promptfoo, DeepEval, and CI-based regression testing.

---
## Table of Contents

- [Test Infrastructure Decision Tree](#test-infrastructure-decision-tree)
- [Test Suite Design](#test-suite-design)
- [Test Set Categories](#test-set-categories)
- [Golden Set Design Checklist](#golden-set-design-checklist)
- [Test Example Format](#test-example-format)
- [test_examples.yaml](#testexamplesyaml)
- [Promptfoo Integration](#promptfoo-integration)
- [Configuration](#configuration)
- [promptfooconfig.yaml](#promptfooconfigyaml)
- [Load from CSV/JSONL for large test sets](#load-from-csvjsonl-for-large-test-sets)
- [Running Promptfoo](#running-promptfoo)
- [Install](#install)
- [Run evaluation](#run-evaluation)
- [Run with specific config](#run-with-specific-config)
- [Generate comparison report](#generate-comparison-report)
- [Run specific tests](#run-specific-tests)
- [Cache results (faster reruns)](#cache-results-faster-reruns)
- [DeepEval Integration](#deepeval-integration)
- [Setup and Configuration](#setup-and-configuration)
- [tests/test_prompts.py](#teststestpromptspy)
- [Define metrics](#define-metrics)
- [DeepEval Metrics Reference](#deepeval-metrics-reference)
- [Running DeepEval](#running-deepeval)
- [CI/CD Pipeline Configuration](#cicd-pipeline-configuration)
- [GitHub Actions Workflow](#github-actions-workflow)
- [.github/workflows/prompt-eval.yml](#githubworkflowsprompt-evalyml)
...
- [Regression Detection Pipeline](#regression-detection-pipeline)
...
|---|---|---|
| Pass rate | Team-defined threshold from the baseline suite | Block merge |
