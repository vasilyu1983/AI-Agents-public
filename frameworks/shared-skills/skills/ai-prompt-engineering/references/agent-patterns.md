...
- [Contents](#contents)
- [2.1 When to Plan](#21-when-to-plan)
- [2.2 Planning Rules](#22-planning-rules)
- [2.3 Plan Structure (When Needed)](#23-plan-structure-when-needed)
- [3.1 Single Tool Structure](#31-single-tool-structure)
- [3.2 Tool Preference Hierarchy (2025)](#32-tool-preference-hierarchy-2025)
- [3.3 Parallel Tool Execution (2025 - Batch-First)](#33-parallel-tool-execution-2025---batch-first)
- [4.1 Structure](#41-structure)
- [5.1 Logic](#51-logic)
- [6.1 Generic Workflow](#61-generic-workflow)
- [6.2 Rules](#62-rules)
- [6.3 Long-Horizon Task Management](#63-long-horizon-task-management)
- [7.1 Input Validation](#71-input-validation)
- [7.2 Output Validation](#72-output-validation)
- [8.1 Tool Error Pattern](#81-tool-error-pattern)
- [8.2 Missing Data Pattern](#82-missing-data-pattern)
- [8.3 Ambiguous Results Pattern](#83-ambiguous-results-pattern)
- [9.1 Structure](#91-structure)
- [10.1 Structure](#101-structure)
- [11.1 Structure](#111-structure)
- [12.1 Pre-Execution Gate](#121-pre-execution-gate)
- [12.2 Output Gate](#122-output-gate)
- [14.1 Orchestration Architectures](#141-orchestration-architectures)
- [14.2 Core Multi-Agent Patterns](#142-core-multi-agent-patterns)
- [14.3 Human-Agent Collaboration Spectrum](#143-human-agent-collaboration-spectrum)
- [14.4 Multi-Agent Checklist](#144-multi-agent-checklist)
...
## 6.3 Long-Horizon Task Management
