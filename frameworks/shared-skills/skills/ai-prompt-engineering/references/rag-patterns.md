...
- [Contents](#contents)
- [1.1 Input Contract](#11-input-contract)
- [2.1 Rules](#21-rules)
- [2.2 Evidence Extraction Structure](#22-evidence-extraction-structure)
- [3.1 Structure](#31-structure)
- [4.1 Missing Information](#41-missing-information)
- [4.2 Contradictory Evidence](#42-contradictory-evidence)
- [4.3 Low-Quality Retrieval](#43-low-quality-retrieval)
- [5.1 Workflow](#51-workflow)
- [5.2 Constraints](#52-constraints)
- [6.1 Chunk-to-Chunk Summary](#61-chunk-to-chunk-summary)
- [6.2 Global Summary Pattern](#62-global-summary-pattern)
- [7.1 Ranking Structure](#71-ranking-structure)
- [7.2 Filtering Rules](#72-filtering-rules)
- [8.1 Namespace Structure](#81-namespace-structure)
- [9.1 Schema Pattern](#91-schema-pattern)
- [9.2 Error-Fallback Rules](#92-error-fallback-rules)
- [12.1 When to Use Agentic RAG](#121-when-to-use-agentic-rag)
- [12.2 Agentic RAG Architecture](#122-agentic-rag-architecture)
- [12.3 Key Agentic Patterns](#123-key-agentic-patterns)
- [12.4 Agentic RAG Prompt Structure](#124-agentic-rag-prompt-structure)
- [12.5 Best Practices (Research-Based)](#125-best-practices-research-based)
