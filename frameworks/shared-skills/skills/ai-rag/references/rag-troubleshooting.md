...
- [1. Symptom → Cause → Fix Matrix](#1-symptom-→-cause-→-fix-matrix)
- [1.1 Irrelevant Results](#11-irrelevant-results)
- [1.2 Missing Essential Information](#12-missing-essential-information)
- [1.3 Hallucinations](#13-hallucinations)
- [1.4 Slow Retrieval](#14-slow-retrieval)
- [1.5 Repeated Content or Duplicates](#15-repeated-content-or-duplicates)
- [2. Debugging Workflow](#2-debugging-workflow)
