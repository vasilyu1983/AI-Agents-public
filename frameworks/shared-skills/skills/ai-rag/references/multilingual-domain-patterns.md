...
- [Pattern 1: Multilingual Embedding Selection](#pattern-1-multilingual-embedding-selection)
- [Decision Rules](#decision-rules)
- [Evaluation by Language](#evaluation-by-language)
- [Pattern 2: Language Detection & Preprocessing](#pattern-2-language-detection-&-preprocessing)
- [Language Detection](#language-detection)
- [Apply per-language preprocessing](#apply-per-language-preprocessing)
- [Per-Language Tokenization](#per-language-tokenization)
- [Pattern 3: Multilingual Hybrid Search](#pattern-3-multilingual-hybrid-search)
- [Architecture](#architecture)
- [Cross-Language Retrieval](#cross-language-retrieval)
- [Pattern 4: Multilingual Reranking](#pattern-4-multilingual-reranking)
- [Cross-Encoder Reranking](#cross-encoder-reranking)
- [Load multilingual cross-encoder](#load-multilingual-cross-encoder)
- [Pattern 5: Domain-Specific Embeddings](#pattern-5-domain-specific-embeddings)
- [When to Use Domain Models](#when-to-use-domain-models)
- [Fine-Tuning for Domain](#fine-tuning-for-domain)
- [Prepare domain-specific training data](#prepare-domain-specific-training-data)
- [Load base model and fine-tune](#load-base-model-and-fine-tune)
- [Use contrastive loss](#use-contrastive-loss)
- [Save domain-adapted model](#save-domain-adapted-model)
- [Pattern 6: Mixed-Language Document Handling](#pattern-6-mixed-language-document-handling)
- [Chunking Strategy for Mixed-Language Docs](#chunking-strategy-for-mixed-language-docs)
- [Index Mixed-Language Chunks](#index-mixed-language-chunks)
- [Pattern 7: Multilingual Evaluation & Monitoring](#pattern-7-multilingual-evaluation-&-monitoring)
- [Per-Language Dashboards](#per-language-dashboards)
- [Track metrics by language slice](#track-metrics-by-language-slice)
- [Alert on underperforming languages](#alert-on-underperforming-languages)
- [Cross-Language Leakage Detection](#cross-language-leakage-detection)
- [Multilingual Quality Checklist](#multilingual-quality-checklist)
