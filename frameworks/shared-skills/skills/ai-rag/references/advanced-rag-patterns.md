...
- [Structured, Graph, and Multimodal RAG](#structured-graph-and-multimodal-rag)
- [Graph/Knowledge RAG](#graphknowledge-rag)
- [Table/Structured Data RAG](#tablestructured-data-rag)
- [Multimodal RAG](#multimodal-rag)
- [Two-Stage Pipelines](#two-stage-pipelines)
- [Freshness/Governance](#freshnessgovernance)
- [Implementation Checklist](#implementation-checklist)
- [Online Evaluation, Telemetry, and Freshness](#online-evaluation-telemetry-and-freshness)
- [Online Signals](#online-signals)
- [Shadow/Canary Testing](#shadowcanary-testing)
- [Freshness Telemetry](#freshness-telemetry)
- [Slice Dashboards](#slice-dashboards)
- [Eval Set Protection](#eval-set-protection)
- [Production Checklist](#production-checklist)
- [Context Compression & Budgeting](#context-compression-&-budgeting)
- [Compression Strategies](#compression-strategies)
- [Token Budget Management](#token-budget-management)
- [Context Optimization Checklist](#context-optimization-checklist)
- [Modern Paradigm Shift](#modern-paradigm-shift)
- [Adaptive Retrieval](#adaptive-retrieval)
- [Self-Correcting Systems](#self-correcting-systems)
- [Wise Retrieval](#wise-retrieval)
- [Multimodal & Structured Integration](#multimodal-&-structured-integration)
- [GEAR: Graph-Enhanced Agentic RAG](#gear-graph-enhanced-agentic-rag)
- [Architecture](#architecture)
- [When GEAR Outperforms Standard RAG](#when-gear-outperforms-standard-rag)
- [Implementation Components](#implementation-components)
- [GEAR Checklist](#gear-checklist)
- [Contextual Memory: RAG Alternative for Agentic AI](#contextual-memory-rag-alternative-for-agentic-ai)
- [RAG vs Contextual Memory](#rag-vs-contextual-memory)
- [When to Use Contextual Memory](#when-to-use-contextual-memory)
...
- Reserve 20-30% of the resulting budget as a formatting buffer
- Track actual usage vs budget
- **Do not reuse pre-2026 heuristics with Opus 4.7.** The tokenizer encodes ~1.0-1.35x more tokens than earlier tokenizers for the same text. Re-measure token counts on your own corpus before setting context budgets.
...
- Small-to-medium knowledge bases where the corpus fits comfortably in context (threshold is corpus- and tokenizer-dependent; run the decision rubric in [`../ai-context-layer/references/retrieve-vs-preload-vs-finetune.md`](../../ai-context-layer/references/retrieve-vs-preload-vs-finetune.md) rather than using a fixed token count)
