...
- [1. Symptom → Root Cause → Fix](#1-symptom-→-root-cause-→-fix)
- [A. Irrelevant Results](#a-irrelevant-results)
- [B. Low Recall](#b-low-recall)
- [C. High Latency](#c-high-latency)
- [D. Duplicate or Noisy Results](#d-duplicate-or-noisy-results)
- [2. Debugging Workflow](#2-debugging-workflow)
- [3. Logging Requirements](#3-logging-requirements)
- [4. Debugging Checklist](#4-debugging-checklist)
