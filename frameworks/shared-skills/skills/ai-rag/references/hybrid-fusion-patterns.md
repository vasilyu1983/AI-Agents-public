...
Use weighted sum only after score normalization. BM25 scores, cosine
similarity, recency, and popularity do not share a natural scale. Normalize on
a held-out judged-query set or use rank-based fusion when score calibration is
unclear.
