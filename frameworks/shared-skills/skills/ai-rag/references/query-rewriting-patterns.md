...
- [When to Use Query Rewriting](#when-to-use-query-rewriting)
- [Pattern 1: Clarification Rewriting](#pattern-1-clarification-rewriting)
- [Example](#example)
- [LLM Prompt Pattern](#llm-prompt-pattern)
- [Pattern 2: Keyword Expansion](#pattern-2-keyword-expansion)
- [Steps](#steps)
- [LLM Prompt Pattern](#llm-prompt-pattern)
- [Pattern 3: Semantic Rewriting](#pattern-3-semantic-rewriting)
- [Example](#example)
- [LLM Prompt Pattern](#llm-prompt-pattern)
- [Pattern 4: Multi-Step Query Decomposition](#pattern-4-multi-step-query-decomposition)
- [Example](#example)
- [Implementation](#implementation)
- [Retrieve separately and merge](#retrieve-separately-and-merge)
- [Deduplicate and rerank](#deduplicate-and-rerank)
- [Pattern 5: Query Rewrite + Original Combination](#pattern-5-query-rewrite-original-combination)
- [Hybrid Strategy](#hybrid-strategy)
- [Evaluation Metrics](#evaluation-metrics)
- [Common Pitfalls](#common-pitfalls)
- [Query Rewriting Quality Checklist](#query-rewriting-quality-checklist)
