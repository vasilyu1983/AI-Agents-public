...
- [nDCG@k (Normalized Discounted Cumulative Gain)](#ndcg@k-normalized-discounted-cumulative-gain)
- [MRR (Mean Reciprocal Rank)](#mrr-mean-reciprocal-rank)
- [Recall@K](#recall@k)
- [Precision@K](#precision@k)
- [Evaluation Process](#evaluation-process)
- [Step 1: Build Labeled Dataset](#step-1-build-labeled-dataset)
- [Step 2: Test Variants](#step-2-test-variants)
- [Step 3: Compute Metrics](#step-3-compute-metrics)
- [Step 4: Plot Results](#step-4-plot-results)
- [Evaluation Slicing](#evaluation-slicing)
...
- [Example monitoring dashboard](#example-monitoring-dashboard)
- [Degradation Alerts](#degradation-alerts)
- [Evaluation Quality Checklist](#evaluation-quality-checklist)
