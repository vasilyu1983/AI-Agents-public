...
- [Pattern 1: Topology & Consistency](#pattern-1-topology-&-consistency)
- [Shard & Replica Design](#shard-&-replica-design)
- [Example: Hash-based sharding](#example-hash-based-sharding)
- [Shard configuration](#shard-configuration)
- [Pattern 2: Resilience & Health Checks](#pattern-2-resilience-&-health-checks)
- [Health Monitoring](#health-monitoring)
- [Automatic Reroute on Failure](#automatic-reroute-on-failure)
- [Pattern 3: Backpressure & Load Shedding](#pattern-3-backpressure-&-load-shedding)
- [Queue Depth Monitoring](#queue-depth-monitoring)
- [Load Shedding Strategies](#load-shedding-strategies)
- [Pattern 4: Caching Strategy](#pattern-4-caching-strategy)
- [Multi-Level Caching](#multi-level-caching)
- [Cache Invalidation](#cache-invalidation)
- [Pattern 5: Performance Runbook](#pattern-5-performance-runbook)
- [Metrics to Track](#metrics-to-track)
- [Incident Playbook](#incident-playbook)
- [Pattern 6: Upgrades & Rollbacks](#pattern-6-upgrades-&-rollbacks)
- [Dual-Write During Rebuild](#dual-write-during-rebuild)
- [Version Tagging](#version-tagging)
- [Distributed Search SLO Checklist](#distributed-search-slo-checklist)
