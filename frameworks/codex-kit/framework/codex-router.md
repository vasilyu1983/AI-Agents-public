...
- **product-manager**: Product strategy, roadmaps, user research, and metrics analysis (uses `product-management`, `docs-codebase`, startup skills).
...
**If the task is about LLM agent/persona QA testing:**
- **Agent**: test-architect
...
- **Agent**: ai-agents-builder
- **Skill**: document-docx OR document-pdf OR document-pptx OR document-xlsx (pick best fit)
