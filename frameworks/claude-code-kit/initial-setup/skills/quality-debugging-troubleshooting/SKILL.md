...
- [foundation-git-workflow](../foundation-git-workflow/SKILL.md) - Git bisect for finding regressions, version control workflows
- [foundation-api-design](../foundation-api-design/SKILL.md) - API debugging, error handling, REST patterns, status codes
...
- [ops-database-sql](../ops-database-sql/SKILL.md) - Database query optimization, EXPLAIN ANALYZE, index tuning, slow query debugging
