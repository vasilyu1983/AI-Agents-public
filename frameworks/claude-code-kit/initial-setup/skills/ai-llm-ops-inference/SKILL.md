...
- **Prompting, tuning, datasets** → [ai-llm-development](../ai-llm-development/SKILL.md)
- **RAG pipeline construction** → [ai-llm-rag-engineering](../ai-llm-rag-engineering/SKILL.md)
- **Deployment, APIs, monitoring** → [ai-ml-ops-production](../ai-ml-ops-production/SKILL.md)
- **Safety, governance** → [ai-ml-ops-security](../ai-ml-ops-security/SKILL.md)
...
- **[ai-llm-development](../ai-llm-development/SKILL.md)** - Prompting, fine-tuning, datasets
- **[ai-llm-engineering](../ai-llm-engineering/SKILL.md)** - LLM application architecture, RAG pipelines
- **[ai-llm-rag-engineering](../ai-llm-rag-engineering/SKILL.md)** - RAG pipeline construction and optimization
- **[ai-ml-ops-production](../ai-ml-ops-production/SKILL.md)** - Deployment, APIs, monitoring
- **[ai-ml-ops-security](../ai-ml-ops-security/SKILL.md)** - Safety, governance, security
