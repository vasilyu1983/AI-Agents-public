...
- **RAG retrieval & chunking** → [ai-llm-rag-engineering](../ai-llm-rag-engineering/SKILL.md)
...
- **Inference optimization** → [ai-llm-ops-inference](../ai-llm-ops-inference/SKILL.md)
...
- [`../ai-llm-engineering/`](../ai-llm-engineering/SKILL.md) - LLM patterns, prompt engineering, and model selection for agents
- [`../ai-llm-rag-engineering/`](../ai-llm-rag-engineering/SKILL.md) - Deep RAG implementation: chunking, embedding, reranking
...
- [`../ai-ml-ops-production/`](../ai-ml-ops-production/SKILL.md) - Model deployment, monitoring, drift detection
