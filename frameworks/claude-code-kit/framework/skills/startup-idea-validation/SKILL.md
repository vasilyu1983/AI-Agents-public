...
description: >
  Systematic 9-dimension validation machine for testing ideas before building.
  Covers problem severity, market sizing, timing, competitive moats, unit economics,
  founder-market fit, technical feasibility, GTM clarity, and risk profile.
  Makes GO/NO-GO decisions based on evidence, not assumptions.
globs:
  - "**/*.md"
  - "**/validation/**"
  - "**/ideas/**"
...
- [startup-mega-router](../startup-mega-router/SKILL.md) - Validation results
