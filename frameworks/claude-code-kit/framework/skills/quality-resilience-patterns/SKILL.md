---
name: quality-resilience-patterns
...
- [../ops-database-sql/SKILL.md](../ops-database-sql/SKILL.md) — Database resilience, connection pooling, and query timeouts
- [../foundation-api-design/SKILL.md](../foundation-api-design/SKILL.md) — API design patterns including error handling and retry semantics
