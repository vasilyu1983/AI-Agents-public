...
- **[ai-llm](../ai-llm/SKILL.md)** - Model training, fine-tuning, dataset creation, instruction tuning
- **[ai-llm-inference](../ai-llm-inference/SKILL.md)** - Production serving, quantization, batching, GPU optimization
- **[ai-mlops](../ai-mlops/SKILL.md)** - Deployment patterns, monitoring, drift detection, API design
- **[ai-mlops](../ai-mlops/SKILL.md)** - Security guardrails, prompt injection defense, privacy protection
