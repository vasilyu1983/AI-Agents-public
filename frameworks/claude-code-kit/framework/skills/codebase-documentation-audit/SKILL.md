---
name: codebase-documentation-audit
description: Systematically audit codebases for documentation gaps, generate coverage reports, and create missing documentation using foundation-documentation templates. Scans APIs, services, events, database schemas, and configurations to ensure comprehensive documentation coverage.
---
...
This skill provides operational workflows for auditing existing codebases, identifying documentation gaps, and systematically generating missing documentation. It complements [foundation-documentation](../foundation-documentation/SKILL.md) by providing the **discovery and analysis** layer.

**Key Principle**: Templates exist in foundation-documentation. This skill tells you **what** to document and **how to find** undocumented components.
...
| **Generate Docs** | foundation-documentation templates | Documentation files | Use [audit-workflows.md](resources/audit-workflows.md) Phase 3 |
...
**[foundation-documentation](../foundation-documentation/SKILL.md)** - Provides templates for:

- [api-docs-template.md](../foundation-documentation/templates/api-reference/api-docs-template.md) - REST API documentation
- [adr-template.md](../foundation-documentation/templates/architecture/adr-template.md) - Architecture decisions
- [readme-template.md](../foundation-documentation/templates/project-management/readme-template.md) - Project overviews
- [changelog-template.md](../foundation-documentation/templates/project-management/changelog-template.md) - Release history

**Workflow**:

1. Use **codebase-documentation-audit** to discover gaps
2. Use **foundation-documentation** templates to fill gaps
3. Use **codebase-documentation-audit** CI/CD integration to maintain coverage
...
- **[foundation-documentation](../foundation-documentation/SKILL.md)** - Templates for writing documentation (README, ADR, API docs, changelog)
- **[product-prd-development](../product-prd-development/SKILL.md)** - PRD and tech spec templates for new features
...
5. **Use templates** - Reference foundation-documentation for documentation structure
