---
name: quality-documentation-audit
...
1. Use **quality-documentation-audit** to discover gaps
2. Use **foundation-documentation** templates to fill gaps
3. Use **quality-documentation-audit** CI/CD integration to maintain coverage
...
- **[product-prd-for-agents](../product-prd-for-agents/SKILL.md)** - PRD and tech spec templates for new features
