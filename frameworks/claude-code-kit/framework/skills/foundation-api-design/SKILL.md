...
- **[ops-database-sql](../ops-database-sql/SKILL.md)** - SQL optimization and database patterns
...
- **[foundation-documentation](../foundation-documentation/SKILL.md)** - Technical documentation standards
